...
Myrubyblog::Application.routes.draw do
  get "pages/about" #note these are necessary since resources is for the 7 default actions
...
#solution, removed the routes 
  ...
  # Keep in mind you can assign values other than :controller and :action
	match '/about' => 'pages#about' # /pages/about URL instead of
	match '/resources' => 'pages#resources' # /pages/about URL instead of
	match '/contact' => 'pages#contact' # /pages/about URL instead of
