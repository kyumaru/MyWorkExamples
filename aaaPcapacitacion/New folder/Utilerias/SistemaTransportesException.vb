Namespace Utilerias.SistemaTransportes
	Public Class SistemaTransportesException
		Inherits Exception
#Region "Constantes"
		Public Const NOMBRE_CLASE As String = "SistemaTransportesException"
#End Region
...
#Region "Funciones"
		...
		Public Shared Function GetFromSoapException(ByVal pvo_Ex As System.Web.Services.Protocols.SoapException) As SistemaTransportesException
			Return New SistemaTransportesException(pvo_Ex.Detail.Attributes("Message").Value.Trim)
		End Function
#End Region
	End Class
End Namespace
