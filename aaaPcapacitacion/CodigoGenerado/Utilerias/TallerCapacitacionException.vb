Namespace Utilerias.TallerCapacitacion
	Public Class TallerCapacitacionException
		Inherits Exception
#Region "Constantes"
		Public Const NOMBRE_CLASE As String = "TallerCapacitacionException"
#End Region
...
#Region "Funciones"
		...
		Public Shared Function GetFromSoapException(ByVal pvo_Ex As System.Web.Services.Protocols.SoapException) As TallerCapacitacionException
			Return New TallerCapacitacionException(pvo_Ex.Detail.Attributes("Message").Value.Trim)
		End Function
#End Region
	End Class
End Namespace
