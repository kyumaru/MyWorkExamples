...
Namespace OrdenesDeTrabajo.AccesoDatos.Catalogos
    Public Class DalOtmAlmacenBodega
        Inherits DalBase
...
#Region "Funciones"
        ...
        Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Dim vlo_RegistroInterno As EntOtmAlmacenBodega
            Dim vln_Resultado As Integer

            Try
                vln_Resultado = -1
                vlo_RegistroInterno = CType(pvo_Registro, EntOtmAlmacenBodega)
                ...
                vlc_Sentencia = "prI_OTM_ALMACEN_BODEGA"

                vlo_Conexion.SetParameter("prn_IdAlmacenBodega", OracleDbType.Int32, vln_Resultado, ParameterDirection.Output)
                ...
                vlo_Conexion.SetParameter("pvc_Tipo", OracleDbType.Varchar2, vlo_RegistroInterno.Tipo)
                ...
                vln_Resultado = CType(vlo_Conexion.GetParameterValue("prn_IdAlmacenBodega"), Integer)
        ...
        Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prD_OTM_ALMACEN_BODEGA"
        ...
        ''' <summary>
        ''' Permite modificar un registro en la tabla OTM_ALMACEN_BODEGA
        ''' </summary>
        ''' <param name="pvo_Registro">Entidad a procesar</param>
        ''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ...
        Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTM_ALMACEN_BODEGA"
        ...
        Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
            ...
            Dim vlo_Resultado As New EntOtmAlmacenBodega

            Try
                vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ALMACEN_BODEGA.ID_ALMACEN_BODEGA, "IdAlmacenBodega"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ALMACEN_BODEGA.ID_UBICACION_ADMINISTRA, "IdUbicacionAdministra"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ALMACEN_BODEGA.DESCRIPCION, "Descripcion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ALMACEN_BODEGA.TIPO, "Tipo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ALMACEN_BODEGA.ID_SECTOR_TALLER, "IdSectorTaller"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ALMACEN_BODEGA.ESTADO, "Estado"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ALMACEN_BODEGA.USUARIO, "Usuario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ALMACEN_BODEGA.TIME_STAMP, "TimeStamp"))

                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtmAlmacenBodega)(vlo_MapeoEntidad)
        ...
        Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_ALMACEN_BODEGA.Name, "V_OTM_ALMACEN_BODEGA", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_ALMACEN_BODEGA.Name, "V_OTM_ALMACEN_BODEGALst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>23/05/2016 02:48:06 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ListarVOtmAlmacenBodega(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTM_ALMACEN_BODEGA.Name, V_OTM_ALMACEN_BODEGA.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>23/05/2016 02:48:06 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtmAlmacenBodega(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTM_ALMACEN_BODEGA.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        ''' <creationDate>23/05/2016 02:48:06 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ListarVOtmAlmacenBodegalst(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTM_ALMACEN_BODEGALST.Name, V_OTM_ALMACEN_BODEGALST.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>23/05/2016 02:48:06 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtmAlmacenBodegalst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTM_ALMACEN_BODEGALST.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        ''' <changeLog></changeLog>
        Public Function ListarVOttViaCompraAlmacen(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTT_VIA_COMPRA_ALMACEN.Name, V_OTT_VIA_COMPRA_ALMACEN.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
