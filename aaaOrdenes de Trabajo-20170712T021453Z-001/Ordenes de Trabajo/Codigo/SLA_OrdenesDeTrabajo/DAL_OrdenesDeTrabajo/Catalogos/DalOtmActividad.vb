...
#Region "Funciones"
	...
	Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Dim vlo_RegistroInterno As EntOtmActividad
		Dim vln_Resultado As Integer

		Try
			vln_Resultado = -1
			vlo_RegistroInterno = CType(pvo_Registro, EntOtmActividad)
			...
			vlc_Sentencia = "prI_OTM_ACTIVIDAD"

			vlo_Conexion.SetParameter("pvn_IdCategoriaServicio", OracleDbType.Int32, vlo_RegistroInterno.IdCategoriaServicio)
                vlo_Conexion.SetParameter("prn_IdActividad", OracleDbType.Int32, vln_Resultado, ParameterDirection.Output)
                ...
                vlo_Conexion.SetParameter("pvc_DescripcionAmpliada", OracleDbType.Varchar2, vlo_RegistroInterno.DescripcionAmpliada)
                ...
                vln_Resultado = CType(vlo_Conexion.GetParameterValue("prn_IdActividad"), Integer)
	...
	Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prD_OTM_ACTIVIDAD"
	...
	''' <summary>
	''' Permite modificar un registro en la tabla OTM_ACTIVIDAD
	''' </summary>
	''' <param name="pvo_Registro">Entidad a procesar</param>
	''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
	''' <author>Generador de Código basado en objetos Oracle</author>
	...
	Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prU_OTM_ACTIVIDAD"
	...
	Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
		...
		Dim vlo_Resultado As New EntOtmActividad

		Try
			vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
			If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
				vlo_MapeoEntidad = New List(Of MapeoSimple)
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ACTIVIDAD.ID_CATEGORIA_SERVICIO, "IdCategoriaServicio"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ACTIVIDAD.ID_ACTIVIDAD, "IdActividad"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ACTIVIDAD.ID_SECTOR_TALLER, "IdSectorTaller"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ACTIVIDAD.DESCRIPCION, "Descripcion"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ACTIVIDAD.DESCRIPCION_AMPLIADA, "DescripcionAmpliada"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ACTIVIDAD.ESTADO, "Estado"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ACTIVIDAD.TIME_STAMP, "TimeStamp"))

				vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtmActividad)(vlo_MapeoEntidad)
	...
	Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_ACTIVIDAD.Name, "V_OTM_ACTIVIDAD", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>01/09/2015 05:07:51 p.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtmActividad(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTM_ACTIVIDAD", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
	...
	Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_ACTIVIDAD.Name, "V_OTM_ACTIVIDADLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>01/09/2015 05:07:51 p.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtmActividadlst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_Resultado As EntDatosPaginacion
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTM_ACTIVIDADLst", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
