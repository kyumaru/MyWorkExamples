...
Namespace OrdenesDeTrabajo.AccesoDatos.Catalogos
	Public Class DalOtpParametroGlobal
		Inherits DalBase
...
#Region "Funciones"
	...
	Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Dim vlo_RegistroInterno As EntOtpParametroGlobal
		Dim vln_Resultado As Integer

		Try
			vln_Resultado = -1
			vlo_RegistroInterno = CType(pvo_Registro, EntOtpParametroGlobal)
			...
			vlc_Sentencia = "prI_OTP_PARAMETRO_GLOBAL"
	...
	Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prD_OTP_PARAMETRO_GLOBAL"
	...
	''' <summary>
	''' Permite modificar un registro en la tabla OTP_PARAMETRO_GLOBAL
	''' </summary>
	''' <param name="pvo_Registro">Entidad a procesar</param>
	''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
	''' <author>Generador de Código basado en objetos Oracle</author>
	...
	Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prU_OTP_PARAMETRO_GLOBAL"
	...
	Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
		...
		Dim vlo_Resultado As New EntOtpParametroGlobal

		Try
			vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
			If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
				vlo_MapeoEntidad = New List(Of MapeoSimple)
				vlo_MapeoEntidad.Add(New MapeoSimple(OTP_PARAMETRO_GLOBAL.ID_PARAMETRO, "IdParametro"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTP_PARAMETRO_GLOBAL.DESCRIPCION, "Descripcion"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTP_PARAMETRO_GLOBAL.VALOR, "Valor"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTP_PARAMETRO_GLOBAL.VALOR_DECIMAL, "ValorDecimal"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTP_PARAMETRO_GLOBAL.PROTEGIDO, "Protegido"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTP_PARAMETRO_GLOBAL.USUARIO, "Usuario"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTP_PARAMETRO_GLOBAL.TIME_STAMP, "TimeStamp"))

				vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtpParametroGlobal)(vlo_MapeoEntidad)
	...
	Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTP_PARAMETRO_GLOBAL.Name, "V_OTP_PARAMETRO_GLOBAL", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTP_PARAMETRO_GLOBAL.Name, "V_OTP_PARAMETRO_GLOBALLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>09/10/2015 10:02:27 a.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ListarVOtpParametroGlobal(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_DsDatos As New DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTP_PARAMETRO_GLOBAL.Name, V_OTP_PARAMETRO_GLOBAL.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>09/10/2015 10:02:27 a.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtpParametroGlobal(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTP_PARAMETRO_GLOBAL.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
	...
	''' <creationDate>09/10/2015 10:02:27 a.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ListarVOtpParametroGloballst(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_DsDatos As New DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTP_PARAMETRO_GLOBALLST.Name, V_OTP_PARAMETRO_GLOBALLST.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>09/10/2015 10:02:27 a.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtpParametroGloballst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_Resultado As EntDatosPaginacion
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTP_PARAMETRO_GLOBALLST.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
