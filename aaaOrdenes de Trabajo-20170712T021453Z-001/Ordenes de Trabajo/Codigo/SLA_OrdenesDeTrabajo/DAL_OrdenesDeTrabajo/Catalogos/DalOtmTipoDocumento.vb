...
Namespace OrdenesDeTrabajo.AccesoDatos.Catalogos
	Public Class DalOtmTipoDocumento
		Inherits DalBase
...
#Region "Funciones"
	...
	''' <creationDate>28/01/2016 09:49:24 a.m.</creationDate>
	''' <changeLog></changeLog>
	Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Dim vlo_RegistroInterno As EntOtmTipoDocumento
            Dim vln_Resultado As Integer

            Try
                vln_Resultado = -1
                vlo_RegistroInterno = CType(pvo_Registro, EntOtmTipoDocumento)
                ...
                vlc_Sentencia = "prI_OTM_TIPO_DOCUMENTO"

                vlo_Conexion.SetParameter("prn_IdTipoDocumento", OracleDbType.Int32, vln_Resultado, ParameterDirection.Output)
                vlo_Conexion.SetParameter("pvc_Descripcion", OracleDbType.Varchar2, vlo_RegistroInterno.Descripcion)
                vlo_Conexion.SetParameter("pvn_TamanioMaximo", OracleDbType.Int32, vlo_RegistroInterno.TamanioMaximo)
                vlo_Conexion.SetParameter("pvc_FormatosAdmitidos", OracleDbType.Varchar2, vlo_RegistroInterno.FormatosAdmitidos)
                ...
                vln_Resultado = CType(vlo_Conexion.GetParameterValue("prn_IdTipoDocumento"), Integer)
	...
	Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prD_OTM_TIPO_DOCUMENTO"
	...
	''' <summary>
	''' Permite modificar un registro en la tabla OTM_TIPO_DOCUMENTO
	''' </summary>
	''' <param name="pvo_Registro">Entidad a procesar</param>
	''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
	''' <author>Generador de Código basado en objetos Oracle</author>
	...
	Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTM_TIPO_DOCUMENTO"
	...
	Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
		...
		Dim vlo_Resultado As New EntOtmTipoDocumento

		Try
			vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
			If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
				vlo_MapeoEntidad = New List(Of MapeoSimple)
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_TIPO_DOCUMENTO.ID_TIPO_DOCUMENTO, "IdTipoDocumento"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_TIPO_DOCUMENTO.DESCRIPCION, "Descripcion"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_TIPO_DOCUMENTO.TAMANIO_MAXIMO, "TamanioMaximo"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_TIPO_DOCUMENTO.FORMATOS_ADMITIDOS, "FormatosAdmitidos"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_TIPO_DOCUMENTO.ESTADO, "Estado"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_TIPO_DOCUMENTO.USUARIO, "Usuario"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_TIPO_DOCUMENTO.TIME_STAMP, "TimeStamp"))

				vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtmTipoDocumento)(vlo_MapeoEntidad)
	...
	Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_TIPO_DOCUMENTO.Name, "V_OTM_TIPO_DOCUMENTO", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>28/01/2016 09:49:24 a.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtmTipoDocumento(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTM_TIPO_DOCUMENTO", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
	...
	Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_TIPO_DOCUMENTO.Name, "V_OTM_TIPO_DOCUMENTOLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>28/01/2016 09:49:24 a.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtmTipoDocumentolst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_Resultado As EntDatosPaginacion
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTM_TIPO_DOCUMENTOLst", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
