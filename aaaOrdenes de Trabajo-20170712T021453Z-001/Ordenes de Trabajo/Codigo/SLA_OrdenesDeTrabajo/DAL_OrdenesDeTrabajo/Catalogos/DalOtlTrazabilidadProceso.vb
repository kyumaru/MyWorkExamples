...
Namespace OrdenesDeTrabajo.AccesoDatos.Catalogos
    Public Class DalOtlTrazabilidadProceso
        Inherits DalBase
...
#Region "Metodos"
        ...
        ''' <summary>
        ''' Adapter para la trazabilidad de la orden
        ''' </summary>
        ...
        ''' <changeLog></changeLog>
        Public Sub AdapterOtfTrazabilidad(pvo_DataSet As Data.DataSet)
            ...
            Try
                ...
                vlo_Conexion.AdapterCrear(String.Empty,
                                          String.Empty,
                                          String.Format("DELETE FROM {0} WHERE {1} = :{1} ", Modelo.OTL_TRAZABILIDAD_PROCESO.Name, Modelo.OTL_TRAZABILIDAD_PROCESO.ID_TRAZABILIDAD_PROCESO))

                vlo_Conexion.AdapterAgregarParametro(String.Format(":{0}", Modelo.OTL_TRAZABILIDAD_PROCESO.ID_TRAZABILIDAD_PROCESO), String.Format("{0}", Modelo.OTL_TRAZABILIDAD_PROCESO.ID_TRAZABILIDAD_PROCESO), DbType.Int32, ConexionOracle.TipoParametro.Delete)
...
#Region "Funciones"
        ...
        Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_RegistroInterno As EntOtlTrazabilidadProceso
            Dim vln_Resultado As Integer

            Try
                vln_Resultado = -1
                vlo_RegistroInterno = CType(pvo_Registro, EntOtlTrazabilidadProceso)
                ...
                vlc_Sentencia = "prI_OTL_TRAZABILIDAD_PROCESO"
        ...
        Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prD_OTL_TRAZABILIDAD_PROCESO"
        ...
        ''' <summary>
        ''' Permite modificar un registro en la tabla OTL_TRAZABILIDAD_PROCESO
        ''' </summary>
        ''' <param name="pvo_Registro">Entidad a procesar</param>
        ''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ...
        Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTL_TRAZABILIDAD_PROCESO"
        ...
        Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
            ...
            Dim vlo_Resultado As New EntOtlTrazabilidadProceso

            Try
                vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABILIDAD_PROCESO.ID_TRAZABILIDAD_PROCESO, "IdTrazabilidadProceso"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABILIDAD_PROCESO.ID_UBICACION, "IdUbicacion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABILIDAD_PROCESO.ANNO, "Anno"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABILIDAD_PROCESO.CONSECUTIVO, "Consecutivo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABILIDAD_PROCESO.NUM_EMPLEADO_EJECUTA, "NumEmpleadoEjecuta"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABILIDAD_PROCESO.ESTADO_ORDEN_TRABAJO, "EstadoOrdenTrabajo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABILIDAD_PROCESO.FECHA_HORA_EJECUCION, "FechaHoraEjecucion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABILIDAD_PROCESO.OBSERVACIONES, "Observaciones"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABILIDAD_PROCESO.USUARIO, "Usuario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABILIDAD_PROCESO.TIME_STAMP, "TimeStamp"))

                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtlTrazabilidadProceso)(vlo_MapeoEntidad)
        ...
        Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTL_TRAZABILIDAD_PROCESO.Name, "V_OTL_TRAZABILIDAD_PROCESO", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>14/09/2015 11:16:46 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtlTrazabilidadProceso(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTL_TRAZABILIDAD_PROCESO", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTL_TRAZABILIDAD_PROCESO.Name, "V_OTL_TRAZABILIDAD_PROCESOLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>14/09/2015 11:16:46 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtlTrazabilidadProcesolst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTL_TRAZABILIDAD_PROCESOLst", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
