...
Namespace OrdenesDeTrabajo.AccesoDatos.Catalogos
    Public Class DalOtmCategoriaServicio
        Inherits DalBase
...
#Region "Funciones"
        ...
        Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Dim vlo_RegistroInterno As EntOtmCategoriaServicio
            Dim vln_Resultado As Integer

            Try
                vln_Resultado = -1
                vlo_RegistroInterno = CType(pvo_Registro, EntOtmCategoriaServicio)
                ...
                vlc_Sentencia = "prI_OTM_CATEGORIA_SERVICIO"

                vlo_Conexion.SetParameter("pvc_SiglasOrdenTrabajoHija", OracleDbType.Varchar2, vlo_RegistroInterno.Siglas)
                vlo_Conexion.SetParameter("pvn_RequiereFichaTecnica", OracleDbType.Int32, vlo_RegistroInterno.RequiereFichaTecnica)
                vlo_Conexion.SetParameter("pvn_IdUbicacionAdministra", OracleDbType.Int32, vlo_RegistroInterno.IdUbicacionAdministra)
                vlo_Conexion.SetParameter("pvn_OcultarCategoria", OracleDbType.Int32, vlo_RegistroInterno.OcultarCategoria)
                vlo_Conexion.SetParameter("prn_IdCategoriaServicio", OracleDbType.Int32, vln_Resultado, ParameterDirection.Output)
                vlo_Conexion.SetParameter("pvn_NumEmpleadoSupervisor", OracleDbType.Double, vlo_RegistroInterno.NumEmpleadoSupervisor)
                ...
                vln_Resultado = CType(vlo_Conexion.GetParameterValue("prn_IdCategoriaServicio"), Integer)
        ...
        Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prD_OTM_CATEGORIA_SERVICIO"
        ...
        ''' <summary>
        ''' Permite modificar un registro en la tabla OTM_CATEGORIA_SERVICIO
        ''' </summary>
        ''' <param name="pvo_Registro">Entidad a procesar</param>
        ''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ...
        Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTM_CATEGORIA_SERVICIO"
        ...
        Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
            ...
            Dim vlo_Resultado As New EntOtmCategoriaServicio

            Try
                vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_CATEGORIA_SERVICIO.SIGLAS_ORDEN_TRABAJO_HIJA, "Siglas"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_CATEGORIA_SERVICIO.REQUIERE_FICHA_TECNICA, "RequiereFichaTecnica"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_CATEGORIA_SERVICIO.ID_UBICACION_ADMINISTRA, "IdUbicacionAdministra"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_CATEGORIA_SERVICIO.OCULTAR_CATEGORIA, "OcultarCategoria"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_CATEGORIA_SERVICIO.ID_CATEGORIA_SERVICIO, "IdCategoriaServicio"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_CATEGORIA_SERVICIO.NUM_EMPLEADO_SUPERVISOR, "NumEmpleadoSupervisor"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_CATEGORIA_SERVICIO.ID_SECTOR_TALLER, "IdSectorTaller"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_CATEGORIA_SERVICIO.DESCRIPCION, "Descripcion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_CATEGORIA_SERVICIO.ESTADO, "Estado"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_CATEGORIA_SERVICIO.TIME_STAMP, "TimeStamp"))

                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtmCategoriaServicio)(vlo_MapeoEntidad)
        ...
        Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_CATEGORIA_SERVICIO.Name, "V_OTM_CATEGORIA_SERVICIO", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>15/01/2016 11:15:03 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtmCategoriaServicio(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTM_CATEGORIA_SERVICIO", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_CATEGORIA_SERVICIO.Name, "V_OTM_CATEGORIA_SERVICIOLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>15/01/2016 11:15:03 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtmCategoriaServiciolst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTM_CATEGORIA_SERVICIOLst", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        ''' <changeLog></changeLog>
        Public Function ListarVOtTallerCategoriasSup(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OT_TALLER_CATEGORIAS_SUP.Name, V_OT_TALLER_CATEGORIAS_SUP.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
