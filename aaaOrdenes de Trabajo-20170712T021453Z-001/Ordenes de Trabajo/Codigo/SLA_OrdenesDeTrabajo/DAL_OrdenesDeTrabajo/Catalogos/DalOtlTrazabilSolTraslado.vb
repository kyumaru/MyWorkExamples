...
Namespace ORDENES_TRABAJO.AccesoDatos.Catalogos
    Public Class DalOtlTrazabilSolTraslado
        Inherits DalBase
...
#Region "Funciones"
        ...
        ''' <creationDate>18/08/2016 01:58:33 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Dim vlo_RegistroInterno As EntOtlTrazabilSolTraslado
            Dim vln_Resultado As Integer

            Try
                vln_Resultado = -1
                vlo_RegistroInterno = CType(pvo_Registro, EntOtlTrazabilSolTraslado)
                ...
                vlc_Sentencia = "prI_OTL_TRAZABIL_SOL_TRASLADO"

                vlo_Conexion.SetParameter("prn_IdTrazabilSolTraslado", OracleDbType.Int32, vln_Resultado, ParameterDirection.Output)
                ...
                vlo_Conexion.SetParameter("pvc_EstadoTraslado", OracleDbType.Varchar2, vlo_RegistroInterno.EstadoTraslado)
                If Not String.IsNullOrWhiteSpace(vlo_RegistroInterno.Observaciones) Then
                ...
                vln_Resultado = CType(vlo_Conexion.GetParameterValue("prn_IdTrazabilSolTraslado"), Integer)
        ...
        Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prD_OTL_TRAZABIL_SOL_TRASLADO"

                vlo_Conexion.SetParameter("pvn_IdTrazabilSolTraslado", OracleDbType.Int32, vlo_RegistroInterno.IdTrazabilSolTraslado)
        ...
        ''' <summary>
        ''' Permite modificar un registro en la tabla OTL_TRAZABIL_SOL_TRASLADO
        ''' </summary>
        ''' <param name="pvo_Registro">Entidad a procesar</param>
        ''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ...
        Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTL_TRAZABIL_SOL_TRASLADO"
        ...
        Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
            ...
            Dim vlo_Resultado As New EntOtlTrazabilSolTraslado

            Try
                vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABIL_SOL_TRASLADO.ID_TRAZABIL_SOL_TRASLADO, "IdTrazabilSolTraslado"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABIL_SOL_TRASLADO.ID_UBICACION, "IdUbicacion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABIL_SOL_TRASLADO.ANNO, "Anno"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABIL_SOL_TRASLADO.ID_SOLICITUD_TRASLADO, "IdSolicitudTraslado"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABIL_SOL_TRASLADO.ESTADO_TRASLADO, "EstadoTraslado"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABIL_SOL_TRASLADO.OBSERVACIONES, "Observaciones"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABIL_SOL_TRASLADO.USUARIO, "Usuario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABIL_SOL_TRASLADO.TIME_STAMP, "TimeStamp"))

                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtlTrazabilSolTraslado)(vlo_MapeoEntidad)
        ...
        Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTL_TRAZABIL_SOL_TRASLADO.Name, "V_OTL_TRAZABIL_SOL_TRASLADO", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>09/08/2016 09:12:03 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtlTrazabilSolTraslado(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTL_TRAZABIL_SOL_TRASLADO", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTL_TRAZABIL_SOL_TRASLADO.Name, "V_OTL_TRAZABIL_SOL_TRASLADOLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>09/08/2016 09:12:03 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtlTrazabilSolTrasladolst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTL_TRAZABIL_SOL_TRASLADOLst", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
