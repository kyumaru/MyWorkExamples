...
Namespace OrdenesDeTrabajo.AccesoDatos.Catalogos
	Public Class DalOtmEtapaOrdenTrabajo
		Inherits DalBase
...
#Region "Funciones"
	...
	Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Dim vlo_RegistroInterno As EntOtmEtapaOrdenTrabajo
		Dim vln_Resultado As Integer

		Try
			vln_Resultado = -1
			vlo_RegistroInterno = CType(pvo_Registro, EntOtmEtapaOrdenTrabajo)
			...
			vlc_Sentencia = "prI_OTM_ETAPA_ORDEN_TRABAJO"

			vlo_Conexion.SetParameter("prn_IdEtapaOrdenTrabajo", OracleDbType.Int32, vln_Resultado, ParameterDirection.Output)
			...
			vln_Resultado = CType(vlo_Conexion.GetParameterValue("prn_IdEtapaOrdenTrabajo"), Integer)
	...
	Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prD_OTM_ETAPA_ORDEN_TRABAJO"
	...
	''' <summary>
	''' Permite modificar un registro en la tabla OTM_ETAPA_ORDEN_TRABAJO
	''' </summary>
	''' <param name="pvo_Registro">Entidad a procesar</param>
	''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
	''' <author>Generador de Código basado en objetos Oracle</author>
	...
	Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prU_OTM_ETAPA_ORDEN_TRABAJO"
	...
	Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
		...
		Dim vlo_Resultado As New EntOtmEtapaOrdenTrabajo

		Try
			vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
			If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
				vlo_MapeoEntidad = New List(Of MapeoSimple)
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ETAPA_ORDEN_TRABAJO.ID_ETAPA_ORDEN_TRABAJO, "IdEtapaOrdenTrabajo"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ETAPA_ORDEN_TRABAJO.DESCRIPCION, "Descripcion"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ETAPA_ORDEN_TRABAJO.ORDEN, "Orden"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ETAPA_ORDEN_TRABAJO.ESTADO, "Estado"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ETAPA_ORDEN_TRABAJO.USUARIO, "Usuario"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ETAPA_ORDEN_TRABAJO.TIME_STAMP, "TimeStamp"))

				vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtmEtapaOrdenTrabajo)(vlo_MapeoEntidad)
	...
	Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_ETAPA_ORDEN_TRABAJO.Name, "V_OTM_ETAPA_ORDEN_TRABAJO", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_ETAPA_ORDEN_TRABAJO.Name, "V_OTM_ETAPA_ORDEN_TRABAJOLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>29/01/2016 04:20:42 p.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ListarVOtmEtapaOrdenTrabajo(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_DsDatos As New DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTM_ETAPA_ORDEN_TRABAJO.Name, V_OTM_ETAPA_ORDEN_TRABAJO.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>29/01/2016 04:20:42 p.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtmEtapaOrdenTrabajo(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTM_ETAPA_ORDEN_TRABAJO.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
	...
	''' <creationDate>29/01/2016 04:20:42 p.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ListarVOtmEtapaOrdenTrabajolst(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_DsDatos As New DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTM_ETAPA_ORDEN_TRABAJOLST.Name, V_OTM_ETAPA_ORDEN_TRABAJOLST.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>29/01/2016 04:20:42 p.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtmEtapaOrdenTrabajolst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_Resultado As EntDatosPaginacion
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTM_ETAPA_ORDEN_TRABAJOLST.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
