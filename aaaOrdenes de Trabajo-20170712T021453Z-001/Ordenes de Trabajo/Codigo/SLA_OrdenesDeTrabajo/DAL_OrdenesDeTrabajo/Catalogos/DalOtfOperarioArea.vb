...
Namespace OrdenesDeTrabajo.AccesoDatos.Catalogos
	Public Class DalOtfOperarioArea
		Inherits DalBase
...
#Region "Funciones"
	...
	Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Dim vlo_RegistroInterno As EntOtfOperarioArea
		Dim vln_Resultado As Integer

		Try
                vln_Resultado = -1
                vlo_RegistroInterno = CType(pvo_Registro, EntOtfOperarioArea)
                ...
                vlc_Sentencia = "prI_OTF_OPERARIO_AREA"
                ...
                If vlo_RegistroInterno.IdAreaProfesional <> 0 Then
                    vlo_Conexion.SetParameter("pvn_IdAreaProfesional", OracleDbType.Int32, vlo_RegistroInterno.IdAreaProfesional)
                End If
                vlo_Conexion.SetParameter("pvc_CategoriaLaboral", OracleDbType.Varchar2, vlo_RegistroInterno.CategoriaLaboral)
	...
	Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prD_OTF_OPERARIO_AREA"
	...
	''' <summary>
	''' Permite modificar un registro en la tabla OTF_OPERARIO_AREA
	''' </summary>
	''' <param name="pvo_Registro">Entidad a procesar</param>
	''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
	''' <author>Generador de Código basado en objetos Oracle</author>
	...
	Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prU_OTF_OPERARIO_AREA"
	...
	Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
		...
		Dim vlo_Resultado As New EntOtfOperarioArea

		Try
			vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
			If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
				vlo_MapeoEntidad = New List(Of MapeoSimple)
				vlo_MapeoEntidad.Add(New MapeoSimple(OTF_OPERARIO_AREA.NUM_EMPLEADO, "NumEmpleado"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTF_OPERARIO_AREA.ID_SECTOR_TALLER, "IdSectorTaller"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTF_OPERARIO_AREA.ID_AREA_PROFESIONAL, "IdAreaProfesional"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTF_OPERARIO_AREA.CATEGORIA_LABORAL, "CategoriaLaboral"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTF_OPERARIO_AREA.ESTADO, "Estado"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTF_OPERARIO_AREA.USUARIO, "Usuario"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTF_OPERARIO_AREA.TIME_STAMP, "TimeStamp"))

				vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtfOperarioArea)(vlo_MapeoEntidad)
	...
	Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTF_OPERARIO_AREA.Name, "V_OTF_OPERARIO_AREA", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>27/01/2016 12:12:35 p.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtfOperarioArea(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTF_OPERARIO_AREA", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
	...
	Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTF_OPERARIO_AREA.Name, "V_OTF_OPERARIO_AREALst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>27/01/2016 12:12:35 p.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtfOperarioArealst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_Resultado As EntDatosPaginacion
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTF_OPERARIO_AREALst", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
