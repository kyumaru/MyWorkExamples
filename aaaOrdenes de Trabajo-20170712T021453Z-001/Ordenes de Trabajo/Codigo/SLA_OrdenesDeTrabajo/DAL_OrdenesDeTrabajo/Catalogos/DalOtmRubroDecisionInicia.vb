...
Namespace OrdenesDeTrabajo.AccesoDatos.Catalogos
	Public Class DalOtmRubroDecisionInicia
		Inherits DalBase
...
#Region "Funciones"
	...
	Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Dim vlo_RegistroInterno As EntOtmRubroDecisionInicia
		Dim vln_Resultado As Integer

		Try
			vln_Resultado = -1
			vlo_RegistroInterno = CType(pvo_Registro, EntOtmRubroDecisionInicia)
			...
			vlc_Sentencia = "prI_OTM_RUBRO_DECISION_INICIA"

			vlo_Conexion.SetParameter("prn_IdRubroDecisionInicia", OracleDbType.Int32, vln_Resultado, ParameterDirection.Output)
			...
			vln_Resultado = CType(vlo_Conexion.GetParameterValue("prn_IdRubroDecisionInicia"), Integer)
	...
	Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prD_OTM_RUBRO_DECISION_INICIA"
	...
	''' <summary>
	''' Permite modificar un registro en la tabla OTM_RUBRO_DECISION_INICIA
	''' </summary>
	''' <param name="pvo_Registro">Entidad a procesar</param>
	''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
	''' <author>Generador de Código basado en objetos Oracle</author>
	...
	Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prU_OTM_RUBRO_DECISION_INICIA"
	...
	Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
		...
		Dim vlo_Resultado As New EntOtmRubroDecisionInicia

		Try
			vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
			If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
				vlo_MapeoEntidad = New List(Of MapeoSimple)
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_RUBRO_DECISION_INICIA.ID_RUBRO_DECISION_INICIA, "IdRubroDecisionInicia"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_RUBRO_DECISION_INICIA.DESCRIPCION, "Descripcion"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_RUBRO_DECISION_INICIA.ORDEN, "Orden"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_RUBRO_DECISION_INICIA.ESTADO, "Estado"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_RUBRO_DECISION_INICIA.USUARIO, "Usuario"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_RUBRO_DECISION_INICIA.TIME_STAMP, "TimeStamp"))

				vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtmRubroDecisionInicia)(vlo_MapeoEntidad)
	...
	Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_RUBRO_DECISION_INICIA.Name, "V_OTM_RUBRO_DECISION_INICIA", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>16/03/2016 09:48:14 a.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtmRubroDecisionInicia(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTM_RUBRO_DECISION_INICIA", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
	...
	Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_RUBRO_DECISION_INICIA.Name, "V_OTM_RUBRO_DECISION_INICIALst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>16/03/2016 09:48:14 a.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtmRubroDecisionInicialst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_Resultado As EntDatosPaginacion
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTM_RUBRO_DECISION_INICIALst", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        ''' <summary>
        ''' Permite Bajar el orden de un Rubro
        ''' </summary>
        ''' <param name="pvn_PvnIdRubro"></param>
        ''' <remarks></remarks>
        ''' <author>César Bermudez</author>
        ''' <creationDate>16/03/2016</creationDate>
        ''' <changeLog></changeLog>
        Public Sub EjecutarPrOtBajarRubro(pvn_PvnIdRubro As Integer)
            Dim vlo_Conexion As DbBase
            Dim vlc_Sentencia As String
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlc_Sentencia = "PR_OT_BAJAR_RUBRO"

                vlo_Conexion.SetParameter("pvn_IdRubro", OracleDbType.Int32, pvn_PvnIdRubro)
        ...
        ''' <summary>
        ''' Permite subir el rubro de orden
        ''' </summary>
        ''' <param name="pvn_PvnIdRubro"></param>
        ''' <remarks></remarks>
        ''' <author>César Bermudez</author>
        ''' <creationDate>16/03/2016</creationDate>
        ''' <changeLog></changeLog>
        Public Sub EjecutarPrOtSubirRubro(pvn_PvnIdRubro As Integer)
            Dim vlo_Conexion As DbBase
            Dim vlc_Sentencia As String
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlc_Sentencia = "PR_OT_SUBIR_RUBRO"
        ...
        ''' <summary>
        ''' Obtiene el ultimo valor de orden proveniente de la tabla OTM_RUBRO_DECISION_INICIA
        ''' </summary>
        ''' <author>César Bermudez</author>
        ''' <creationDate>16/03/2016</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerFnOtObtenerUltimoOrden() As Double
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlc_Sentencia As String
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlc_Sentencia = "SELECT FN_OT_ULTIMO_ORDEN_RUBROS() AS RESULTADO FROM DUAL"
