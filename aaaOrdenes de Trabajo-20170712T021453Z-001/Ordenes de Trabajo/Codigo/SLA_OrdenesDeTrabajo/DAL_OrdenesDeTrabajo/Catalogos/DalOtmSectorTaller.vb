...
Namespace OrdenesDeTrabajo.AccesoDatos.Catalogos
    Public Class DalOtmSectorTaller
        Inherits DalBase
...
#Region "Funciones"
        ...
        Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Dim vlo_RegistroInterno As EntOtmSectorTaller
            Dim vln_Resultado As Integer

            Try
                vln_Resultado = -1
                vlo_RegistroInterno = CType(pvo_Registro, EntOtmSectorTaller)
                ...
                vlc_Sentencia = "prI_OTM_SECTOR_TALLER"

                vlo_Conexion.SetParameter("pvn_IdUbicacionAdministra", OracleDbType.Int32, vlo_RegistroInterno.IdUbicacionAdministra)
                vlo_Conexion.SetParameter("pvn_NumEmpleadoCoordinador", OracleDbType.Double, vlo_RegistroInterno.NumEmpleadoCoordinador)
                If vlo_RegistroInterno.NumEmpleadoSustituto <> 0 Then
                    vlo_Conexion.SetParameter("pvn_NumEmpleadoSustituto", OracleDbType.Double, vlo_RegistroInterno.NumEmpleadoSustituto)
                End If
                vlo_Conexion.SetParameter("prn_IdSectorTaller", OracleDbType.Int32, vln_Resultado, ParameterDirection.Output)
                vlo_Conexion.SetParameter("pvc_Nombre", OracleDbType.Varchar2, vlo_RegistroInterno.Nombre)
                vlo_Conexion.SetParameter("pvc_TipoArea", OracleDbType.Varchar2, vlo_RegistroInterno.TipoArea)
                ...
                vln_Resultado = CType(vlo_Conexion.GetParameterValue("prn_IdSectorTaller"), Integer)
        ...
        Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prD_OTM_SECTOR_TALLER"
        ...
        ''' <summary>
        ''' Permite modificar un registro en la tabla OTM_SECTOR_TALLER
        ''' </summary>
        ''' <param name="pvo_Registro">Entidad a procesar</param>
        ''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ...
        Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTM_SECTOR_TALLER"
        ...
        Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
            ...
            Dim vlo_Resultado As New EntOtmSectorTaller

            Try
                vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_SECTOR_TALLER.ID_UBICACION_ADMINISTRA, "IdUbicacionAdministra"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_SECTOR_TALLER.NUM_EMPLEADO_COORDINADOR, "NumEmpleadoCoordinador"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_SECTOR_TALLER.NUM_EMPLEADO_SUSTITUTO, "NumEmpleadoSustituto"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_SECTOR_TALLER.ID_SECTOR_TALLER, "IdSectorTaller"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_SECTOR_TALLER.NOMBRE, "Nombre"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_SECTOR_TALLER.TIPO_AREA, "TipoArea"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_SECTOR_TALLER.ESTADO, "Estado"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_SECTOR_TALLER.TIME_STAMP, "TimeStamp"))

                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtmSectorTaller)(vlo_MapeoEntidad)
        ...
        Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_SECTOR_TALLER.Name, "V_OTM_SECTOR_TALLER", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>10/09/2015 10:29:57 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtmSectorTaller(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTM_SECTOR_TALLER", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_SECTOR_TALLER.Name, "V_OTM_SECTOR_TALLERLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>10/09/2015 10:29:57 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtmSectorTallerlst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTM_SECTOR_TALLERLst", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        ''' <creationDate>10/09/2015 10:29:57 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerRegistroLista(ByVal pvc_Condicion As String) As EntBase
            Dim vlo_MapeoEntidad As List(Of MapeoSimple)
            Dim vlo_DsDatos As DataSet
            Dim vlo_Resultado As New EntOtmSectorTaller
            ...
            Try
                ...
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(V_OTM_SECTOR_TALLERLST.ID_UBICACION_ADMINISTRA, "IdUbicacionAdministra"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(V_OTM_SECTOR_TALLERLST.NUM_EMPLEADO_COORDINADOR, "NumEmpleadoCoordinador"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(V_OTM_SECTOR_TALLERLST.NUM_EMPLEADO_SUSTITUTO, "NumEmpleadoSustituto"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(V_OTM_SECTOR_TALLERLST.ID_SECTOR_TALLER, "IdSectorTaller"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(V_OTM_SECTOR_TALLERLST.NOMBRE, "Nombre"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(V_OTM_SECTOR_TALLERLST.TIPO_AREA, "TipoArea"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(V_OTM_SECTOR_TALLERLST.ESTADO, "Estado"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(V_OTM_SECTOR_TALLERLST.TIME_STAMP, "TimeStamp"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(V_OTM_SECTOR_TALLERLST.NOMBRE_COORDINADOR, "NombreCoodinador"))
                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtmSectorTaller)(vlo_MapeoEntidad)
                    vlo_Resultado.Existe = True
                End If
