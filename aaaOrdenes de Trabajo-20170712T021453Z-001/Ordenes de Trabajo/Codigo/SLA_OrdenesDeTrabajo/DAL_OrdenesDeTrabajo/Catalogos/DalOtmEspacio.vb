...
#Region "Funciones"
	...
	Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Dim vlo_RegistroInterno As EntOtmEspacio
		Dim vln_Resultado As Integer

		Try
			vln_Resultado = -1
			vlo_RegistroInterno = CType(pvo_Registro, EntOtmEspacio)
	...
	''' <summary>
	''' Permite modificar un registro en la tabla OTM_ESPACIO
	''' </summary>
	''' <param name="pvo_Registro">Entidad a procesar</param>
	''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
	''' <author>Generador de Código basado en objetos Oracle</author>
	...
	Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
		...
		Dim vlo_Resultado As New EntOtmEspacio

		Try
			vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
			If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
				vlo_MapeoEntidad = New List(Of MapeoSimple)
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ESPACIO.ID_ESPACIO, "IdEspacio"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ESPACIO.ID_UBICACION, "IdUbicacion"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ESPACIO.DESCRIPCION, "Descripcion"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ESPACIO.ORDEN, "Orden"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ESPACIO.ESTADO, "Estado"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ESPACIO.USUARIO, "Usuario"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_ESPACIO.TIME_STAMP, "TimeStamp"))

				vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtmEspacio)(vlo_MapeoEntidad)
	...
	Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_ESPACIO.Name, "V_OTM_ESPACIO", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>09/11/2015 03:51:04 p.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtmEspacio(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTM_ESPACIO", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
	...
	Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_ESPACIO.Name, "V_OTM_ESPACIOLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>09/11/2015 03:51:04 p.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtmEspaciolst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_Resultado As EntDatosPaginacion
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTM_ESPACIOLst", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        ''' <summary>
        ''' Obtiene el ultimo valor de orden proveniente de la tabla OTM_ESPACIO
        ''' </summary>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ...
        Public Function ObtenerFnOtObtenerUltimoOrden() As Double
            ...
            Try
                ...
                vlc_Sentencia = "SELECT FN_OT_OBTENER_ULTIMO_ORDEN() AS RESULTADO FROM DUAL"
        ...
        ''' <summary>
        ''' Permite ejecutar el procedimiento PR_OT_BAJAR_ESPACIO
        ''' </summary>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ''' <creationDate>12/11/2015 10:48:28 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Sub EjecutarPrOtBajarespacio(pvn_PvnIdespacio As Integer)
            Dim vlo_Conexion As DbBase
            Dim vlc_Sentencia As String
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlc_Sentencia = "PR_OT_BAJAR_ESPACIO"
        ...
        ''' <summary>
        ''' Permite ejecutar el procedimiento PR_OT_SUBIR_ESPACIO
        ''' </summary>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ''' <creationDate>12/11/2015 10:48:28 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Sub EjecutarPrOtSubirespacio(pvn_PvnIdespacio As Integer)
            Dim vlo_Conexion As DbBase
            Dim vlc_Sentencia As String
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlc_Sentencia = "PR_OT_SUBIR_ESPACIO"
