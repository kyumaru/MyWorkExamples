...
Namespace OrdenesDeTrabajo.AccesoDatos.Catalogos
	Public Class DalOtmSubcategoriaMaterial
		Inherits DalBase
...
#Region "Funciones"
	...
	Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Dim vlo_RegistroInterno As EntOtmSubcategoriaMaterial
		Dim vln_Resultado As Integer

		Try
			vln_Resultado = -1
			vlo_RegistroInterno = CType(pvo_Registro, EntOtmSubcategoriaMaterial)
			...
			vlc_Sentencia = "prI_OTM_SUBCATEGORIA_MATERIAL"

			vlo_Conexion.SetParameter("prn_IdSubcategoriaMaterial", OracleDbType.Int32, vln_Resultado, ParameterDirection.Output)
			...
			vln_Resultado = CType(vlo_Conexion.GetParameterValue("prn_IdSubcategoriaMaterial"), Integer)
	...
	Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prD_OTM_SUBCATEGORIA_MATERIAL"
	...
	''' <summary>
	''' Permite modificar un registro en la tabla OTM_SUBCATEGORIA_MATERIAL
	''' </summary>
	''' <param name="pvo_Registro">Entidad a procesar</param>
	''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
	''' <author>Generador de Código basado en objetos Oracle</author>
	...
	Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prU_OTM_SUBCATEGORIA_MATERIAL"
	...
	Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
		...
		Dim vlo_Resultado As New EntOtmSubcategoriaMaterial

		Try
			vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
			If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
				vlo_MapeoEntidad = New List(Of MapeoSimple)
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_SUBCATEGORIA_MATERIAL.ID_SUBCATEGORIA_MATERIAL, "IdSubcategoriaMaterial"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_SUBCATEGORIA_MATERIAL.ID_UBICACION_ADMINISTRA, "IdUbicacionAdministra"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_SUBCATEGORIA_MATERIAL.DESCRIPCION, "Descripcion"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_SUBCATEGORIA_MATERIAL.ESTADO, "Estado"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_SUBCATEGORIA_MATERIAL.USUARIO, "Usuario"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_SUBCATEGORIA_MATERIAL.TIME_STAMP, "TimeStamp"))

				vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtmSubcategoriaMaterial)(vlo_MapeoEntidad)
	...
	Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_SUBCATEGORIA_MATERIAL.Name, "V_OTM_SUBCATEGORIA_MATERIAL", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_SUBCATEGORIA_MATERIAL.Name, "V_OTM_SUBCATEGORIA_MATERIALLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>19/05/2016 09:54:59 a.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ListarVOtmSubcategoriaMaterial(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_DsDatos As New DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTM_SUBCATEGORIA_MATERIAL.Name, V_OTM_SUBCATEGORIA_MATERIAL.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>19/05/2016 09:54:59 a.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtmSubcategoriaMaterial(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTM_SUBCATEGORIA_MATERIAL.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
	...
	''' <creationDate>19/05/2016 09:54:59 a.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ListarVOtmSubcategoriaMateriallst(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_DsDatos As New DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTM_SUBCATEGORIA_MATERIALLST.Name, V_OTM_SUBCATEGORIA_MATERIALLST.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>19/05/2016 09:54:59 a.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtmSubcategoriaMateriallst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_Resultado As EntDatosPaginacion
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTM_SUBCATEGORIA_MATERIALLST.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
