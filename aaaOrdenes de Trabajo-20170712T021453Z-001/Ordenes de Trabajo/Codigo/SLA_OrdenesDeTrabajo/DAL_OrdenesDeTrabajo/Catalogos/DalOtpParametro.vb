...
#Region "Funciones"
	''' <summary>
	''' Permite agregar un registro en la tabla OTP_PARAMETRO
	''' </summary>
	...
	Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Dim vlo_RegistroInterno As EntOtpParametro
		Dim vln_Resultado As Integer

		Try
			vln_Resultado = -1
			vlo_RegistroInterno = CType(pvo_Registro, EntOtpParametro)
			...
			vlc_Sentencia = "prI_OTP_PARAMETRO"
	...
	''' <summary>
	''' Permite borrar un registro en la tabla OTP_PARAMETRO
	''' </summary>
	''' <param name="pvo_Registro">Entidad a procesar</param>
	...
	Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prD_OTP_PARAMETRO"
	...
	''' <summary>
	''' Permite modificar un registro en la tabla OTP_PARAMETRO
	''' </summary>
	''' <param name="pvo_Registro">Entidad a procesar</param>
	''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
	''' <author>Generador de Código basado en objetos Oracle</author>
	...
	Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prU_OTP_PARAMETRO"
	...
	''' <summary>
	''' Obtiene un registro de la tabla OTP_PARAMETRO según el criterio indicado
	''' </summary>
	...
	Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
		...
		Dim vlo_Resultado As New EntOtpParametro

		Try
			vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
			If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
				vlo_MapeoEntidad = New List(Of MapeoSimple)
				vlo_MapeoEntidad.Add(New MapeoSimple(OTP_PARAMETRO.ID_PARAMETRO, "IdParametro"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTP_PARAMETRO.DESCRIPCION, "Descripcion"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTP_PARAMETRO.VALOR, "Valor"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTP_PARAMETRO.VALOR_DECIMAL, "ValorDecimal"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTP_PARAMETRO.PROTEGIDO, "Protegido"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTP_PARAMETRO.USUARIO, "Usuario"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTP_PARAMETRO.TIME_STAMP, "TimeStamp"))

				vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtpParametro)(vlo_MapeoEntidad)
	...
	''' <summary>
	''' Obtiene los registros de la vista V_OTP_PARAMETRO según el criterio y orden indicados
	''' </summary>
	''' <param name="pvc_Condicion">Corresponde al detalle de la cláusula WHERE</param>
	...
	Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTP_PARAMETRO.Name, "V_OTP_PARAMETRO", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <summary>
	''' Obtiene la cantidad de registros y páginas que retornará la consulta a la vista V_OTP_PARAMETRO según el criterio y orden indicados
	''' </summary>
	''' <param name="pvc_Condicion">Corresponde al detalle de la cláusula WHERE</param>
	''' <param name="pvc_Orden">Corresponde al detalle de la cláusula ORDER BY</param>
	''' <param name="pvn_TamanoPagina">Indica la cantidad máxima de registro a retornar por página</param>
	...
	''' <creationDate>09/09/2015 01:54:27 p.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtpParametro(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTP_PARAMETRO", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
	...
	''' <summary>
	''' Obtiene los registros de la vista V_OTP_PARAMETROLst según el criterio y orden indicados
	''' </summary>
	''' <param name="pvc_Condicion">Corresponde al detalle de la cláusula WHERE</param>
	''' <param name="pvc_Orden">Corresponde al detalle de la cláusula ORDER BY</param>
	''' <param name="pvb_Paginar">Indica si debe paginarse el resultado de la consulta</param>
	...
	Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTP_PARAMETRO.Name, "V_OTP_PARAMETROLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <summary>
	''' Obtiene la cantidad de registros y páginas que retornará la consulta a la vista V_OTP_PARAMETROLst según el criterio y orden indicados
	''' </summary>
	''' <param name="pvc_Condicion">Corresponde al detalle de la cláusula WHERE</param>
	''' <param name="pvc_Orden">Corresponde al detalle de la cláusula ORDER BY</param>
	''' <param name="pvn_TamanoPagina">Indica la cantidad máxima de registro a retornar por página</param>
	...
	''' <creationDate>09/09/2015 01:54:27 p.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtpParametrolst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_Resultado As EntDatosPaginacion
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTP_PARAMETROLst", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
