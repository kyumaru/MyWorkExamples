...
#Region "Funciones"
        ...
        Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Dim vlo_RegistroInterno As EntOtmProveedor
            Dim vln_Resultado As Integer

            Try
                vln_Resultado = -1
                vlo_RegistroInterno = CType(pvo_Registro, EntOtmProveedor)
                ...
                vlc_Sentencia = "prI_OTM_PROVEEDOR"

                vlo_Conexion.SetParameter("pvc_Identificacion", OracleDbType.Varchar2, vlo_RegistroInterno.Identificacion)
                vlo_Conexion.SetParameter("pvc_TipoProveedor", OracleDbType.Varchar2, vlo_RegistroInterno.TipoProveedor)
                vlo_Conexion.SetParameter("pvc_Nombre", OracleDbType.Varchar2, vlo_RegistroInterno.Nombre)
                vlo_Conexion.SetParameter("pvc_Direccion", OracleDbType.Varchar2, vlo_RegistroInterno.Direccion)
                If vlo_RegistroInterno.Nombre <> Constantes.VALOR_DEFECTO_STRING AndAlso vlo_RegistroInterno.SitioWeb <> String.Empty Then
                    vlo_Conexion.SetParameter("pvc_SitioWeb", OracleDbType.Varchar2, vlo_RegistroInterno.SitioWeb)
                End If
                If vlo_RegistroInterno.Nombre <> Constantes.VALOR_DEFECTO_STRING AndAlso vlo_RegistroInterno.Observaciones <> String.Empty Then
                    vlo_Conexion.SetParameter("pvc_Observaciones", OracleDbType.Varchar2, vlo_RegistroInterno.Observaciones)
                End If
                If vlo_RegistroInterno.Nombre <> Constantes.VALOR_DEFECTO_STRING AndAlso vlo_RegistroInterno.Estado <> String.Empty Then
        ...
        Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prD_OTM_PROVEEDOR"
        ...
        ''' <summary>
        ''' Permite modificar un registro en la tabla OTM_PROVEEDOR
        ''' </summary>
        ''' <param name="pvo_Registro">Entidad a procesar</param>
        ''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ...
        Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTM_PROVEEDOR"
        ...
        Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
            ...
            Dim vlo_Resultado As New EntOtmProveedor

            Try
                vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_PROVEEDOR.IDENTIFICACION, "Identificacion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_PROVEEDOR.TIPO_PROVEEDOR, "TipoProveedor"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_PROVEEDOR.NOMBRE, "Nombre"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_PROVEEDOR.DIRECCION, "Direccion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_PROVEEDOR.SITIO_WEB, "SitioWeb"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_PROVEEDOR.OBSERVACIONES, "Observaciones"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_PROVEEDOR.ESTADO, "Estado"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_PROVEEDOR.USUARIO, "Usuario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_PROVEEDOR.TIME_STAMP, "TimeStamp"))

                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtmProveedor)(vlo_MapeoEntidad)
        ...
        Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_PROVEEDOR.Name, "V_OTM_PROVEEDOR", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>04/08/2016 03:35:36 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtmProveedor(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTM_PROVEEDOR", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_PROVEEDOR.Name, "V_OTM_PROVEEDORLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>04/08/2016 03:35:36 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtmProveedorlst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTM_PROVEEDORLst", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
