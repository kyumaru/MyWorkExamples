...
Namespace OrdenesDeTrabajo.AccesoDatos.Catalogos
    Public Class DalOtmLugarTrabajo
        Inherits DalBase
...
#Region "Funciones"
        ...
        Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Dim vlo_RegistroInterno As EntOtmLugarTrabajo
            Dim vln_Resultado As Integer

            Try
                vln_Resultado = -1
                vlo_RegistroInterno = CType(pvo_Registro, EntOtmLugarTrabajo)
                ...
                vlc_Sentencia = "prI_OTM_LUGAR_TRABAJO"
                ...
                vlo_Conexion.SetParameter("prn_IdLugarTrabajo", OracleDbType.Int32, vln_Resultado, ParameterDirection.Output)
                vlo_Conexion.SetParameter("pvn_IdUbicacionPertenece", OracleDbType.Int32, vlo_RegistroInterno.IdUbicacionPertenece)
                ...
                'End If
                vlo_Conexion.SetParameter("pvn_IdTipoLugarUbicacion", OracleDbType.Int32, vlo_RegistroInterno.IdTipoLugarUbicacion)
                ...
                vln_Resultado = CType(vlo_Conexion.GetParameterValue("prn_IdLugarTrabajo"), Integer)
        ...
        Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prD_OTM_LUGAR_TRABAJO"
        ...
        ''' <summary>
        ''' Permite modificar un registro en la tabla OTM_LUGAR_TRABAJO
        ''' </summary>
        ''' <param name="pvo_Registro">Entidad a procesar</param>
        ''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ...
        Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTM_LUGAR_TRABAJO"
        ...
        Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
            ...
            Dim vlo_Resultado As New EntOtmLugarTrabajo

            Try
                vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_LUGAR_TRABAJO.ID_UBICACION_ADMINISTRA, "IdUbicacionAdministra"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_LUGAR_TRABAJO.ESTADO, "Estado"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_LUGAR_TRABAJO.ID_LUGAR_TRABAJO, "IdLugarTrabajo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_LUGAR_TRABAJO.ID_UBICACION_PERTENECE, "IdUbicacionPertenece"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_LUGAR_TRABAJO.ID_SECTOR_TALLER, "IdSectorTaller"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_LUGAR_TRABAJO.ID_TIPO_LUGAR_UBICACION, "IdTipoLugarUbicacion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_LUGAR_TRABAJO.NOMBRE, "Nombre"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_LUGAR_TRABAJO.CLASIFICACION, "Clasificacion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_LUGAR_TRABAJO.USUARIO, "Usuario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_LUGAR_TRABAJO.TIME_STAMP, "TimeStamp"))

                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtmLugarTrabajo)(vlo_MapeoEntidad)
        ...
        Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_LUGAR_TRABAJO.Name, "V_OTM_LUGAR_TRABAJO", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>08/09/2015 01:51:45 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtmLugarTrabajo(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTM_LUGAR_TRABAJO", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_LUGAR_TRABAJO.Name, "V_OTM_LUGAR_TRABAJOLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>08/09/2015 01:51:45 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtmLugarTrabajolst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTM_LUGAR_TRABAJOLst", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
