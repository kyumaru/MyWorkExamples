...
Namespace OrdenesDeTrabajo.AccesoDatos.Catalogos
    Public Class DalOtmUnidadEncargada
        Inherits DalBase
...
#Region "Funciones"
        ...
        Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Dim vlo_RegistroInterno As EntOtmUnidadEncargada
            Dim vln_Resultado As Integer

            Try
                vln_Resultado = -1
                vlo_RegistroInterno = CType(pvo_Registro, EntOtmUnidadEncargada)
                ...
                vlc_Sentencia = "prI_OTM_UNIDAD_ENCARGADA"
        ...
        Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prD_OTM_UNIDAD_ENCARGADA"
        ...
        ''' <summary>
        ''' Permite modificar un registro en la tabla OTM_UNIDAD_ENCARGADA
        ''' </summary>
        ''' <param name="pvo_Registro">Entidad a procesar</param>
        ''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ...
        Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTM_UNIDAD_ENCARGADA"
        ...
        Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
            ...
            Dim vlo_Resultado As New EntOtmUnidadEncargada

            Try
                vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_UNIDAD_ENCARGADA.ID_LUGAR_TRABAJO, "IdLugarTrabajo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_UNIDAD_ENCARGADA.COD_UNIDAD_SIRH, "CodUnidadSirh"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_UNIDAD_ENCARGADA.USUARIO, "Usuario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_UNIDAD_ENCARGADA.TIME_STAMP, "TimeStamp"))

                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtmUnidadEncargada)(vlo_MapeoEntidad)
        ...
        Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_UNIDAD_ENCARGADA.Name, "V_OTM_UNIDAD_ENCARGADA", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>14/03/2016 12:22:09 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtmUnidadEncargada(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTM_UNIDAD_ENCARGADA", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_UNIDAD_ENCARGADA.Name, "V_OTM_UNIDAD_ENCARGADALst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>14/03/2016 12:22:09 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtmUnidadEncargadalst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTM_UNIDAD_ENCARGADALst", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        ''' <summary>
        ''' Adaptador para ingresar las unidades encargadas de un edificio
        ''' </summary>
        ''' <param name="pvo_DsUnidades"></param>
        ''' <remarks></remarks>
        ''' <author>César Bermudez Garcia</author>
        ''' <creationDate>14/03/2016</creationDate>
        ''' <changeLog></changeLog>
        Sub AdapterUnidadEncargada(pvo_DsUnidades As DataSet)
            ...
            Try
                ...
                vlo_Conexion.AdapterCrear(String.Format("INSERT INTO OTM_UNIDAD_ENCARGADA (ID_LUGAR_TRABAJO, COD_UNIDAD_SIRH, USUARIO) VALUES (:ID_LUGAR_TRABAJO, :COD_UNIDAD_SIRH, :USUARIO)"),
                                          String.Empty,
                                          String.Format("DELETE FROM {0} WHERE {1} = :{1} AND {2} = :{2}", Modelo.OTM_UNIDAD_ENCARGADA.Name, Modelo.OTM_UNIDAD_ENCARGADA.ID_LUGAR_TRABAJO, Modelo.OTM_UNIDAD_ENCARGADA.COD_UNIDAD_SIRH))
                ...
                vlo_Conexion.AdapterAgregarParametro(":USUARIO", "USUARIO", DbType.Int32, ConexionOracle.TipoParametro.Insert)

                vlo_Conexion.AdapterAgregarParametro(String.Format(":{0}", Modelo.OTM_UNIDAD_ENCARGADA.ID_LUGAR_TRABAJO), String.Format("{0}", Modelo.OTM_UNIDAD_ENCARGADA.ID_LUGAR_TRABAJO), DbType.Int32, ConexionOracle.TipoParametro.Delete)
                vlo_Conexion.AdapterAgregarParametro(String.Format(":{0}", Modelo.OTM_UNIDAD_ENCARGADA.COD_UNIDAD_SIRH), String.Format("{0}", Modelo.OTM_UNIDAD_ENCARGADA.COD_UNIDAD_SIRH), DbType.Int32, ConexionOracle.TipoParametro.Delete)

                vlo_Conexion.AdapterActualizar(pvo_DsUnidades, pvo_DsUnidades.Tables(0).TableName)
