...
Namespace OrdenesDeTrabajo.AccesoDatos.Catalogos
	Public Class DalOtmUnidadTiempo
		Inherits DalBase
...
#Region "Funciones"
	...
	Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Dim vlo_RegistroInterno As EntOtmUnidadTiempo
		Dim vln_Resultado As Integer

		Try
			vln_Resultado = -1
			vlo_RegistroInterno = CType(pvo_Registro, EntOtmUnidadTiempo)
			...
			vlc_Sentencia = "prI_OTM_UNIDAD_TIEMPO"
			...
			vlo_Conexion.SetParameter("pvn_Unidad", OracleDbType.Int32, vlo_RegistroInterno.Unidad)
			vlo_Conexion.SetParameter("pvn_Valor", OracleDbType.Int32, vlo_RegistroInterno.Valor)
	...
	Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prD_OTM_UNIDAD_TIEMPO"
	...
	''' <summary>
	''' Permite modificar un registro en la tabla OTM_UNIDAD_TIEMPO
	''' </summary>
	''' <param name="pvo_Registro">Entidad a procesar</param>
	''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
	''' <author>Generador de Código basado en objetos Oracle</author>
	...
	Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prU_OTM_UNIDAD_TIEMPO"
	...
	Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
		...
		Dim vlo_Resultado As New EntOtmUnidadTiempo

		Try
			vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
			If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
				vlo_MapeoEntidad = New List(Of MapeoSimple)
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_UNIDAD_TIEMPO.ID_UNIDAD_TIEMPO, "IdUnidadTiempo"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_UNIDAD_TIEMPO.DESCRIPCION, "Descripcion"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_UNIDAD_TIEMPO.UNIDAD, "Unidad"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_UNIDAD_TIEMPO.VALOR, "Valor"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_UNIDAD_TIEMPO.ESTADO, "Estado"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_UNIDAD_TIEMPO.USUARIO, "Usuario"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTM_UNIDAD_TIEMPO.TIME_STAMP, "TimeStamp"))

				vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtmUnidadTiempo)(vlo_MapeoEntidad)
	...
	Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_UNIDAD_TIEMPO.Name, "V_OTM_UNIDAD_TIEMPO", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>15/01/2016 02:29:16 p.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtmUnidadTiempo(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTM_UNIDAD_TIEMPO", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
	...
	Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_UNIDAD_TIEMPO.Name, "V_OTM_UNIDAD_TIEMPOLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>15/01/2016 02:29:16 p.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtmUnidadTiempolst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_Resultado As EntDatosPaginacion
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTM_UNIDAD_TIEMPOLst", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
