...
Namespace OrdenesDeTrabajo.AccesoDatos.Catalogos
	Public Class DalOtmSubcategoriaCategor
		Inherits DalBase
...
#Region "Metodos"
        ...
        ''' <summary>
        ''' Adapter para OTM_SUBCATEGORIA_CATEGOR
        ''' </summary>
        ...
        ''' <changeLog></changeLog>
        Public Sub AdapterOtmSubCategoriaCategoria(pvo_DataSet As Data.DataSet)
            ...
            Try
                ...
                vlo_Conexion.AdapterCrear(String.Format("INSERT INTO OTM_SUBCATEGORIA_CATEGOR (ID_CATEGORIA_MATERIAL, ID_SUBCATEGORIA_MATERIAL, USUARIO) VALUES (:ID_CATEGORIA_MATERIAL, :ID_SUBCATEGORIA_MATERIAL, :USUARIO)"),
                                          String.Empty,
                                          String.Format("DELETE FROM {0} WHERE {1} = :{1} AND {2} = :{2}", Modelo.OTM_SUBCATEGORIA_CATEGOR.Name, Modelo.OTM_SUBCATEGORIA_CATEGOR.ID_CATEGORIA_MATERIAL, Modelo.OTM_SUBCATEGORIA_CATEGOR.ID_SUBCATEGORIA_MATERIAL))

                vlo_Conexion.AdapterAgregarParametro(":ID_CATEGORIA_MATERIAL", "ID_CATEGORIA_MATERIAL", DbType.Int32, ConexionOracle.TipoParametro.Insert)
                vlo_Conexion.AdapterAgregarParametro(":ID_SUBCATEGORIA_MATERIAL", "ID_SUBCATEGORIA_MATERIAL", DbType.Int32, ConexionOracle.TipoParametro.Insert)
                vlo_Conexion.AdapterAgregarParametro(":USUARIO", "USUARIO", DbType.String, ConexionOracle.TipoParametro.Insert)

                vlo_Conexion.AdapterAgregarParametro(String.Format(":{0}", Modelo.OTM_SUBCATEGORIA_CATEGOR.ID_CATEGORIA_MATERIAL), String.Format("{0}", Modelo.OTM_SUBCATEGORIA_CATEGOR.ID_CATEGORIA_MATERIAL), DbType.Int32, ConexionOracle.TipoParametro.Delete)
                vlo_Conexion.AdapterAgregarParametro(String.Format(":{0}", Modelo.OTM_SUBCATEGORIA_CATEGOR.ID_SUBCATEGORIA_MATERIAL), String.Format("{0}", Modelo.OTM_SUBCATEGORIA_CATEGOR.ID_SUBCATEGORIA_MATERIAL), DbType.Int32, ConexionOracle.TipoParametro.Delete)
...
#Region "Funciones"
	...
	Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_RegistroInterno As EntOtmSubcategoriaCategor
		Dim vln_Resultado As Integer

		Try
			vln_Resultado = -1
			vlo_RegistroInterno = CType(pvo_Registro, EntOtmSubcategoriaCategor)
			...
			vlc_Sentencia = "prI_OTM_SUBCATEGORIA_CATEGOR"
        ...
        Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prD_OTM_SUBCATEGORIA_CATEGOR"
        ...
        ''' <summary>
        ''' Permite modificar un registro en la tabla OTM_SUBCATEGORIA_CATEGOR
        ''' </summary>
        ''' <param name="pvo_Registro">Entidad a procesar</param>
        ''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ...
        Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTM_SUBCATEGORIA_CATEGOR"
        ...
        Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
            ...
            Dim vlo_Resultado As New EntOtmSubcategoriaCategor

            Try
                vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_SUBCATEGORIA_CATEGOR.ID_CATEGORIA_MATERIAL, "IdCategoriaMaterial"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_SUBCATEGORIA_CATEGOR.ID_SUBCATEGORIA_MATERIAL, "IdSubcategoriaMaterial"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_SUBCATEGORIA_CATEGOR.USUARIO, "Usuario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTM_SUBCATEGORIA_CATEGOR.TIME_STAMP, "TimeStamp"))

                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtmSubcategoriaCategor)(vlo_MapeoEntidad)
        ...
        Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_SUBCATEGORIA_CATEGOR.Name, "V_OTM_SUBCATEGORIA_CATEGOR", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTM_SUBCATEGORIA_CATEGOR.Name, "V_OTM_SUBCATEGORIA_CATEGORLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>19/05/2016 05:14:54 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ListarVOtmSubcategoriaCategor(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTM_SUBCATEGORIA_CATEGOR.Name, V_OTM_SUBCATEGORIA_CATEGOR.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>19/05/2016 05:14:54 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtmSubcategoriaCategor(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTM_SUBCATEGORIA_CATEGOR.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        ''' <creationDate>19/05/2016 05:14:54 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ListarVOtmSubcategoriaCategorlst(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTM_SUBCATEGORIA_CATEGORLST.Name, V_OTM_SUBCATEGORIA_CATEGORLST.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>19/05/2016 05:14:54 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtmSubcategoriaCategorlst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTM_SUBCATEGORIA_CATEGORLST.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
