...
Namespace OrdenesDeTrabajo.AccesoDatos.OrdenesDeTrabajo
	Public Class DalOtlDetalleMaterial
		Inherits DalBase
...
#Region "Metodos"
        ...
        ''' <changeLog></changeLog>
        Public Sub AdapterOtlDetalleMaterial(pvo_DataSet As Data.DataSet)
            ...
            Try
                ...
                vlo_Conexion.AdapterCrear(String.Empty,
                                          String.Empty,
                                          String.Format("DELETE FROM {0} WHERE {1} = :{1}", Modelo.OTL_DETALLE_MATERIAL.Name, Modelo.OTL_DETALLE_MATERIAL.ID_DETALLE_MATERIAL))


                vlo_Conexion.AdapterAgregarParametro(String.Format(":{0}", Modelo.OTL_DETALLE_MATERIAL.ID_DETALLE_MATERIAL), String.Format("{0}", Modelo.OTL_DETALLE_MATERIAL.ID_DETALLE_MATERIAL), DbType.Int32, ConexionOracle.TipoParametro.Delete)
...
#Region "Funciones"
	...
	Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_RegistroInterno As EntOtlDetalleMaterial
		Dim vln_Resultado As Integer

		Try
			vln_Resultado = -1
			vlo_RegistroInterno = CType(pvo_Registro, EntOtlDetalleMaterial)
			...
			vlc_Sentencia = "prI_OTL_DETALLE_MATERIAL"
        ...
        Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prD_OTL_DETALLE_MATERIAL"
        ...
        ''' <summary>
        ''' Permite modificar un registro en la tabla OTL_DETALLE_MATERIAL
        ''' </summary>
        ''' <param name="pvo_Registro">Entidad a procesar</param>
        ''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ...
        Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTL_DETALLE_MATERIAL"
        ...
        Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
            ...
            Dim vlo_Resultado As New EntOtlDetalleMaterial

            Try
                vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_DETALLE_MATERIAL.ID_DETALLE_MATERIAL, "IdDetalleMaterial"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_DETALLE_MATERIAL.ID_UBICACION, "IdUbicacion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_DETALLE_MATERIAL.ID_ORDEN_TRABAJO, "IdOrdenTrabajo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_DETALLE_MATERIAL.ID_UBICACION_ADMINISTRA, "IdUbicacionAdministra"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_DETALLE_MATERIAL.ID_MATERIAL, "IdMaterial"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_DETALLE_MATERIAL.CANTIDAD_SOLICITADA, "CantidadSolicitada"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_DETALLE_MATERIAL.DETALLE, "Detalle"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_DETALLE_MATERIAL.USUARIO, "Usuario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_DETALLE_MATERIAL.TIME_STAMP, "TimeStamp"))

                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtlDetalleMaterial)(vlo_MapeoEntidad)
        ...
        Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTL_DETALLE_MATERIAL.Name, "V_OTL_DETALLE_MATERIAL", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>03/06/2016 02:42:19 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtlDetalleMaterial(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTL_DETALLE_MATERIAL", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTL_DETALLE_MATERIAL.Name, "V_OTL_DETALLE_MATERIALLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>03/06/2016 02:42:19 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtlDetalleMateriallst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTL_DETALLE_MATERIALLst", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
