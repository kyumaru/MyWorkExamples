...
Namespace OrdenesDeTrabajo.AccesoDatos.OrdenesDeTrabajo
    Public Class DalOtfFichaTecnicaGeneral
        Inherits DalBase
...
#Region "Funciones"
        ...
        Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Dim vlo_RegistroInterno As EntOtfFichaTecnicaGeneral
            Dim vln_Resultado As Integer

            Try
                vln_Resultado = -1
                vlo_RegistroInterno = CType(pvo_Registro, EntOtfFichaTecnicaGeneral)
                ...
                vlc_Sentencia = "prI_OTF_FICHA_TECNICA_GENERAL"
                ...
                vlo_Conexion.SetParameter("pvn_CuentaConPresupuesto", OracleDbType.Int32, vlo_RegistroInterno.CuentaConPresupuesto)
        ...
        Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prD_OTF_FICHA_TECNICA_GENERAL"
        ...
        ''' <summary>
        ''' Permite modificar un registro en la tabla OTF_FICHA_TECNICA_GENERAL
        ''' </summary>
        ''' <param name="pvo_Registro">Entidad a procesar</param>
        ''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ...
        Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTF_FICHA_TECNICA_GENERAL"
        ...
        Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
            ...
            Dim vlo_Resultado As New EntOtfFichaTecnicaGeneral

            Try
                vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_FICHA_TECNICA_GENERAL.ID_UBICACION, "IdUbicacion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_FICHA_TECNICA_GENERAL.ID_PRE_ORDEN_TRABAJO, "IdPreOrdenTrabajo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_FICHA_TECNICA_GENERAL.CONSERVA_MOBILIARIO, "ConservaMobiliario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_FICHA_TECNICA_GENERAL.REQUIERE_NUEVO_MOBILIARIO, "RequiereNuevoMobiliario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_FICHA_TECNICA_GENERAL.CUENTA_CON_PRESUPUESTO, "CuentaConPresupuesto"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_FICHA_TECNICA_GENERAL.OTROS_MOBILIARIO, "OtrosMobiliario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_FICHA_TECNICA_GENERAL.OTRO_TIPO_REQUERIMIENTO, "OtroTipoRequerimiento"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_FICHA_TECNICA_GENERAL.NOMBRE_ARCHIVO, "NombreArchivo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_FICHA_TECNICA_GENERAL.ARCHIVO, "Archivo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_FICHA_TECNICA_GENERAL.CUENTA_CON_ALARMA, "CuentaConAlarma"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_FICHA_TECNICA_GENERAL.REQUIERE_ALARMA, "RequiereAlarma"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_FICHA_TECNICA_GENERAL.TIME_STAMP, "TimeStamp"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_FICHA_TECNICA_GENERAL.USUARIO, "Usuario"))

                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtfFichaTecnicaGeneral)(vlo_MapeoEntidad)
        ...
        Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTF_FICHA_TECNICA_GENERAL.Name, "V_OTF_FICHA_TECNICA_GENERAL", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTF_FICHA_TECNICA_GENERAL.Name, "V_OTF_FICHA_TECNICA_GENERALLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>14/04/2016 09:20:07 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ListarVOtfFichaTecnicaGeneral(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTF_FICHA_TECNICA_GENERAL.Name, V_OTF_FICHA_TECNICA_GENERAL.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>14/04/2016 09:20:07 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtfFichaTecnicaGeneral(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTF_FICHA_TECNICA_GENERAL.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        ''' <creationDate>14/04/2016 09:20:07 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ListarVOtfFichaTecnicaGenerallst(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTF_FICHA_TECNICA_GENERALLST.Name, V_OTF_FICHA_TECNICA_GENERALLST.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>14/04/2016 09:20:07 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtfFichaTecnicaGenerallst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTF_FICHA_TECNICA_GENERALLST.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
