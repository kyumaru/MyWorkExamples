...
Namespace OrdenesDeTrabajo.AccesoDatos.OrdenesDeTrabajo
    Public Class DalOtfExcepcionPeriodo
        Inherits DalBase
...
#Region "Metodos"
        ...
        ''' <summary>
        ''' Adapter para las excepciones de periodo
        ''' </summary>
        ...
        ''' <changeLog></changeLog>
        Public Sub AdapterOtfExcepcionPeriodo(pvo_DataSet As Data.DataSet)
            ...
            Try
                ...
                vlo_Conexion.AdapterCrear(String.Empty,
                                          String.Empty,
                                          String.Format("DELETE FROM {0} WHERE {1} = :{1}", Modelo.OTF_EXCEPCION_PERIODO.Name, Modelo.OTF_EXCEPCION_PERIODO.ID_EXCEPCION_PERIODO))

                vlo_Conexion.AdapterAgregarParametro(String.Format(":{0}", Modelo.OTF_EXCEPCION_PERIODO.ID_EXCEPCION_PERIODO), String.Format("{0}", Modelo.OTF_EXCEPCION_PERIODO.ID_EXCEPCION_PERIODO), DbType.Int32, ConexionOracle.TipoParametro.Delete)
...
#Region "Funciones"
        ...
        Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_RegistroInterno As EntOtfExcepcionPeriodo
            Dim vln_Resultado As Integer

            Try
                vln_Resultado = -1
                vlo_RegistroInterno = CType(pvo_Registro, EntOtfExcepcionPeriodo)
                ...
                vlc_Sentencia = "prI_OTF_EXCEPCION_PERIODO"

                vlo_Conexion.SetParameter("prn_IdExcepcionPeriodo", OracleDbType.Int32, vln_Resultado, ParameterDirection.Output)
                ...
                vlo_Conexion.SetParameter("pvc_UnidadInterna", OracleDbType.Varchar2, vlo_RegistroInterno.UnidadInterna)
                vlo_Conexion.SetParameter("pvn_Vigencia", OracleDbType.Int32, vlo_RegistroInterno.Vigencia)
                ...
                vln_Resultado = CType(vlo_Conexion.GetParameterValue("prn_IdExcepcionPeriodo"), Integer)
        ...
        Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prD_OTF_EXCEPCION_PERIODO"

                vlo_Conexion.SetParameter("pvn_IdExcepcionPeriodo", OracleDbType.Int32, vlo_RegistroInterno.IdExcepcionPeriodo)
        ...
        ''' <summary>
        ''' Permite modificar un registro en la tabla OTF_EXCEPCION_PERIODO
        ''' </summary>
        ''' <param name="pvo_Registro">Entidad a procesar</param>
        ''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ...
        Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTF_EXCEPCION_PERIODO"
        ...
        Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
            ...
            Dim vlo_Resultado As New EntOtfExcepcionPeriodo

            Try
                vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_EXCEPCION_PERIODO.ID_EXCEPCION_PERIODO, "IdExcepcionPeriodo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_EXCEPCION_PERIODO.NUM_EMPLEADO, "NumEmpleado"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_EXCEPCION_PERIODO.ID_UNIDAD_TIEMPO, "IdUnidadTiempo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_EXCEPCION_PERIODO.VIGENCIA, "Vigencia"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_EXCEPCION_PERIODO.UNIDAD_INTERNA, "UnidadInterna"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_EXCEPCION_PERIODO.USUARIO, "Usuario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_EXCEPCION_PERIODO.TIME_STAMP, "TimeStamp"))

                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtfExcepcionPeriodo)(vlo_MapeoEntidad)
        ...
        Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTF_EXCEPCION_PERIODO.Name, "V_OTF_EXCEPCION_PERIODO", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTF_EXCEPCION_PERIODO.Name, "V_OTF_EXCEPCION_PERIODOLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>18/01/2016 02:03:50 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ListarVOtfExcepcionPeriodo(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTF_EXCEPCION_PERIODO.Name, V_OTF_EXCEPCION_PERIODO.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>18/01/2016 02:03:50 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtfExcepcionPeriodo(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTF_EXCEPCION_PERIODO.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        ''' <creationDate>18/01/2016 02:03:50 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ListarVOtfExcepcionPeriodolst(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTF_EXCEPCION_PERIODOLST.Name, V_OTF_EXCEPCION_PERIODOLST.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>18/01/2016 02:03:50 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtfExcepcionPeriodolst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTF_EXCEPCION_PERIODOLST.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
