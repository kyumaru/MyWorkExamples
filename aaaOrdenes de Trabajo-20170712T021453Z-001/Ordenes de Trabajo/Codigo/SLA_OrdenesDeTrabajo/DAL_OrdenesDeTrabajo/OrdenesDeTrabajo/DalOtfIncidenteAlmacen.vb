...
Namespace OrdenesDeTrabajo.AccesoDatos.OrdenesDeTrabajo
	Public Class DalOtfIncidenteAlmacen
		Inherits DalBase
...
#Region "Funciones"
	...
	Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Dim vlo_RegistroInterno As EntOtfIncidenteAlmacen
		Dim vln_Resultado As Integer

		Try
			vln_Resultado = -1
			vlo_RegistroInterno = CType(pvo_Registro, EntOtfIncidenteAlmacen)
			...
			vlc_Sentencia = "prI_OTF_INCIDENTE_ALMACEN"

			vlo_Conexion.SetParameter("prn_IdIncidenteAlmacen", OracleDbType.Int32, vln_Resultado, ParameterDirection.Output)
			...
			vlo_Conexion.SetParameter("pvn_IdTipoIncidente", OracleDbType.Int32, vlo_RegistroInterno.IdTipoIncidente)
			...
			vlo_Conexion.SetParameter("pvd_FechaInclusion", OracleDbType.Date, vlo_RegistroInterno.FechaInclusion)
			vlo_Conexion.SetParameter("pvc_ObservacionesRevisor", OracleDbType.Varchar2, vlo_RegistroInterno.ObservacionesRevisor)
			...
			vln_Resultado = CType(vlo_Conexion.GetParameterValue("prn_IdIncidenteAlmacen"), Integer)
        ...
        Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prD_OTF_INCIDENTE_ALMACEN"

                vlo_Conexion.SetParameter("pvn_IdIncidenteAlmacen", OracleDbType.Int32, vlo_RegistroInterno.IdIncidenteAlmacen)
        ...
        ''' <summary>
        ''' Permite modificar un registro en la tabla OTF_INCIDENTE_ALMACEN
        ''' </summary>
        ''' <param name="pvo_Registro">Entidad a procesar</param>
        ''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ...
        Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTF_INCIDENTE_ALMACEN"
        ...
        Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
            ...
            Dim vlo_Resultado As New EntOtfIncidenteAlmacen

            Try
                vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_INCIDENTE_ALMACEN.ID_INCIDENTE_ALMACEN, "IdIncidenteAlmacen"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_INCIDENTE_ALMACEN.ID_UBICACION, "IdUbicacion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_INCIDENTE_ALMACEN.ID_MATERIAL, "IdMaterial"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_INCIDENTE_ALMACEN.ID_ALMACEN_BODEGA, "IdAlmacenBodega"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_INCIDENTE_ALMACEN.ID_TIPO_INCIDENTE, "IdTipoIncidente"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_INCIDENTE_ALMACEN.DETALLE, "Detalle"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_INCIDENTE_ALMACEN.ESTADO, "Estado"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_INCIDENTE_ALMACEN.FECHA_INCLUSION, "FechaInclusion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_INCIDENTE_ALMACEN.OBSERVACIONES_REVISOR, "ObservacionesRevisor"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_INCIDENTE_ALMACEN.USUARIO, "Usuario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_INCIDENTE_ALMACEN.TIME_STAMP, "TimeStamp"))

                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtfIncidenteAlmacen)(vlo_MapeoEntidad)
        ...
        Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTF_INCIDENTE_ALMACEN.Name, "V_OTF_INCIDENTE_ALMACEN", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTF_INCIDENTE_ALMACEN.Name, "V_OTF_INCIDENTE_ALMACENLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>04/08/2016 04:57:26 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ListarVOtfIncidenteAlmacen(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTF_INCIDENTE_ALMACEN.Name, V_OTF_INCIDENTE_ALMACEN.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>04/08/2016 04:57:26 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtfIncidenteAlmacen(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTF_INCIDENTE_ALMACEN.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        ''' <creationDate>04/08/2016 04:57:26 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ListarVOtfIncidenteAlmacenlst(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTF_INCIDENTE_ALMACENLST.Name, V_OTF_INCIDENTE_ALMACENLST.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>04/08/2016 04:57:26 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtfIncidenteAlmacenlst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTF_INCIDENTE_ALMACENLST.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
