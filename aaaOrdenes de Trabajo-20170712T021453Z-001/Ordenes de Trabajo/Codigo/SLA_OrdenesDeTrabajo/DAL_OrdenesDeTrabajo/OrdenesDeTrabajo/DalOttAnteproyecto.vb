...
Namespace OrdenesDeTrabajo.AccesoDatos.OrdenesDeTrabajo
    Public Class DalOttAnteproyecto
        Inherits DalBase
...
#Region "Funciones"
        ...
        ''' <changeLog></changeLog>
        Public Function ObtenerFnOtVersionAnteproyecto(pvn_IdUbicacion As Integer, pvc_IdOrdenTrabajo As String) As Double
            ...
            Try
                ...
                vlc_Sentencia = "SELECT FN_OT_VERSION_ANTEPROYECTO(:pvn_IdUbicacion, :pvc_IdOrdenTrabajo) AS RESULTADO FROM DUAL"
        ...
        Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Dim vlc_Sentencia As String
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_RegistroInterno As EntOttAnteproyecto
            Dim vln_Resultado As Integer

            Try
                vln_Resultado = -1
                vlo_RegistroInterno = CType(pvo_Registro, EntOttAnteproyecto)
                ...
                vlc_Sentencia = "prI_OTT_ANTEPROYECTO"
                ...
                vlo_Conexion.SetParameter("pvc_ActividadesContempladas", OracleDbType.Varchar2, vlo_RegistroInterno.ActividadesContempladas)
                vlo_Conexion.SetParameter("pvn_Cantidad", OracleDbType.Double, vlo_RegistroInterno.Cantidad)
                vlo_Conexion.SetParameter("pvc_UnidadMedida", OracleDbType.Varchar2, vlo_RegistroInterno.UnidadMedida)
                vlo_Conexion.SetParameter("pvn_AvalPlantaFisica", OracleDbType.Int32, vlo_RegistroInterno.AvalPlantaFisica)
                vlo_Conexion.SetParameter("pvn_AvalForesta", OracleDbType.Int32, vlo_RegistroInterno.AvalForesta)
                vlo_Conexion.SetParameter("pvn_TiempoRespuesta", OracleDbType.Int32, vlo_RegistroInterno.TiempoRespuesta)
                vlo_Conexion.SetParameter("pvd_FechaEnvia", OracleDbType.Date, vlo_RegistroInterno.FechaEnvia)
                vlo_Conexion.SetParameter("pvd_FechaResponde", OracleDbType.Date, vlo_RegistroInterno.FechaResponde)
        ...
        Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prD_OTT_ANTEPROYECTO"
        ...
        ''' <summary>
        ''' Permite modificar un registro en la tabla OTT_ANTEPROYECTO
        ''' </summary>
        ''' <param name="pvo_Registro">Entidad a procesar</param>
        ''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ...
        Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTT_ANTEPROYECTO"
        ...
        Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
            ...
            Dim vlo_Resultado As New EntOttAnteproyecto

            Try
                vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_ANTEPROYECTO.ID_UNIDAD_TIEMPO, "IdUnidadTiempo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_ANTEPROYECTO.ID_UBICACION, "IdUbicacion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_ANTEPROYECTO.ID_ORDEN_TRABAJO, "IdOrdenTrabajo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_ANTEPROYECTO.VERSION, "Version"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_ANTEPROYECTO.EDITABLE, "Editable"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_ANTEPROYECTO.DESCRIPCION, "Descripcion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_ANTEPROYECTO.ACTIVIDADES_CONTEMPLADAS, "ActividadesContempladas"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_ANTEPROYECTO.CANTIDAD, "Cantidad"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_ANTEPROYECTO.UNIDAD_MEDIDA, "UnidadMedida"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_ANTEPROYECTO.AVAL_PLANTA_FISICA, "AvalPlantaFisica"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_ANTEPROYECTO.AVAL_FORESTA, "AvalForesta"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_ANTEPROYECTO.TIEMPO_RESPUESTA, "TiempoRespuesta"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_ANTEPROYECTO.FECHA_ENVIA, "FechaEnvia"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_ANTEPROYECTO.FECHA_RESPONDE, "FechaResponde"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_ANTEPROYECTO.USUARIO, "Usuario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_ANTEPROYECTO.TIME_STAMP, "TimeStamp"))

                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOttAnteproyecto)(vlo_MapeoEntidad)
        ...
        Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_ANTEPROYECTO.Name, "V_OTT_ANTEPROYECTO", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>07/03/2016 11:51:28 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOttAnteproyecto(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTT_ANTEPROYECTO", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_ANTEPROYECTO.Name, "V_OTT_ANTEPROYECTOLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>07/03/2016 11:51:28 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOttAnteproyectolst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTT_ANTEPROYECTOLst", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        ''' <creationDate>07/03/2016 11:51:28 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ListarVOtthAnteproyecto(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_ANTEPROYECTO.Name, "V_OTTH_ANTEPROYECTO", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>07/03/2016 11:51:28 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtthAnteproyecto(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTTH_ANTEPROYECTO", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
