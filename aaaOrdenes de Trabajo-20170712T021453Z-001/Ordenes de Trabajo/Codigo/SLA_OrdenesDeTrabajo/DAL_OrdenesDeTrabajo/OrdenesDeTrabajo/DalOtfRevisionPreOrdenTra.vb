...
Namespace OrdenesDeTrabajo.AccesoDatos.OrdenesDeTrabajo
	Public Class DalOtfRevisionPreOrdenTra
		Inherits DalBase
...
#Region "Funciones"
	...
	Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Dim vlo_RegistroInterno As EntOtfRevisionPreOrdenTra
		Dim vln_Resultado As Integer

		Try
			vln_Resultado = -1
			vlo_RegistroInterno = CType(pvo_Registro, EntOtfRevisionPreOrdenTra)
			...
			vlc_Sentencia = "prI_OTF_REVISION_PRE_ORDEN_TRA"

			vlo_Conexion.SetParameter("prn_IdRevisionPreOrdenTra", OracleDbType.Int32, vln_Resultado, ParameterDirection.Output)
			...
			vln_Resultado = CType(vlo_Conexion.GetParameterValue("prn_IdRevisionPreOrdenTra"), Integer)
	...
	Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prD_OTF_REVISION_PRE_ORDEN_TRA"

			vlo_Conexion.SetParameter("pvn_IdRevisionPreOrdenTra", OracleDbType.Int32, vlo_RegistroInterno.IdRevisionPreOrdenTra)
	...
	''' <summary>
	''' Permite modificar un registro en la tabla OTF_REVISION_PRE_ORDEN_TRA
	''' </summary>
	''' <param name="pvo_Registro">Entidad a procesar</param>
	''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
	''' <author>Generador de Código basado en objetos Oracle</author>
	...
	Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prU_OTF_REVISION_PRE_ORDEN_TRA"
	...
	Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
		...
		Dim vlo_Resultado As New EntOtfRevisionPreOrdenTra

		Try
			vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
			If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
				vlo_MapeoEntidad = New List(Of MapeoSimple)
				vlo_MapeoEntidad.Add(New MapeoSimple(OTF_REVISION_PRE_ORDEN_TRA.ID_REVISION_PRE_ORDEN_TRA, "IdRevisionPreOrdenTra"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTF_REVISION_PRE_ORDEN_TRA.ID_UBICACION, "IdUbicacion"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTF_REVISION_PRE_ORDEN_TRA.ID_PRE_ORDEN_TRABAJO, "IdPreOrdenTrabajo"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTF_REVISION_PRE_ORDEN_TRA.OBSERVACIONES, "Observaciones"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTF_REVISION_PRE_ORDEN_TRA.ESTADO, "Estado"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTF_REVISION_PRE_ORDEN_TRA.USUARIO, "Usuario"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTF_REVISION_PRE_ORDEN_TRA.TIME_STAMP, "TimeStamp"))

				vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtfRevisionPreOrdenTra)(vlo_MapeoEntidad)
	...
	Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTF_REVISION_PRE_ORDEN_TRA.Name, "V_OTF_REVISION_PRE_ORDEN_TRA", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			End If
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTF_REVISION_PRE_ORDEN_TRA.Name, "V_OTF_REVISION_PRE_ORDENLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>14/04/2016 09:20:07 a.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtfRevisionPreOrdenTralst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		...
		Try
			...
			End If
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTF_REVISION_PRE_ORDENLst", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
	...
	''' <creationDate>14/04/2016 09:20:07 a.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ListarVOtfRevisionPreOrdenlst(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_DsDatos As New DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTF_REVISION_PRE_ORDENLST.Name, V_OTF_REVISION_PRE_ORDENLST.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>14/04/2016 09:20:07 a.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtfRevisionPreOrdenlst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_Resultado As EntDatosPaginacion
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTF_REVISION_PRE_ORDENLST.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
	...
	''' <creationDate>14/04/2016 09:20:07 a.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ListarVOtfRevisionPreOrdenTra(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_DsDatos As New DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTF_REVISION_PRE_ORDEN_TRA.Name, V_OTF_REVISION_PRE_ORDEN_TRA.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>14/04/2016 09:20:07 a.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtfRevisionPreOrdenTra(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_Resultado As EntDatosPaginacion
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTF_REVISION_PRE_ORDEN_TRA.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
