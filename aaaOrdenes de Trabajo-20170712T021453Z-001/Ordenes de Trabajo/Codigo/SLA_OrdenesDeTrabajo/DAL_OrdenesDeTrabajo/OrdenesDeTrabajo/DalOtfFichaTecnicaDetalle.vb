...
Namespace OrdenesDeTrabajo.AccesoDatos.OrdenesDeTrabajo
    Public Class DalOtfFichaTecnicaDetalle
        Inherits DalBase
...
#Region "Metodos"
        ...
        ''' <changeLog></changeLog>
        Public Sub AdapterOtfFichaTecnicaDetalle(pvo_DataSet As Data.DataSet)
            ...
            Try
                ...
                vlo_Conexion.AdapterCrear(String.Format("INSERT INTO OTF_FICHA_TECNICA_DETALLE (ID_UBICACION, ID_PRE_ORDEN_TRABAJO, ID_ESPACIO, ID_SUBCOMPONENTE, ID_REQUERIMIENTO, VALOR, USUARIO) VALUES (:ID_UBICACION, :ID_PRE_ORDEN_TRABAJO, :ID_ESPACIO, :ID_SUBCOMPONENTE, :ID_REQUERIMIENTO, :VALOR, :USUARIO)"),
                                          String.Empty,
                                          String.Format("DELETE FROM {0} WHERE {1} = :{1} AND {2} = :{2} AND {3} = :{3}", Modelo.OTF_FICHA_TECNICA_DETALLE.Name, Modelo.OTF_FICHA_TECNICA_DETALLE.ID_ESPACIO, Modelo.OTF_FICHA_TECNICA_DETALLE.ID_SUBCOMPONENTE, Modelo.OTF_FICHA_TECNICA_DETALLE.ID_REQUERIMIENTO))
                ...
                vlo_Conexion.AdapterAgregarParametro(String.Format(":{0}", Modelo.OTF_FICHA_TECNICA_DETALLE.ID_ESPACIO), String.Format("{0}", Modelo.OTF_FICHA_TECNICA_DETALLE.ID_ESPACIO), DbType.Int32, ConexionOracle.TipoParametro.Delete)
                vlo_Conexion.AdapterAgregarParametro(String.Format(":{0}", Modelo.OTF_FICHA_TECNICA_DETALLE.ID_SUBCOMPONENTE), String.Format("{0}", Modelo.OTF_FICHA_TECNICA_DETALLE.ID_SUBCOMPONENTE), DbType.Int32, ConexionOracle.TipoParametro.Delete)
                vlo_Conexion.AdapterAgregarParametro(String.Format(":{0}", Modelo.OTF_FICHA_TECNICA_DETALLE.ID_REQUERIMIENTO), String.Format("{0}", Modelo.OTF_FICHA_TECNICA_DETALLE.ID_REQUERIMIENTO), DbType.Int32, ConexionOracle.TipoParametro.Delete)
...
#Region "Funciones"
        ...
        Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_RegistroInterno As EntOtfFichaTecnicaDetalle
            Dim vln_Resultado As Integer

            Try
                vln_Resultado = -1
                vlo_RegistroInterno = CType(pvo_Registro, EntOtfFichaTecnicaDetalle)
                ...
                vlc_Sentencia = "prI_OTF_FICHA_TECNICA_DETALLE"
        ...
        Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prD_OTF_FICHA_TECNICA_DETALLE"
        ...
        ''' <summary>
        ''' Permite modificar un registro en la tabla OTF_FICHA_TECNICA_DETALLE
        ''' </summary>
        ''' <param name="pvo_Registro">Entidad a procesar</param>
        ''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ...
        Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTF_FICHA_TECNICA_DETALLE"
        ...
        Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
            ...
            Dim vlo_Resultado As New EntOtfFichaTecnicaDetalle

            Try
                vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_FICHA_TECNICA_DETALLE.ID_UBICACION, "IdUbicacion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_FICHA_TECNICA_DETALLE.ID_PRE_ORDEN_TRABAJO, "IdPreOrdenTrabajo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_FICHA_TECNICA_DETALLE.ID_ESPACIO, "IdEspacio"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_FICHA_TECNICA_DETALLE.ID_SUBCOMPONENTE, "IdSubcomponente"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_FICHA_TECNICA_DETALLE.ID_REQUERIMIENTO, "IdRequerimiento"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_FICHA_TECNICA_DETALLE.VALOR, "Valor"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_FICHA_TECNICA_DETALLE.USUARIO, "Usuario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_FICHA_TECNICA_DETALLE.TIME_STAMP, "TimeStamp"))

                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtfFichaTecnicaDetalle)(vlo_MapeoEntidad)
        ...
        Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTF_FICHA_TECNICA_DETALLE.Name, "V_OTF_FICHA_TECNICA_DETALLE", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTF_FICHA_TECNICA_DETALLE.Name, "V_OTF_FICHA_TECNICA_DETALLELst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>14/04/2016 09:20:07 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ListarVOtfFichaTecnicaDetalle(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTF_FICHA_TECNICA_DETALLE.Name, V_OTF_FICHA_TECNICA_DETALLE.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>14/04/2016 09:20:07 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtfFichaTecnicaDetalle(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTF_FICHA_TECNICA_DETALLE.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        ''' <creationDate>14/04/2016 09:20:07 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ListarVOtfFichaTecnicaDetallelst(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTF_FICHA_TECNICA_DETALLELST.Name, V_OTF_FICHA_TECNICA_DETALLELST.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>14/04/2016 09:20:07 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtfFichaTecnicaDetallelst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTF_FICHA_TECNICA_DETALLELST.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
