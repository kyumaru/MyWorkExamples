...
Namespace OrdenesDeTrabajo.AccesoDatos.OrdenesDeTrabajo
	Public Class DalOtfPlaneacionPreventivo
		Inherits DalBase
...
#Region "Funciones"
	...
	Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Dim vlo_RegistroInterno As EntOtfPlaneacionPreventivo
            Dim vln_Resultado As Integer

            Try
                vln_Resultado = -1
                vlo_RegistroInterno = CType(pvo_Registro, EntOtfPlaneacionPreventivo)
                ...
                vlc_Sentencia = "prI_OTF_PLANEACION_PREVENTIVO"

                vlo_Conexion.SetParameter("pvn_ConsecutivoPropuesto", OracleDbType.Int32, vlo_RegistroInterno.ConsecutivoPropuesto)
	...
	Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prD_OTF_PLANEACION_PREVENTIVO"
	...
	''' <summary>
	''' Permite modificar un registro en la tabla OTF_PLANEACION_PREVENTIVO
	''' </summary>
	''' <param name="pvo_Registro">Entidad a procesar</param>
	''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
	''' <author>Generador de Código basado en objetos Oracle</author>
	...
	Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTF_PLANEACION_PREVENTIVO"
	...
	Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
            ...
            Dim vlo_Resultado As New EntOtfPlaneacionPreventivo

            Try
                vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_PLANEACION_PREVENTIVO.CONSECUTIVO_PROPUESTO, "ConsecutivoPropuesto"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_PLANEACION_PREVENTIVO.ID_CATEGORIA_SERVICIO, "IdCategoriaServicio"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_PLANEACION_PREVENTIVO.ID_ACTIVIDAD, "IdActividad"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_PLANEACION_PREVENTIVO.ID_LUGAR_TRABAJO, "IdLugarTrabajo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_PLANEACION_PREVENTIVO.USUARIO, "Usuario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_PLANEACION_PREVENTIVO.TIME_STAMP, "TimeStamp"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_PLANEACION_PREVENTIVO.ID_UBICACION_ADMINISTRA, "IdUbicacionAdministra"))

                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtfPlaneacionPreventivo)(vlo_MapeoEntidad)
	...
	Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTF_PLANEACION_PREVENTIVO.Name, "V_OTF_PLANEACION_PREVENTIVO", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>09/09/2015 03:12:05 p.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtfPlaneacionPreventivo(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTF_PLANEACION_PREVENTIVO", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
	...
	Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTF_PLANEACION_PREVENTIVO.Name, "V_OTF_PLANEACION_PREVENTIVOLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>09/09/2015 03:12:05 p.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ListarVOtfPlaneacionPreventivolst(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_DsDatos As New DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTF_PLANEACION_PREVENTIVOLST.Name, V_OTF_PLANEACION_PREVENTIVOLST.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>09/09/2015 03:12:05 p.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtfPlaneacionPreventivolst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_Resultado As EntDatosPaginacion
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTF_PLANEACION_PREVENTIVOLST.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
