...
Namespace OrdenesDeTrabajo.AccesoDatos.OrdenesDeTrabajo
	Public Class DalOtlTrazabilGestionIngr
		Inherits DalBase
...
#Region "Funciones"
	...
	Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Dim vlo_RegistroInterno As EntOtlTrazabilGestionIngr
		Dim vln_Resultado As Integer

		Try
			vln_Resultado = -1
			vlo_RegistroInterno = CType(pvo_Registro, EntOtlTrazabilGestionIngr)
			...
			vlc_Sentencia = "prI_OTL_TRAZABIL_GESTION_INGR"

			vlo_Conexion.SetParameter("prn_IdTrazabilGestionIngr", OracleDbType.Int32, vln_Resultado, ParameterDirection.Output)
			...
			vln_Resultado = CType(vlo_Conexion.GetParameterValue("prn_IdTrazabilGestionIngr"), Integer)
        ...
        Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prD_OTL_TRAZABIL_GESTION_INGR"

                vlo_Conexion.SetParameter("pvn_IdTrazabilGestionIngr", OracleDbType.Int32, vlo_RegistroInterno.IdTrazabilGestionIngr)
        ...
        ''' <summary>
        ''' Permite modificar un registro en la tabla OTL_TRAZABIL_GESTION_INGR
        ''' </summary>
        ''' <param name="pvo_Registro">Entidad a procesar</param>
        ''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ...
        Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTL_TRAZABIL_GESTION_INGR"
        ...
        Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
            ...
            Dim vlo_Resultado As New EntOtlTrazabilGestionIngr

            Try
                vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABIL_GESTION_INGR.ID_TRAZABIL_GESTION_INGR, "IdTrazabilGestionIngr"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABIL_GESTION_INGR.ID_UBICACION, "IdUbicacion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABIL_GESTION_INGR.ID_VIA_COMPRA_CONTRATO, "IdViaCompraContrato"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABIL_GESTION_INGR.NUMERO_GESTION, "NumeroGestion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABIL_GESTION_INGR.ANNO, "Anno"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABIL_GESTION_INGR.CONSECUTIVO, "Consecutivo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABIL_GESTION_INGR.ESTADO_GESTION_INGRESO, "EstadoGestionIngreso"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABIL_GESTION_INGR.OBSERVACIONES, "Observaciones"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABIL_GESTION_INGR.USUARIO, "Usuario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABIL_GESTION_INGR.TIME_STAMP, "TimeStamp"))

                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtlTrazabilGestionIngr)(vlo_MapeoEntidad)
        ...
        Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTL_TRAZABIL_GESTION_INGR.Name, "V_OTL_TRAZABIL_GESTION_INGR", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>20/02/2017 04:13:16 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtlTrazabilGestionIngr(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTL_TRAZABIL_GESTION_INGR", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTL_TRAZABIL_GESTION_INGR.Name, "V_OTL_TRAZABIL_GESTION_INGRLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>20/02/2017 04:13:16 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtlTrazabilGestionIngrlst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTL_TRAZABIL_GESTION_INGRLst", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
