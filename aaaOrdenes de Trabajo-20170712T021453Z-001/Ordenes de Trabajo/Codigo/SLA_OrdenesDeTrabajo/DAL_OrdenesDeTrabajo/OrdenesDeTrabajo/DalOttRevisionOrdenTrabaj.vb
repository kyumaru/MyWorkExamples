...
Namespace OrdenesDeTrabajo.AccesoDatos.OrdenesDeTrabajo
	Public Class DalOttRevisionOrdenTrabaj
		Inherits DalBase
...
#Region "Funciones"
	...
	Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Dim vlo_RegistroInterno As EntOttRevisionOrdenTrabaj
		Dim vln_Resultado As Integer

		Try
			vln_Resultado = -1
			vlo_RegistroInterno = CType(pvo_Registro, EntOttRevisionOrdenTrabaj)
			...
			vlc_Sentencia = "prI_OTT_REVISION_ORDEN_TRABAJ"

			vlo_Conexion.SetParameter("prn_IdRevisionOrdenTrabaj", OracleDbType.Int32, vln_Resultado, ParameterDirection.Output)
			...
			vln_Resultado = CType(vlo_Conexion.GetParameterValue("prn_IdRevisionOrdenTrabaj"), Integer)
	...
	Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prD_OTT_REVISION_ORDEN_TRABAJ"

			vlo_Conexion.SetParameter("pvn_IdRevisionOrdenTrabaj", OracleDbType.Int32, vlo_RegistroInterno.IdRevisionOrdenTrabaj)
	...
	''' <summary>
	''' Permite modificar un registro en la tabla OTT_REVISION_ORDEN_TRABAJ
	''' </summary>
	''' <param name="pvo_Registro">Entidad a procesar</param>
	''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
	''' <author>Generador de Código basado en objetos Oracle</author>
	...
	Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prU_OTT_REVISION_ORDEN_TRABAJ"
	...
	Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
		...
		Dim vlo_Resultado As New EntOttRevisionOrdenTrabaj

		Try
			vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
			If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
				vlo_MapeoEntidad = New List(Of MapeoSimple)
				vlo_MapeoEntidad.Add(New MapeoSimple(OTT_REVISION_ORDEN_TRABAJ.ID_REVISION_ORDEN_TRABAJ, "IdRevisionOrdenTrabaj"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTT_REVISION_ORDEN_TRABAJ.ID_UBICACION, "IdUbicacion"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTT_REVISION_ORDEN_TRABAJ.ID_ORDEN_TRABAJO, "IdOrdenTrabajo"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTT_REVISION_ORDEN_TRABAJ.OBSERVACIONES, "Observaciones"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTT_REVISION_ORDEN_TRABAJ.ESTADO, "Estado"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTT_REVISION_ORDEN_TRABAJ.USUARIO, "Usuario"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTT_REVISION_ORDEN_TRABAJ.TIME_STAMP, "TimeStamp"))

				vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOttRevisionOrdenTrabaj)(vlo_MapeoEntidad)
	...
	Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_REVISION_ORDEN_TRABAJ.Name, "V_OTT_REVISION_ORDEN_TRABAJ", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_REVISION_ORDEN_TRABAJ.Name, "V_OTT_REVISION_ORDEN_TRABAJLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>25/11/2015 04:13:29 p.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ListarVOtthRevisionOrdenTrabaj(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_DsDatos As New DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_REVISION_ORDEN_TRABAJ.Name, "V_OTTH_REVISION_ORDEN_TRABAJ", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>25/11/2015 04:13:29 p.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtthRevisionOrdenTrabaj(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTTH_REVISION_ORDEN_TRABAJ", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        ''' <changeLog></changeLog>
        Public Function ListarVOttRevisionOrdenTrabaj(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTT_REVISION_ORDEN_TRABAJ.Name, V_OTT_REVISION_ORDEN_TRABAJ.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>26/11/2015 09:03:26 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOttRevisionOrdenTrabaj(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTT_REVISION_ORDEN_TRABAJ.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        ''' <creationDate>26/11/2015 09:03:26 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ListarVOttRevisionOrdenTrabajlst(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTT_REVISION_ORDEN_TRABAJLST.Name, V_OTT_REVISION_ORDEN_TRABAJLST.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>26/11/2015 09:03:26 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOttRevisionOrdenTrabajlst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTT_REVISION_ORDEN_TRABAJLST.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
