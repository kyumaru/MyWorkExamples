...
Namespace OrdenesDeTrabajo.AccesoDatos.OrdenesDeTrabajo
    Public Class DalOttTrazabilidadProceso
        Inherits DalBase
...
#Region "Metodos"
        ...
        ''' <summary>
        ''' Adapter para la trazabilidad de la OT
        ''' </summary>
        ...
        ''' <changeLog></changeLog>
        Public Sub AdapterOttTrazabilidadProceso(pvo_DataSet As Data.DataSet)
            ...
            Try
                ...
                vlo_Conexion.AdapterCrear(String.Format("INSERT INTO OTT_TRAZABILIDAD_PROCESO (FECHA_HORA_EJECUCION, OBSERVACIONES, USUARIO, ID_TRAZABILIDAD_PROCESO, ID_UBICACION, ID_ORDEN_TRABAJO, NUM_EMPLEADO_EJECUTA, ESTADO_ORDEN_TRABAJO) VALUES (SYSDATE, :OBSERVACIONES, :USUARIO, SQ_ID_TRAZABILIDAD_PROCESO.NEXTVAL, :ID_UBICACION, :ID_ORDEN_TRABAJO, :NUM_EMPLEADO_EJECUTA, :ESTADO_ORDEN_TRABAJO)"),
                                          String.Empty,
                                          String.Empty)

                'vlo_Conexion.AdapterAgregarParametro(":FECHA_HORA_EJECUCION", "FECHA_HORA_EJECUCION", DbType.Date, ConexionOracle.TipoParametro.Insert)
                ...
                vlo_Conexion.AdapterAgregarParametro(":NUM_EMPLEADO_EJECUTA", "NUM_EMPLEADO_EJECUTA", DbType.Int32, ConexionOracle.TipoParametro.Insert)
...
#Region "Funciones"
        ...
        Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_RegistroInterno As EntOttTrazabilidadProceso
            Dim vln_Resultado As Integer

            Try
                vln_Resultado = -1
                vlo_RegistroInterno = CType(pvo_Registro, EntOttTrazabilidadProceso)
                ...
                vlc_Sentencia = "prI_OTT_TRAZABILIDAD_PROCESO"

                ' vlo_Conexion.SetParameter("pvd_FechaHoraEjecucion", OracleDbType.Date, vlo_RegistroInterno.FechaHoraEjecucion)
                ...
                vlo_Conexion.SetParameter("pvc_ObservacionesInternas", OracleDbType.Varchar2, vlo_RegistroInterno.ObservacionesInternas)
                vlo_Conexion.SetParameter("pvc_Usuario", OracleDbType.Varchar2, vlo_RegistroInterno.Usuario)
                vlo_Conexion.SetParameter("prn_IdTrazabilidadProceso", OracleDbType.Int32, vln_Resultado, ParameterDirection.Output)
                ...
                vlo_Conexion.SetParameter("pvn_NumEmpleadoEjecuta", OracleDbType.Double, vlo_RegistroInterno.NumEmpleadoEjecuta)
                ...
                vln_Resultado = CType(vlo_Conexion.GetParameterValue("prn_IdTrazabilidadProceso"), Integer)
        ...
        Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prD_OTT_TRAZABILIDAD_PROCESO"

                vlo_Conexion.SetParameter("pvn_IdTrazabilidadProceso", OracleDbType.Int32, vlo_RegistroInterno.IdTrazabilidadProceso)
        ...
        ''' <summary>
        ''' Permite modificar un registro en la tabla OTT_TRAZABILIDAD_PROCESO
        ''' </summary>
        ''' <param name="pvo_Registro">Entidad a procesar</param>
        ''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ...
        Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTT_TRAZABILIDAD_PROCESO"

                vlo_Conexion.SetParameter("pvd_FechaHoraEjecucion", OracleDbType.Date, Date.Now)

                If vlo_RegistroInterno.Observaciones <> String.Empty And vlo_RegistroInterno.Observaciones <> "-" Then
                    vlo_Conexion.SetParameter("pvc_Observaciones", OracleDbType.Varchar2, vlo_RegistroInterno.Observaciones)
                End If
        ...
        Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
            ...
            Dim vlo_Resultado As New EntOttTrazabilidadProceso

            Try
                vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_TRAZABILIDAD_PROCESO.FECHA_HORA_EJECUCION, "FechaHoraEjecucion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_TRAZABILIDAD_PROCESO.OBSERVACIONES, "Observaciones"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_TRAZABILIDAD_PROCESO.ID_MOTIVO_RECHAZO, "IdMotivoRechazo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_TRAZABILIDAD_PROCESO.OBSERVACIONES_INTERNAS, "ObservacionesInternas"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_TRAZABILIDAD_PROCESO.USUARIO, "Usuario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_TRAZABILIDAD_PROCESO.TIME_STAMP, "TimeStamp"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_TRAZABILIDAD_PROCESO.ID_TRAZABILIDAD_PROCESO, "IdTrazabilidadProceso"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_TRAZABILIDAD_PROCESO.ID_UBICACION, "IdUbicacion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_TRAZABILIDAD_PROCESO.ID_ORDEN_TRABAJO, "IdOrdenTrabajo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_TRAZABILIDAD_PROCESO.NUM_EMPLEADO_EJECUTA, "NumEmpleadoEjecuta"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_TRAZABILIDAD_PROCESO.ESTADO_ORDEN_TRABAJO, "EstadoOrdenTrabajo"))

                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOttTrazabilidadProceso)(vlo_MapeoEntidad)
        ...
        Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_TRAZABILIDAD_PROCESO.Name, "V_OTT_TRAZABILIDAD_PROCESO", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_TRAZABILIDAD_PROCESO.Name, "V_OTT_TRAZABILIDAD_PROCESOLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <param name="pvn_TamanoPagina">Indica la cantidad máxima de registro a retornar por página</param>
        ''' <returns>DataSet con la información obtenida según el criterio de búsqueda indicado</returns>
        Public Function ListarRegistrosListaHistorico(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, "OTH_TRAZABILIDAD_PROCESO", "V_OTH_TRAZABILIDAD_PROCESOLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>25/11/2015 04:13:29 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ListarVOtthTrazabilidadProceso(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_TRAZABILIDAD_PROCESO.Name, "V_OTTH_TRAZABILIDAD_PROCESO", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>25/11/2015 04:13:29 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtthTrazabilidadProceso(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTTH_TRAZABILIDAD_PROCESO", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        ''' <changeLog></changeLog>
        Public Function ListarVOttTrazabilidadProceso(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTT_TRAZABILIDAD_PROCESO.Name, V_OTT_TRAZABILIDAD_PROCESO.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>26/11/2015 09:03:26 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOttTrazabilidadProceso(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTT_TRAZABILIDAD_PROCESO.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        ''' <creationDate>26/11/2015 09:03:26 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ListarVOttTrazabilidadProcesolst(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTT_TRAZABILIDAD_PROCESOLST.Name, V_OTT_TRAZABILIDAD_PROCESOLST.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>26/11/2015 09:03:26 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOttTrazabilidadProcesolst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTT_TRAZABILIDAD_PROCESOLST.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
