...
Namespace OrdenesDeTrabajo.AccesoDatos.OrdenesDeTrabajo
	Public Class DalOtlTrazabilidadAjuste
		Inherits DalBase
...
#Region "Funciones"
	...
	Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Dim vlo_RegistroInterno As EntOtlTrazabilidadAjuste
		Dim vln_Resultado As Integer

		Try
			vln_Resultado = -1
			vlo_RegistroInterno = CType(pvo_Registro, EntOtlTrazabilidadAjuste)
			...
			vlc_Sentencia = "prI_OTL_TRAZABILIDAD_AJUSTE"

			vlo_Conexion.SetParameter("prn_IdTrazabilidadAjuste", OracleDbType.Int32, vln_Resultado, ParameterDirection.Output)
			...
			vln_Resultado = CType(vlo_Conexion.GetParameterValue("prn_IdTrazabilidadAjuste"), Integer)
        ...
        Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prD_OTL_TRAZABILIDAD_AJUSTE"

                vlo_Conexion.SetParameter("pvn_IdTrazabilidadAjuste", OracleDbType.Int32, vlo_RegistroInterno.IdTrazabilidadAjuste)
        ...
        ''' <summary>
        ''' Permite modificar un registro en la tabla OTL_TRAZABILIDAD_AJUSTE
        ''' </summary>
        ''' <param name="pvo_Registro">Entidad a procesar</param>
        ''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ...
        Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTL_TRAZABILIDAD_AJUSTE"
        ...
        Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
            ...
            Dim vlo_Resultado As New EntOtlTrazabilidadAjuste

            Try
                vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABILIDAD_AJUSTE.ID_TRAZABILIDAD_AJUSTE, "IdTrazabilidadAjuste"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABILIDAD_AJUSTE.ESTADO_AJUSTE, "EstadoAjuste"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABILIDAD_AJUSTE.OBSERVACIONES, "Observaciones"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABILIDAD_AJUSTE.USUARIO, "Usuario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_TRAZABILIDAD_AJUSTE.TIME_STAMP, "TimeStamp"))

                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtlTrazabilidadAjuste)(vlo_MapeoEntidad)
        ...
        Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTL_TRAZABILIDAD_AJUSTE.Name, "V_OTL_TRAZABILIDAD_AJUSTE", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>24/01/2017 02:01:22 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtlTrazabilidadAjuste(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTL_TRAZABILIDAD_AJUSTE", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTL_TRAZABILIDAD_AJUSTE.Name, "V_OTL_TRAZABILIDAD_AJUSTELst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>24/01/2017 02:01:22 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtlTrazabilidadAjustelst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTL_TRAZABILIDAD_AJUSTELst", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
