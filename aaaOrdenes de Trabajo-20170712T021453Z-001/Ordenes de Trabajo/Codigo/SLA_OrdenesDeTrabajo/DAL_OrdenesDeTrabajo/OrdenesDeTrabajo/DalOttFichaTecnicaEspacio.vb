...
Namespace OrdenesDeTrabajo.AccesoDatos.OrdenesDeTrabajo
	Public Class DalOttFichaTecnicaEspacio
		Inherits DalBase
...
#Region "Metodos"
        ...
        ''' <changeLog></changeLog>
        Public Sub AdapterOttFichaTecnicaEspacio(pvo_DataSet As Data.DataSet)
            ...
            Try
                ...
                vlo_Conexion.AdapterCrear(String.Format("INSERT INTO OTT_FICHA_TECNICA_ESPACIO (ID_UBICACION, ID_ORDEN_TRABAJO, ID_ESPACIO) VALUES (:ID_UBICACION, :ID_ORDEN_TRABAJO, :ID_ESPACIO)"),
                                          String.Empty,
                                          String.Format("DELETE FROM {0} WHERE {1} = :{1}", Modelo.OTT_FICHA_TECNICA_ESPACIO.Name, Modelo.OTT_FICHA_TECNICA_ESPACIO.ID_ESPACIO))
                ...
                vlo_Conexion.AdapterAgregarParametro(String.Format(":{0}", Modelo.OTT_FICHA_TECNICA_ESPACIO.ID_ESPACIO), String.Format("{0}", Modelo.OTT_FICHA_TECNICA_ESPACIO.ID_ESPACIO), DbType.Int32, ConexionOracle.TipoParametro.Delete)
...
#Region "Funciones"
	...
	Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_RegistroInterno As EntOttFichaTecnicaEspacio
		Dim vln_Resultado As Integer

		Try
			vln_Resultado = -1
			vlo_RegistroInterno = CType(pvo_Registro, EntOttFichaTecnicaEspacio)
			...
			vlc_Sentencia = "prI_OTT_FICHA_TECNICA_ESPACIO"
	...
	Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prD_OTT_FICHA_TECNICA_ESPACIO"
	...
	''' <summary>
	''' Permite modificar un registro en la tabla OTT_FICHA_TECNICA_ESPACIO
	''' </summary>
	''' <param name="pvo_Registro">Entidad a procesar</param>
	''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
	''' <author>Generador de Código basado en objetos Oracle</author>
	...
	Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prU_OTT_FICHA_TECNICA_ESPACIO"
	...
	Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
		...
		Dim vlo_Resultado As New EntOttFichaTecnicaEspacio

		Try
			vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
			If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
				vlo_MapeoEntidad = New List(Of MapeoSimple)
				vlo_MapeoEntidad.Add(New MapeoSimple(OTT_FICHA_TECNICA_ESPACIO.ID_UBICACION, "IdUbicacion"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTT_FICHA_TECNICA_ESPACIO.ID_ORDEN_TRABAJO, "IdOrdenTrabajo"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTT_FICHA_TECNICA_ESPACIO.ID_ESPACIO, "IdEspacio"))

				vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOttFichaTecnicaEspacio)(vlo_MapeoEntidad)
	...
	Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_FICHA_TECNICA_ESPACIO.Name, "V_OTT_FICHA_TECNICA_ESPACIO", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_FICHA_TECNICA_ESPACIO.Name, "V_OTT_FICHA_TECNICA_ESPACIOLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>17/12/2015 02:43:46 p.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ListarVOtthFichaTecnicaEspacio(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_DsDatos As New DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_FICHA_TECNICA_ESPACIO.Name, "V_OTTH_FICHA_TECNICA_ESPACIO", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>17/12/2015 02:43:46 p.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtthFichaTecnicaEspacio(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTTH_FICHA_TECNICA_ESPACIO", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
	...
	''' <creationDate>17/12/2015 02:43:46 p.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ListarVOttFichaTecnicaEspacio(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_DsDatos As New DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTT_FICHA_TECNICA_ESPACIO.Name, V_OTT_FICHA_TECNICA_ESPACIO.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>17/12/2015 02:43:46 p.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOttFichaTecnicaEspacio(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_Resultado As EntDatosPaginacion
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTT_FICHA_TECNICA_ESPACIO.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
	...
	''' <creationDate>17/12/2015 02:43:46 p.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ListarVOttFichaTecnicaEspaciolst(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_DsDatos As New DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTT_FICHA_TECNICA_ESPACIOLST.Name, V_OTT_FICHA_TECNICA_ESPACIOLST.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>17/12/2015 02:43:46 p.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOttFichaTecnicaEspaciolst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_Resultado As EntDatosPaginacion
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTT_FICHA_TECNICA_ESPACIOLST.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
