...
Namespace OrdenesDeTrabajo.AccesoDatos.OrdenesDeTrabajo
    Public Class DalOttGestionCompra
        Inherits DalBase
...
#Region "Funciones"
        ...
        Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Dim vlo_RegistroInterno As EntOttGestionCompra
            Dim vln_Resultado As Integer

            Try
                vln_Resultado = -1
                vlo_RegistroInterno = CType(pvo_Registro, EntOttGestionCompra)
                ...
                vlc_Sentencia = "prI_OTT_GESTION_COMPRA"
                ...
                If vlo_RegistroInterno.NumeroCheque <> String.Empty And vlo_RegistroInterno.NumeroCheque <> "-" Then
                    vlo_Conexion.SetParameter("pvc_NumeroCheque", OracleDbType.Varchar2, vlo_RegistroInterno.NumeroCheque)
                End If

                If vlo_RegistroInterno.NumeroGestionGeco <> String.Empty And vlo_RegistroInterno.NumeroGestionGeco <> "-" Then
                    vlo_Conexion.SetParameter("pvc_NumeroGestionGeco", OracleDbType.Varchar2, vlo_RegistroInterno.NumeroGestionGeco)
                End If

                'If vlo_RegistroInterno.FechaHoraImpresion <> Nothing Then
        ...
        Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prD_OTT_GESTION_COMPRA"
        ...
        Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTT_GESTION_COMPRA"
        ...
        Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
            ...
            Dim vlo_Resultado As New EntOttGestionCompra

            Try
                vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_GESTION_COMPRA.ID_UBICACION, "IdUbicacion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_GESTION_COMPRA.ID_VIA_COMPRA_CONTRATO, "IdViaCompraContrato"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_GESTION_COMPRA.ANNO, "Anno"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_GESTION_COMPRA.NUMERO_GESTION, "NumeroGestion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_GESTION_COMPRA.FECHA_REGISTRO_SOLICITUD, "FechaRegistroSolicitud"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_GESTION_COMPRA.OBSERVACIONES, "Observaciones"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_GESTION_COMPRA.NUMERO_CHEQUE, "NumeroCheque"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_GESTION_COMPRA.NUMERO_GESTION_GECO, "NumeroGestionGeco"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_GESTION_COMPRA.FECHA_HORA_IMPRESION, "FechaHoraImpresion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_GESTION_COMPRA.ESTADO, "Estado"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_GESTION_COMPRA.USUARIO, "Usuario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_GESTION_COMPRA.TIME_STAMP, "TimeStamp"))

                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOttGestionCompra)(vlo_MapeoEntidad)
        ...
        Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_GESTION_COMPRA.Name, "V_OTT_GESTION_COMPRA", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_GESTION_COMPRA.Name, "V_OTT_GESTION_COMPRALst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>18/08/2016 02:41:55 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ListarVOtthGestionCompra(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_GESTION_COMPRA.Name, "V_OTTH_GESTION_COMPRA", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>18/08/2016 02:41:55 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtthGestionCompra(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTTH_GESTION_COMPRA", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        ''' <creationDate>18/08/2016 02:41:55 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ListarVOttGestionCompra(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTT_GESTION_COMPRA.Name, V_OTT_GESTION_COMPRA.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>18/08/2016 02:41:55 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOttGestionCompra(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTT_GESTION_COMPRA.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        ''' <creationDate>18/08/2016 02:41:55 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ListarVOttGestionCompralst(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTT_GESTION_COMPRALST.Name, V_OTT_GESTION_COMPRALST.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>18/08/2016 02:41:55 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOttGestionCompralst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTT_GESTION_COMPRALST.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        ''' <summary>
        ''' Ejecuta la función FN_OT_NUMERO_GESTION_COMPRA
        ''' </summary>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ''' <creationDate>23/08/2016 02:50:02 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerFnOtNumeroGestionCompra(pvn_Annio As Integer, pvn_IdUbicacion As Integer, pvn_IdViaCompraContrato As Integer) As Double
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlc_Sentencia As String
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlc_Sentencia = "SELECT FN_OT_NUMERO_GESTION_COMPRA(:pvn_Annio, :pvn_IdUbicacion, :pvn_IdViaCompraContrato) AS RESULTADO FROM DUAL"
                ...
                vlo_Conexion.SetParameter("pvn_IdViaCompraContrato", OracleDbType.Int32, pvn_IdViaCompraContrato)
