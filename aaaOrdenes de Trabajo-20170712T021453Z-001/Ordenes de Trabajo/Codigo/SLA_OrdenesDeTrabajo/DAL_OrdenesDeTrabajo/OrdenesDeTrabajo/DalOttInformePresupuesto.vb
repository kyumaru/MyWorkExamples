...
Namespace OrdenesDeTrabajo.AccesoDatos.OrdenesDeTrabajo
    Public Class DalOttInformePresupuesto
        Inherits DalBase
...
#Region "Funciones"
        ...
        Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Dim vlo_RegistroInterno As EntOttInformePresupuesto
            Dim vln_Resultado As Integer

            Try
                vln_Resultado = -1
                vlo_RegistroInterno = CType(pvo_Registro, EntOttInformePresupuesto)
                ...
                vlc_Sentencia = "prI_OTT_INFORME_PRESUPUESTO"
                ...
                vlo_Conexion.SetParameter("pvn_EstimacionPresupuestaria", OracleDbType.Double, vlo_RegistroInterno.EstimacionPresupuestaria)
                If vlo_RegistroInterno.TiempoRespuesta <> 0 Then
                    vlo_Conexion.SetParameter("pvn_TiempoRespuesta", OracleDbType.Int32, vlo_RegistroInterno.TiempoRespuesta)
                End If
                If vlo_RegistroInterno.IdUnidadTiempo <> 0 Then
                    vlo_Conexion.SetParameter("pvn_IdUnidadTiempo", OracleDbType.Int32, vlo_RegistroInterno.IdUnidadTiempo)
                End If
                vlo_Conexion.SetParameter("pvc_Detalle", OracleDbType.Clob, vlo_RegistroInterno.Detalle)
        ...
        Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prD_OTT_INFORME_PRESUPUESTO"
        ...
        Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTT_INFORME_PRESUPUESTO"
        ...
        Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
            ...
            Dim vlo_Resultado As New EntOttInformePresupuesto

            Try
                vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_INFORME_PRESUPUESTO.ID_UBICACION, "IdUbicacion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_INFORME_PRESUPUESTO.ID_ORDEN_TRABAJO, "IdOrdenTrabajo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_INFORME_PRESUPUESTO.ESTIMACION_PRESUPUESTARIA, "EstimacionPresupuestaria"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_INFORME_PRESUPUESTO.TIEMPO_RESPUESTA, "TiempoRespuesta"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_INFORME_PRESUPUESTO.ID_UNIDAD_TIEMPO, "IdUnidadTiempo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_INFORME_PRESUPUESTO.DETALLE, "Detalle"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_INFORME_PRESUPUESTO.USUARIO, "Usuario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_INFORME_PRESUPUESTO.TIME_STAMP, "TimeStamp"))

                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOttInformePresupuesto)(vlo_MapeoEntidad)
        ...
        Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_INFORME_PRESUPUESTO.Name, "V_OTT_INFORME_PRESUPUESTO", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_INFORME_PRESUPUESTO.Name, "V_OTT_INFORME_PRESUPUESTOLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>06/04/2016 09:13:01 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ListarVOtthInformePresupuesto(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_INFORME_PRESUPUESTO.Name, "V_OTTH_INFORME_PRESUPUESTO", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>06/04/2016 09:13:01 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtthInformePresupuesto(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTTH_INFORME_PRESUPUESTO", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        ''' <creationDate>06/04/2016 09:13:01 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ListarVOttInformePresupuesto(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTT_INFORME_PRESUPUESTO.Name, V_OTT_INFORME_PRESUPUESTO.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>06/04/2016 09:13:01 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOttInformePresupuesto(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTT_INFORME_PRESUPUESTO.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        ''' <creationDate>06/04/2016 09:13:01 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ListarVOttInformePresupuestolst(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTT_INFORME_PRESUPUESTOLST.Name, V_OTT_INFORME_PRESUPUESTOLST.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>06/04/2016 09:13:01 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOttInformePresupuestolst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTT_INFORME_PRESUPUESTOLST.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
