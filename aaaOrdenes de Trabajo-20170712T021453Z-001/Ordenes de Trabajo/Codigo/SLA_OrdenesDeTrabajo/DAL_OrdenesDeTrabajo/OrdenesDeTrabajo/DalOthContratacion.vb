...
Namespace OrdenesDeTrabajo.AccesoDatos.OrdenesDeTrabajo
	Public Class DalOthContratacion
		Inherits DalBase
...
#Region "Funciones"
	...
	Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Dim vlo_RegistroInterno As EntOthContratacion
		Dim vln_Resultado As Integer

		Try
			vln_Resultado = -1
			vlo_RegistroInterno = CType(pvo_Registro, EntOthContratacion)
			...
			vlc_Sentencia = "prI_OTH_CONTRATACION"
			...
			vlo_Conexion.SetParameter("pvn_NumeroSolicitud", OracleDbType.Int32, vlo_RegistroInterno.NumeroSolicitud)
	...
	Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prD_OTH_CONTRATACION"
	...
	''' <summary>
	''' Permite modificar un registro en la tabla OTH_CONTRATACION
	''' </summary>
	''' <param name="pvo_Registro">Entidad a procesar</param>
	''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
	''' <author>Generador de Código basado en objetos Oracle</author>
	...
	Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prU_OTH_CONTRATACION"
	...
	Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
		...
		Dim vlo_Resultado As New EntOthContratacion

		Try
			vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
			If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
				vlo_MapeoEntidad = New List(Of MapeoSimple)
				vlo_MapeoEntidad.Add(New MapeoSimple(OTH_CONTRATACION.ID_UBICACION, "IdUbicacion"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTH_CONTRATACION.ID_ORDEN_TRABAJO, "IdOrdenTrabajo"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTH_CONTRATACION.VERSION, "Version"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTH_CONTRATACION.ID_VIA_CONTRATO, "IdViaContrato"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTH_CONTRATACION.EDITABLE, "Editable"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTH_CONTRATACION.NUMERO_SOLICITUD, "NumeroSolicitud"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTH_CONTRATACION.NUMERO_DECISION_INICIAL, "NumeroDecisionInicial"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTH_CONTRATACION.NUMERO_CONTRATO, "NumeroContrato"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTH_CONTRATACION.NOMBRE_CONTRATO, "NombreContrato"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTH_CONTRATACION.USUARIO, "Usuario"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTH_CONTRATACION.TIME_STAMP, "TimeStamp"))

				vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOthContratacion)(vlo_MapeoEntidad)
	...
	Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTH_CONTRATACION.Name, "V_OTH_CONTRATACION", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>14/04/2016 09:56:09 a.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOthContratacion(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTH_CONTRATACION", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
	...
	Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTH_CONTRATACION.Name, "V_OTH_CONTRATACIONLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>14/04/2016 09:56:09 a.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOthContratacionlst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_Resultado As EntDatosPaginacion
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTH_CONTRATACIONLst", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
