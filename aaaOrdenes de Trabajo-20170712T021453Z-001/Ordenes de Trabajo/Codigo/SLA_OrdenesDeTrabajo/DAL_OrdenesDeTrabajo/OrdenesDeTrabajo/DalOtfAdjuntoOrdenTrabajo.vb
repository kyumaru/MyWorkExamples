...
Namespace OrdenesDeTrabajo.AccesoDatos.OrdenesDeTrabajo
    Public Class DalOtfAdjuntoOrdenTrabajo
        Inherits DalBase
...
#Region "Metodos"
        ...
        ''' <changeLog></changeLog>
        Public Sub AdapterOtfAdjunto(pvo_DataSet As Data.DataSet)
            ...
            Try
                ...
                vlo_Conexion.AdapterCrear(String.Format("INSERT INTO OTF_ADJUNTO_ORDEN_TRABAJO (ID_UBICACION, ANNO, CONSECUTIVO, ID_ADJUNTO_ORDEN_TRABAJO, NOMBRE_ARCHIVO, ARCHIVO, USUARIO) VALUES (:ID_UBICACION, :ANNO, :CONSECUTIVO, SQ_ID_ADJUNTO_ORDEN_TRABAJO.NEXTVAL, :NOMBRE_ARCHIVO, :ARCHIVO, :USUARIO)"),
                                          String.Empty,
                                          String.Format("DELETE FROM {0} WHERE {1} = :{1}", Modelo.OTF_ADJUNTO_ORDEN_TRABAJO.Name, Modelo.OTF_ADJUNTO_ORDEN_TRABAJO.ID_ADJUNTO_ORDEN_TRABAJO))
                ...
                vlo_Conexion.AdapterAgregarParametro(String.Format(":{0}", Modelo.OTF_ADJUNTO_ORDEN_TRABAJO.ID_ADJUNTO_ORDEN_TRABAJO), String.Format("{0}", Modelo.OTF_ADJUNTO_ORDEN_TRABAJO.ID_ADJUNTO_ORDEN_TRABAJO), DbType.Int32, ConexionOracle.TipoParametro.Delete)
...
#Region "Funciones"
        ...
        ''' <creationDate>01/09/2015 05:07:51 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_RegistroInterno As EntOtfAdjuntoOrdenTrabajo
            Dim vln_Resultado As Integer

            Try
                vln_Resultado = -1
                vlo_RegistroInterno = CType(pvo_Registro, EntOtfAdjuntoOrdenTrabajo)
                ...
                vlc_Sentencia = "prI_OTF_ADJUNTO_ORDEN_TRABAJO"
        ...
        Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prD_OTF_ADJUNTO_ORDEN_TRABAJO"
        ...
        ''' <summary>
        ''' Permite modificar un registro en la tabla OTF_ADJUNTO_ORDEN_TRABAJO
        ''' </summary>
        ''' <param name="pvo_Registro">Entidad a procesar</param>
        ''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ...
        Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTF_ADJUNTO_ORDEN_TRABAJO"
        ...
        Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
            ...
            Dim vlo_Resultado As New EntOtfAdjuntoOrdenTrabajo

            Try
                vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_ADJUNTO_ORDEN_TRABAJO.ID_UBICACION, "IdUbicacion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_ADJUNTO_ORDEN_TRABAJO.ANNO, "Anno"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_ADJUNTO_ORDEN_TRABAJO.CONSECUTIVO, "Consecutivo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_ADJUNTO_ORDEN_TRABAJO.ID_ADJUNTO_ORDEN_TRABAJO, "IdAdjuntoOrdenTrabajo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_ADJUNTO_ORDEN_TRABAJO.NOMBRE_ARCHIVO, "NombreArchivo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_ADJUNTO_ORDEN_TRABAJO.ARCHIVO, "Archivo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_ADJUNTO_ORDEN_TRABAJO.USUARIO, "Usuario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTF_ADJUNTO_ORDEN_TRABAJO.TIME_STAMP, "TimeStamp"))

                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtfAdjuntoOrdenTrabajo)(vlo_MapeoEntidad)
        ...
        Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTF_ADJUNTO_ORDEN_TRABAJO.Name, "V_OTF_ADJUNTO_ORDEN_TRABAJO", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>01/09/2015 05:07:51 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtfAdjuntoOrdenTrabajo(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTF_ADJUNTO_ORDEN_TRABAJO", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTF_ADJUNTO_ORDEN_TRABAJO.Name, "V_OTF_ADJUNTO_ORDEN_TRABAJOLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>01/09/2015 05:07:51 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtfAdjuntoOrdenTrabajolst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTF_ADJUNTO_ORDEN_TRABAJOLst", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
