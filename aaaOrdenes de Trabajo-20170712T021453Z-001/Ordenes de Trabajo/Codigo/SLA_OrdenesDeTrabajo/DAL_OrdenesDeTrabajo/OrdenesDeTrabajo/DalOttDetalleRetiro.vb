...
Namespace OrdenesDeTrabajo.AccesoDatos.OrdenesDeTrabajo
    Public Class DalOttDetalleRetiro
        Inherits DalBase
...
#Region "Metodos"
        ...
        ''' <summary>
        ''' Adapter para solicitudes de salida
        ''' </summary>
        ...
        ''' <changeLog></changeLog>
        Public Sub AdapterSolicitudRetiro(pvo_DataSet As Data.DataSet)
            ...
            Try
                ...
                vlo_Conexion.AdapterCrear(String.Format("INSERT INTO OTT_DETALLE_RETIRO (ANNO, ID_SOLICITUD_RETIRO, ID_DETALLE_MATERIAL, CANTIDAD_SOLICITADA, ESTADO, COSTO_CALCULADO, USUARIO) VALUES (:ANNO, :ID_SOLICITUD_RETIRO, :ID_DETALLE_MATERIAL, :CANTIDAD_SOLICITADA, :ESTADO, :COSTO_CALCULADO, :USUARIO)"),
                                          String.Empty,
                                          String.Empty)

                vlo_Conexion.AdapterAgregarParametro(":ANNO", "ANNO", DbType.Int32, ConexionOracle.TipoParametro.Insert)
                vlo_Conexion.AdapterAgregarParametro(":ID_SOLICITUD_RETIRO", "ID_SOLICITUD_RETIRO", DbType.Int32, ConexionOracle.TipoParametro.Insert)
                ...
                vlo_Conexion.AdapterAgregarParametro(":CANTIDAD_SOLICITADA", "CANTIDAD_SOLICITADA", DbType.Int32, ConexionOracle.TipoParametro.Insert)
                vlo_Conexion.AdapterAgregarParametro(":ESTADO", "ESTADO", DbType.String, ConexionOracle.TipoParametro.Insert)
                vlo_Conexion.AdapterAgregarParametro(":COSTO_CALCULADO", "COSTO_CALCULADO", DbType.Int32, ConexionOracle.TipoParametro.Insert)
...
#Region "Funciones"
        ...
        Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_RegistroInterno As EntOttDetalleRetiro
            Dim vln_Resultado As Integer

            Try
                vln_Resultado = -1
                vlo_RegistroInterno = CType(pvo_Registro, EntOttDetalleRetiro)
                ...
                vlc_Sentencia = "prI_OTT_DETALLE_RETIRO"
        ...
        Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prD_OTT_DETALLE_RETIRO"
        ...
        ''' <summary>
        ''' Permite modificar un registro en la tabla OTT_DETALLE_RETIRO
        ''' </summary>
        ''' <param name="pvo_Registro">Entidad a procesar</param>
        ''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ...
        Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTT_DETALLE_RETIRO"
        ...
        Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
            ...
            Dim vlo_Resultado As New EntOttDetalleRetiro

            Try
                vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_DETALLE_RETIRO.ANNO, "Anno"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_DETALLE_RETIRO.ID_SOLICITUD_RETIRO, "IdSolicitudRetiro"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_DETALLE_RETIRO.ID_DETALLE_MATERIAL, "IdDetalleMaterial"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_DETALLE_RETIRO.CANTIDAD_SOLICITADA, "CantidadSolicitada"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_DETALLE_RETIRO.CANTIDAD_RETIRADA, "CantidadRetirada"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_DETALLE_RETIRO.COSTO_CALCULADO, "CostoCalculado"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_DETALLE_RETIRO.ESTADO, "Estado"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_DETALLE_RETIRO.USUARIO, "Usuario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_DETALLE_RETIRO.TIME_STAMP, "TimeStamp"))

                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOttDetalleRetiro)(vlo_MapeoEntidad)
        ...
        Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_DETALLE_RETIRO.Name, "V_OTT_DETALLE_RETIRO", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>21/06/2016 02:32:03 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOttDetalleRetiro(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTT_DETALLE_RETIRO", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_DETALLE_RETIRO.Name, "V_OTT_DETALLE_RETIROLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>21/06/2016 02:32:03 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOttDetalleRetirolst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTT_DETALLE_RETIROLst", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        ''' <creationDate>21/06/2016 02:32:03 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ListarVOtthDetalleRetiro(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_DETALLE_RETIRO.Name, "V_OTTH_DETALLE_RETIRO", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>21/06/2016 02:32:03 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtthDetalleRetiro(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTTH_DETALLE_RETIRO", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
