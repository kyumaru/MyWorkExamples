...
Namespace OrdenesDeTrabajo.AccesoDatos.OrdenesDeTrabajo
	Public Class DalOtlDetAprovisionamiento
		Inherits DalBase
...
#Region "Funciones"
	...
	Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Dim vlo_RegistroInterno As EntOtlDetAprovisionamiento
		Dim vln_Resultado As Integer

		Try
			vln_Resultado = -1
			vlo_RegistroInterno = CType(pvo_Registro, EntOtlDetAprovisionamiento)
			...
			vlc_Sentencia = "prI_OTL_DET_APROVISIONAMIENTO"

			vlo_Conexion.SetParameter("prn_IdDetAprovisionamiento", OracleDbType.Int32, vln_Resultado, ParameterDirection.Output)
			...
			vln_Resultado = CType(vlo_Conexion.GetParameterValue("prn_IdDetAprovisionamiento"), Integer)
	...
	Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prD_OTL_DET_APROVISIONAMIENTO"

			vlo_Conexion.SetParameter("pvn_IdDetAprovisionamiento", OracleDbType.Int32, vlo_RegistroInterno.IdDetAprovisionamiento)
			vlo_Conexion.SetParameter("pvn_IdUbicacion", OracleDbType.Int32, vlo_RegistroInterno.IdUbicacion)
			vlo_Conexion.SetParameter("pvn_NumeroGestion", OracleDbType.Int32, vlo_RegistroInterno.NumeroGestion)
			vlo_Conexion.SetParameter("pvn_Anno", OracleDbType.Int32, vlo_RegistroInterno.Anno)
			vlo_Conexion.SetParameter("pvn_IdMaterial", OracleDbType.Int32, vlo_RegistroInterno.IdMaterial)
	...
	Public Overrides Function BorrarRegistro() As Integer
        ...
        ''' <summary>
        ''' Permite modificar un registro en la tabla OTL_DET_APROVISIONAMIENTO
        ''' </summary>
        ''' <param name="pvo_Registro">Entidad a procesar</param>
        ''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ...
        Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTL_DET_APROVISIONAMIENTO"
        ...
        Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
            ...
            Dim vlo_Resultado As New EntOtlDetAprovisionamiento

            Try
                vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_DET_APROVISIONAMIENTO.ID_DET_APROVISIONAMIENTO, "IdDetAprovisionamiento"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_DET_APROVISIONAMIENTO.ID_UBICACION, "IdUbicacion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_DET_APROVISIONAMIENTO.NUMERO_GESTION, "NumeroGestion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_DET_APROVISIONAMIENTO.ANNO, "Anno"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_DET_APROVISIONAMIENTO.ID_MATERIAL, "IdMaterial"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_DET_APROVISIONAMIENTO.CANTIDAD, "Cantidad"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_DET_APROVISIONAMIENTO.OBSERVACIONES, "Observaciones"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_DET_APROVISIONAMIENTO.ESTADO, "Estado"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_DET_APROVISIONAMIENTO.USUARIO, "Usuario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTL_DET_APROVISIONAMIENTO.TIME_STAMP, "TimeStamp"))

                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtlDetAprovisionamiento)(vlo_MapeoEntidad)
        ...
        Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTL_DET_APROVISIONAMIENTO.Name, "V_OTL_DET_APROVISIONAMIENTO", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>11/01/2017 01:45:14 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtlDetAprovisionamiento(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTL_DET_APROVISIONAMIENTO", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTL_DET_APROVISIONAMIENTO.Name, "V_OTL_DET_APROVISIONAMIENTOLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>11/01/2017 01:45:14 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtlDetAprovisionamientolst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTL_DET_APROVISIONAMIENTOLst", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
