...
Namespace OrdenesDeTrabajo.AccesoDatos.OrdenesDeTrabajo
	Public Class DalOtfFichaTecnicaSubcomp
		Inherits DalBase
...
#Region "Metodos"
        ...
        ''' <changeLog></changeLog>
        Public Sub AdapterOtfFichaTecnicaSubComp(pvo_DataSet As Data.DataSet)
            ...
            Try
                ...
                vlo_Conexion.AdapterCrear(String.Format("INSERT INTO OTF_FICHA_TECNICA_SUBCOMP (ID_UBICACION, ID_PRE_ORDEN_TRABAJO, ID_ESPACIO, ID_SUBCOMPONENTE) VALUES (:ID_UBICACION, :ID_PRE_ORDEN_TRABAJO, :ID_ESPACIO, :ID_SUBCOMPONENTE)"),
                                          String.Empty,
                                          String.Format("DELETE FROM {0} WHERE {1} = :{1} AND {2} = :{2}", Modelo.OTF_FICHA_TECNICA_SUBCOMP.Name, Modelo.OTF_FICHA_TECNICA_SUBCOMP.ID_ESPACIO, Modelo.OTF_FICHA_TECNICA_SUBCOMP.ID_SUBCOMPONENTE))
                ...
                vlo_Conexion.AdapterAgregarParametro(String.Format(":{0}", Modelo.OTF_FICHA_TECNICA_SUBCOMP.ID_ESPACIO), String.Format("{0}", Modelo.OTF_FICHA_TECNICA_SUBCOMP.ID_ESPACIO), DbType.Int32, ConexionOracle.TipoParametro.Delete)
                vlo_Conexion.AdapterAgregarParametro(String.Format(":{0}", Modelo.OTF_FICHA_TECNICA_SUBCOMP.ID_SUBCOMPONENTE), String.Format("{0}", Modelo.OTF_FICHA_TECNICA_SUBCOMP.ID_SUBCOMPONENTE), DbType.Int32, ConexionOracle.TipoParametro.Delete)
...
#Region "Funciones"
	...
	Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_RegistroInterno As EntOtfFichaTecnicaSubcomp
		Dim vln_Resultado As Integer

		Try
			vln_Resultado = -1
			vlo_RegistroInterno = CType(pvo_Registro, EntOtfFichaTecnicaSubcomp)
			...
			vlc_Sentencia = "prI_OTF_FICHA_TECNICA_SUBCOMP"
	...
	Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prD_OTF_FICHA_TECNICA_SUBCOMP"
	...
	''' <summary>
	''' Permite modificar un registro en la tabla OTF_FICHA_TECNICA_SUBCOMP
	''' </summary>
	''' <param name="pvo_Registro">Entidad a procesar</param>
	''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
	''' <author>Generador de Código basado en objetos Oracle</author>
	...
	Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Try
			...
			vlc_Sentencia = "prU_OTF_FICHA_TECNICA_SUBCOMP"
	...
	Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
		...
		Dim vlo_Resultado As New EntOtfFichaTecnicaSubcomp

		Try
			vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
			If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
				vlo_MapeoEntidad = New List(Of MapeoSimple)
				vlo_MapeoEntidad.Add(New MapeoSimple(OTF_FICHA_TECNICA_SUBCOMP.ID_UBICACION, "IdUbicacion"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTF_FICHA_TECNICA_SUBCOMP.ID_PRE_ORDEN_TRABAJO, "IdPreOrdenTrabajo"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTF_FICHA_TECNICA_SUBCOMP.ID_ESPACIO, "IdEspacio"))
				vlo_MapeoEntidad.Add(New MapeoSimple(OTF_FICHA_TECNICA_SUBCOMP.ID_SUBCOMPONENTE, "IdSubcomponente"))

				vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOtfFichaTecnicaSubcomp)(vlo_MapeoEntidad)
	...
	Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTF_FICHA_TECNICA_SUBCOMP.Name, "V_OTF_FICHA_TECNICA_SUBCOMP", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTF_FICHA_TECNICA_SUBCOMP.Name, "V_OTF_FICHA_TECNICA_SUBCOMPLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>14/04/2016 09:20:07 a.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ListarVOtfFichaTecnicaSubcomp(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_DsDatos As New DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTF_FICHA_TECNICA_SUBCOMP.Name, V_OTF_FICHA_TECNICA_SUBCOMP.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>14/04/2016 09:20:07 a.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtfFichaTecnicaSubcomp(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTF_FICHA_TECNICA_SUBCOMP.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
	...
	''' <creationDate>14/04/2016 09:20:07 a.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ListarVOtfFichaTecnicaSubcomplst(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_DsDatos As New DataSet
		...
		Try
			...
			vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, V_OTF_FICHA_TECNICA_SUBCOMPLST.Name, V_OTF_FICHA_TECNICA_SUBCOMPLST.Name, pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
	...
	''' <creationDate>14/04/2016 09:20:07 a.m.</creationDate>
	''' <changeLog></changeLog>
	Public Function ObtenerDatosPaginacionVOtfFichaTecnicaSubcomplst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
		Dim vlo_Conexion As DbBase
		Dim vlb_DisposeConexion As Boolean
		Dim vlo_Resultado As EntDatosPaginacion
		...
		Try
			...
			vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, V_OTF_FICHA_TECNICA_SUBCOMPLST.Name, pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
