...
Namespace OrdenesDeTrabajo.AccesoDatos.OrdenesDeTrabajo
	Public Class DalOttLineaAdjudicacion
		Inherits DalBase
...
#Region "Funciones"
	...
	Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
		...
		Dim vlo_RegistroInterno As EntOttLineaAdjudicacion
		Dim vln_Resultado As Integer

		Try
			vln_Resultado = -1
			vlo_RegistroInterno = CType(pvo_Registro, EntOttLineaAdjudicacion)
			...
			vlc_Sentencia = "prI_OTT_LINEA_ADJUDICACION"
			...
			vlo_Conexion.SetParameter("pvn_MontoAdjudicado", OracleDbType.Double, vlo_RegistroInterno.MontoAdjudicado)
			vlo_Conexion.SetParameter("pvc_Adjudicatario", OracleDbType.Varchar2, vlo_RegistroInterno.Adjudicatario)
			vlo_Conexion.SetParameter("pvd_FechaInicioObra", OracleDbType.Date, vlo_RegistroInterno.FechaInicioObra)
			vlo_Conexion.SetParameter("pvn_PlazoEnDias", OracleDbType.Int32, vlo_RegistroInterno.PlazoEnDias)
			vlo_Conexion.SetParameter("pvc_FormaCalculoDias", OracleDbType.Varchar2, vlo_RegistroInterno.FormaCalculoDias)
			vlo_Conexion.SetParameter("pvd_FechaFinEstimada", OracleDbType.Date, vlo_RegistroInterno.FechaFinEstimada)
        ...
        Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prD_OTT_LINEA_ADJUDICACION"
        ...
        ''' <summary>
        ''' Permite modificar un registro en la tabla OTT_LINEA_ADJUDICACION
        ''' </summary>
        ''' <param name="pvo_Registro">Entidad a procesar</param>
        ''' <returns>Mayor a cero: El proceso ha sido exitoso. Menor a cero: El proceso ha fallado</returns>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ...
        Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTT_LINEA_ADJUDICACION"
        ...
        Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
            ...
            Dim vlo_Resultado As New EntOttLineaAdjudicacion

            Try
                vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_LINEA_ADJUDICACION.ID_UBICACION, "IdUbicacion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_LINEA_ADJUDICACION.ID_ORDEN_TRABAJO, "IdOrdenTrabajo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_LINEA_ADJUDICACION.VERSION, "Version"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_LINEA_ADJUDICACION.NUMERO_LINEA, "NumeroLinea"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_LINEA_ADJUDICACION.MONTO_ADJUDICADO, "MontoAdjudicado"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_LINEA_ADJUDICACION.ADJUDICATARIO, "Adjudicatario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_LINEA_ADJUDICACION.FECHA_INICIO_OBRA, "FechaInicioObra"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_LINEA_ADJUDICACION.PLAZO_EN_DIAS, "PlazoEnDias"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_LINEA_ADJUDICACION.FORMA_CALCULO_DIAS, "FormaCalculoDias"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_LINEA_ADJUDICACION.FECHA_FIN_ESTIMADA, "FechaFinEstimada"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_LINEA_ADJUDICACION.USUARIO, "Usuario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_LINEA_ADJUDICACION.TIME_STAMP, "TimeStamp"))

                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOttLineaAdjudicacion)(vlo_MapeoEntidad)
        ...
        Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_LINEA_ADJUDICACION.Name, "V_OTT_LINEA_ADJUDICACION", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>06/05/2016 10:46:05 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOttLineaAdjudicacion(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTT_LINEA_ADJUDICACION", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_LINEA_ADJUDICACION.Name, "V_OTT_LINEA_ADJUDICACIONLst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>06/05/2016 10:46:05 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOttLineaAdjudicacionlst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTT_LINEA_ADJUDICACIONLst", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        ''' <creationDate>06/05/2016 10:46:05 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ListarVOtthLineaAdjudicacion(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_LINEA_ADJUDICACION.Name, "V_OTTH_LINEA_ADJUDICACION", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>06/05/2016 10:46:05 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtthLineaAdjudicacion(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTTH_LINEA_ADJUDICACION", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
