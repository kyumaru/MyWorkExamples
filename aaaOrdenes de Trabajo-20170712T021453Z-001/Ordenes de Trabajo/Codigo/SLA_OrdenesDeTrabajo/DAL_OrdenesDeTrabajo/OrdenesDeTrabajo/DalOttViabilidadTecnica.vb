...
Namespace OrdenesDeTrabajo.AccesoDatos.OrdenesDeTrabajo
    Public Class DalOttViabilidadTecnica
        Inherits DalBase
...
#Region "Funciones"
        ...
        Public Overrides Function InsertarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Dim vlo_RegistroInterno As EntOttViabilidadTecnica
            Dim vln_Resultado As Integer

            Try
                vln_Resultado = -1
                vlo_RegistroInterno = CType(pvo_Registro, EntOttViabilidadTecnica)
                ...
                vlc_Sentencia = "prI_OTT_VIABILIDAD_TECNICA"
                ...
                End If
                vlo_Conexion.SetParameter("pvn_Viabilidad", OracleDbType.Int32, vlo_RegistroInterno.Viabilidad)
        ...
        Public Overrides Function BorrarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prD_OTT_VIABILIDAD_TECNICA"
        ...
        Public Overrides Function ModificarRegistro(ByVal pvo_Registro As EntBase) As Integer
            ...
            Try
                ...
                vlc_Sentencia = "prU_OTT_VIABILIDAD_TECNICA"
        ...
        Public Overrides Function ObtenerRegistro(ByVal pvc_Condicion As String) As EntBase
            ...
            Dim vlo_Resultado As New EntOttViabilidadTecnica

            Try
                vlo_DsDatos = ListarRegistros(pvc_Condicion, String.Empty, False, 0, 0)
                If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                    vlo_MapeoEntidad = New List(Of MapeoSimple)
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_VIABILIDAD_TECNICA.ID_UBICACION, "IdUbicacion"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_VIABILIDAD_TECNICA.ID_ORDEN_TRABAJO, "IdOrdenTrabajo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_VIABILIDAD_TECNICA.ID_UNIDAD_TIEMPO, "IdUnidadTiempo"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_VIABILIDAD_TECNICA.TIEMPO_RESPUESTA, "TiempoRespuesta"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_VIABILIDAD_TECNICA.VIABILIDAD, "Viabilidad"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_VIABILIDAD_TECNICA.ESTIMACION_PRESUPUESTARIA, "EstimacionPresupuestaria"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_VIABILIDAD_TECNICA.DETALLE, "Detalle"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_VIABILIDAD_TECNICA.USUARIO, "Usuario"))
                    vlo_MapeoEntidad.Add(New MapeoSimple(OTT_VIABILIDAD_TECNICA.TIME_STAMP, "TimeStamp"))

                    vlo_Resultado = vlo_DsDatos.Tables(0).Rows(0).ToEntity(Of EntOttViabilidadTecnica)(vlo_MapeoEntidad)
        ...
        Public Overrides Function ListarRegistros(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_VIABILIDAD_TECNICA.Name, "V_OTT_VIABILIDAD_TECNICA", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>18/02/2016 03:07:35 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOttViabilidadTecnica(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTT_VIABILIDAD_TECNICA", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        Public Overrides Function ListarRegistrosLista(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_VIABILIDAD_TECNICA.Name, "V_OTT_VIABILIDAD_TECNICALst", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>18/02/2016 03:07:35 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOttViabilidadTecnicalst(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTT_VIABILIDAD_TECNICALst", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
        ...
        ''' <creationDate>18/02/2016 03:07:35 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ListarVOtthViabilidadTecnica(pvc_Condicion As String, pvc_Orden As String, pvb_Paginar As Boolean, pvn_NumeroPagina As Integer, pvn_TamanoPagina As Integer) As DataSet
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_DsDatos As New DataSet
            ...
            Try
                ...
                vlo_DsDatos = Me.EjecutarVista(vlo_Conexion, OTT_VIABILIDAD_TECNICA.Name, "V_OTTH_VIABILIDAD_TECNICA", pvc_Condicion, pvc_Orden, pvb_Paginar, pvn_NumeroPagina, pvn_TamanoPagina)
        ...
        ''' <creationDate>18/02/2016 03:07:35 p.m.</creationDate>
        ''' <changeLog></changeLog>
        Public Function ObtenerDatosPaginacionVOtthViabilidadTecnica(pvc_Condicion As String, pvc_Orden As String, pvn_TamanoPagina As Integer) As EntDatosPaginacion
            Dim vlo_Conexion As DbBase
            Dim vlb_DisposeConexion As Boolean
            Dim vlo_Resultado As EntDatosPaginacion
            ...
            Try
                ...
                vlo_Resultado = Me.ObtenerDatosPaginacionVista(vlo_Conexion, "V_OTTH_VIABILIDAD_TECNICA", pvc_Condicion, pvc_Orden, pvn_TamanoPagina)
