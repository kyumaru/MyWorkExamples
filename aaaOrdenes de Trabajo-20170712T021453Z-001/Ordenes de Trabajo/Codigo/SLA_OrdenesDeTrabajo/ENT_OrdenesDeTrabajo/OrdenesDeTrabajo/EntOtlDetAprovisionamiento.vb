...
Namespace OrdenesDeTrabajo.EntidadNegocio.OrdenesDeTrabajo
	<Serializable()> _
	Public Class EntOtlDetAprovisionamiento
		Inherits EntBase
#Region "Atributos"
	Private vgn_IdDetAprovisionamiento AS Integer 'Llave primaria de la tabla de bitácora del aprovisionamiento
...
#Region "Propiedades"
	...
	''' <changeLog></changeLog>
	Public Property IdDetAprovisionamiento() As Integer
		Get
			Return vgn_IdDetAprovisionamiento
		End Get
		Set(ByVal value As Integer)
			vgn_IdDetAprovisionamiento = value
		End Set
	End Property
