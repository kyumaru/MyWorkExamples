...
Namespace OrdenesDeTrabajo.EntidadNegocio.OrdenesDeTrabajo
	<Serializable()> _
	Public Class EntOttAdjuntoGestionCompr
		Inherits EntBase
#Region "Atributos"
	...
	Private vgn_IdAdjuntoGestionCompr AS Integer 'Llave de la tabla ott_adjunto_gestion_compr asociada a la secuencia sq_id_adjunto_gestion_compr
	...
	Private vgc_NumeroOrdenCompra AS String 'Número de orden de compra
...
#Region "Propiedades"
	...
	''' <creationDate>24/10/2016 01:26:16 p.m.</creationDate>
	''' <changeLog></changeLog>
	Public Property IdAdjuntoGestionCompr() As Integer
		Get
			Return vgn_IdAdjuntoGestionCompr
		End Get
		Set(ByVal value As Integer)
			vgn_IdAdjuntoGestionCompr = value
		End Set
	End Property
	...
	Public Property NumeroOrdenCompra() As String
		Get
			Return vgc_NumeroOrdenCompra
		End Get
		Set(ByVal value As String)
			vgc_NumeroOrdenCompra = value
		End Set
	End Property
