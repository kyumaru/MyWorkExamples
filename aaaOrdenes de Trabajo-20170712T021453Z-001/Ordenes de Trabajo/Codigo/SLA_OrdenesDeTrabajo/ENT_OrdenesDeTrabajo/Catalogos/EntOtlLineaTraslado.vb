...
Namespace ORDENES_TRABAJO.EntidadNegocio.Catalogos
	<Serializable()> _
	Public Class EntOtlLineaTraslado
		Inherits EntBase
#Region "Atributos"
	...
	Private vgn_IdAlmacen AS Integer 'Llave primaria de la tabla otm_almacen_bodega que se asocia con la secuencia sq_id_almacen_bodega
