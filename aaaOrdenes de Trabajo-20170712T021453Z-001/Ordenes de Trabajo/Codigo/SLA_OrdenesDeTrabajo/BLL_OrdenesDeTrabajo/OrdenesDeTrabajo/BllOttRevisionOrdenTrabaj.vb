...
Namespace OrdenesDeTrabajo.LogicaNegocio.OrdenesDeTrabajo
    Public Class BllOttRevisionOrdenTrabaj
#Region "Atributos"
...
#Region "Funciones"
        ''' <summary>
        ''' Permite agregar un registro en la tabla OTT_REVISION_ORDEN_TRABAJ, no sin antes aplicar la validación de la llave primaria o alterna según corresponda
        ''' </summary>
        ...
        ''' <changeLog></changeLog>
        Public Function InsertarRegistro(ByVal pvo_Registro As EntOttRevisionOrdenTrabaj) As Integer
            ...
            Try
                ...
                vln_Resultado = vlo_DalOttRevisionOrdenTrabaj.InsertarRegistro(pvo_Registro)
        ...
        ''' <changeLog></changeLog>
        Public Function InsertarRevisionEnvioCorreo(pvo_Registro As EntOttRevisionOrdenTrabaj, pvn_NumeroEmpleado As Integer, pvc_Descripcion As String, pvc_Motivo As String, pvo_FechaHoraSolicita As Date) As Integer
            Dim vlo_Conexion As ConexionOracle
            Dim vlb_LiberarConexion As Boolean
            ...
            Try
                ...
                vlo_EntOttOrdenTrabajo.Usuario = pvo_Registro.Usuario
                ...
                Select Case pvo_Registro.Estado
                    Case EstadoRevision.DEVUELTA, EstadoRevision.DENEGADA
                        ...
                        vlo_EntOttTrazabilidadProceso.NumEmpleadoEjecuta = pvn_NumeroEmpleado
                        vlo_EntOttTrazabilidadProceso.EstadoOrdenTrabajo = pvo_Registro.Estado
                        'vlo_EntOttTrazabilidadProceso.FechaHoraEjecucion = DateTime.Now
                        vlo_EntOttTrazabilidadProceso.Observaciones = pvo_Registro.Observaciones
                ...
                vlo_DalOttRevisionOrdenTrabaj = New DalOttRevisionOrdenTrabaj(vlo_Conexion)
                vlo_DalOttRevisionOrdenTrabaj.InsertarRegistro(pvo_Registro)
        ...
        ''' </summary>
        ''' <param name="pvn_IdRevisionOrdenTrabaj">Llave primaria de la tabla ott_revision_orden_trabaj que se asocia con la secuencia sq_id_revision_orden_trabaj</param>
        ''' <returns>Entidad que representa la información obtenida al ejecutar la consulta</returns>
        ''' <author>Generador de Código basado en objetos Oracle</author>
        ''' <creationDate>31/08/2015 08:25:27 a.m.</creationDate>
        ''' <changeLog></changeLog>
        Private Function ObtenerRegistroPorLlavePrimaria(pvn_IdRevisionOrdenTrabaj As Integer) As EntOttRevisionOrdenTrabaj
            Dim vlo_Conexion As ConexionOracle
            Dim vlb_LiberarConexion As Boolean
            Dim vlo_DalOttRevisionOrdenTrabaj As DalOttRevisionOrdenTrabaj
            ...
            Try
                ...
                vlo_DalOttRevisionOrdenTrabaj = New DalOttRevisionOrdenTrabaj(vlo_Conexion)
                Return vlo_DalOttRevisionOrdenTrabaj.ObtenerRegistro(String.Format("{0} = {1}", Modelo.OTT_REVISION_ORDEN_TRABAJ.ID_REVISION_ORDEN_TRABAJ, pvn_IdRevisionOrdenTrabaj))
            Catch vlo_Excepcion As Exception
                Throw
            Finally
                If vlb_LiberarConexion Then
