<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage/Mp_Formulario.master" CodeFile="Rpt_OT_GeneralSectoresOTalleres.aspx.vb" Inherits="Reportes_Rpt_OT_GeneralSectoresOTalleres" %>

<asp:Content runat="server" ID="Content1" ContentPlaceHolderID="cphFormulario">

    <header>
        <h2>
            Reporte general de órdenes de trabajo por sectores o talleres
        </h2>
    </header>
    ...
    <article data-grupo="FiltrosDeBusqueda" class="formulario">
        <table>
            ...
            <tr>
                <th>Ordenamiento</th>
                <td>
                    <asp:RadioButton ID="rbtFecha" runat="server" Text="Fecha de Asignación" GroupName="Condicion" AutoPostBack="true" Checked="true" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:RadioButton ID="rbtEstado" runat="server" Text="Estado" GroupName="Condicion" AutoPostBack="true"/>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:RadioButton ID="rbtNumOt" runat="server" Text="Número de OT" GroupName="Condicion" AutoPostBack="true" />
                </td>
            </tr>
