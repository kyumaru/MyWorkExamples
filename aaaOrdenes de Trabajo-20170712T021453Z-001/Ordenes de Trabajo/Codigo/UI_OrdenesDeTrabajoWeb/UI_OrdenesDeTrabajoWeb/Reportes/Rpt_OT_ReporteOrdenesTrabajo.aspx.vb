...
Partial Class Reportes_Rpt_OT_ReporteOrdenesTrabajo
...
#Region "Eventos"
    ...
    Protected Sub btnGenerar_Click(sender As Object, e As EventArgs) Handles btnGenerar.Click
        Try
            ...
            Response.Redirect(String.Format("RPT_OT_ReportePDF.aspx?pvc_Condicion={0}&pvc_Orden={1}&pvc_NombreReporte={2}", ObtenerCondicionBusqueda(), ObtenerOrden(), Reportes.RPT_OT_REPORTE_ORDENES_TRABAJO))
