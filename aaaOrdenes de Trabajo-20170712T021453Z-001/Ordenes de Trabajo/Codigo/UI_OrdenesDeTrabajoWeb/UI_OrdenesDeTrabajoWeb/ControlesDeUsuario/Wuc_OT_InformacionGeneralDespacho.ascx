<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Wuc_OT_InformacionGeneralDespacho.ascx.vb" Inherits="ControlesDeUsuario_Wuc_OT_InformacionGeneral" %>
...
<article class="formulario">
    <table runat="server">
        ...
        <tr>
            <th>Solicitante Gestión de Salida:</th>
            <td colspan="2">
