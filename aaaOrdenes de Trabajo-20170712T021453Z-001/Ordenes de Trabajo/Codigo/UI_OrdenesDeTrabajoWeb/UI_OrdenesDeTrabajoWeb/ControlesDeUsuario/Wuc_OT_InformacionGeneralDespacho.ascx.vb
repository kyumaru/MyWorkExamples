...
#Region "Metodos"
    ...
    Private Sub Inicializar(pvc_IdOrdenTrabajo As String, pvc_IdUbicacion As String, pvc_Anno As Integer, pvn_NumContrato As String, pvc_NombreContrato As String)
        ...
        Dim vlo_DsDatosPRUEBA As DataSet
        ...
        Try
            ...
            vlo_DsDatosPRUEBA = vlo_Ws_OT_OrdenesDeTrabajo.OTT_ORDEN_TRABAJO_ListarRegistrosLista(
                    ConfigurationManager.AppSettings(ConstantesInternas.APP_KEY_USUARIO_APLICACION_WEB),
                    ConfigurationManager.AppSettings(ConstantesInternas.APP_KEY_CLAVE_APLICACION_WEB),
            ...
            If vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                ...
                Me.lblResponsable.Text = vlo_DsDatosPRUEBA.Tables(0).Rows(0)(Modelo.V_OTT_ORDEN_TRABAJOLST.NOMBRE_SOLICITANTE)
