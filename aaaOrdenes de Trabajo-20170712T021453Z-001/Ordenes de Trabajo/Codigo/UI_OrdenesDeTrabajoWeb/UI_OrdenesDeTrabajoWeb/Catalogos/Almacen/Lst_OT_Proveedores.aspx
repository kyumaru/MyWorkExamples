<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Listado.master" AutoEventWireup="false" CodeFile="Lst_OT_Proveedores.aspx.vb" Inherits="Catalogos_Almacen_Lst_OT_Proveedores" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphFormulario" Runat="Server">
    ...
    <article data-grupo="FiltrosDeBusqueda" class="formulario">
        ...
        <article class="areaBotonesListado">
            <a id="lnkNuevoRegistroFiltro" href="Frm_OT_Proveedores.aspx?pvn_Operacion=<%=Utilerias.OrdenesDeTrabajo.eOperacion.Agregar%>">
        ...
        <table>
            <tr>
                <th>Nombre</th>
                <td>
                    <asp:TextBox  Width="40%" runat="server" ID="txtFiltroNombre" data-tipocontrol="texto" MaxLength="100"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th>Identificación</th>
                <td>
                    <asp:TextBox  Width="40%" runat="server" ID="txtFiltroIdentificación" data-tipocontrol="texto" MaxLength="100"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th>Estado</th>
    ...
    <article data-grupo="Listado" class="listado">
        ...
        <article class="areaBotonesListado">
            <a id="lnkNuevoRegistro" href="Frm_OT_Proveedores.aspx?pvn_Operacion=<%=Utilerias.OrdenesDeTrabajo.eOperacion.Agregar%>">
        ...
        <asp:Repeater runat="server" ID="rpProveedores">
            <HeaderTemplate>
                <table>
                    <tr>
                        <th>
                            <asp:LinkButton runat="server" ID="lnkNombre" Text="Nombre" CommandName="<%#Utilerias.OrdenesDeTrabajo.Modelo.OTM_PROVEEDOR.NOMBRE%>" CommandArgument="ASC" OnCommand="lnkRpProveedores_Command"></asp:LinkButton>
                        </th>
                        <th>
                            <asp:LinkButton runat="server" ID="lnkIdentificacion" Text="Identificación" CommandName="<%#Utilerias.OrdenesDeTrabajo.Modelo.OTM_PROVEEDOR.IDENTIFICACION%>" CommandArgument="ASC" OnCommand="lnkRpProveedores_Command"></asp:LinkButton>
                        </th>
                        <th>
                            <asp:LinkButton runat="server" ID="lnkEstado" Text="Estado" CommandName="<%#Utilerias.OrdenesDeTrabajo.Modelo.OTM_PROVEEDOR.ESTADO%>" CommandArgument="ASC" OnCommand="lnkRpProveedores_Command"></asp:LinkButton>
                        </th>
                        <th>&nbsp;</th>
                        <th>&nbsp;</th>
                    </tr>
            ...
            <ItemTemplate>
                <tr class="lineaDelListado">
                    <td><%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.OTM_PROVEEDOR.NOMBRE)%></td>
                    <td><%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.OTM_PROVEEDOR.IDENTIFICACION)%></td>
                    <td><%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.OTM_PROVEEDOR.DESC_ESTADO)%></td>
                    <td>
                        <a href="Frm_OT_Proveedores.aspx?pvn_Operacion=<%#Utilerias.OrdenesDeTrabajo.eOperacion.Modificar%>&pvn_Identificacion=<%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.OTM_PROVEEDOR.IDENTIFICACION)%>">
                    ...
                    <td>
                        <asp:ImageButton runat="server" ID="ibBorrar" AlternateText="Borrar Registro" data-tipo="borrarRegistro" ToolTip="Borrar registro"
                            CommandArgument='<%# String.Format("{0}", Eval(Utilerias.OrdenesDeTrabajo.Modelo.OTM_PROVEEDOR.IDENTIFICACION))%>'
                            Visible="<%#IIf(CType(Eval(Utilerias.OrdenesDeTrabajo.Modelo.OTM_PROVEEDOR.POSEE_REGISTROS_ASOCIADOS), Integer) = 0, True, False)%>"
    ...
    <article data-grupo="Listado" class="areaPaginadorListado">
        <wuc:PaginadorNumerico runat="server" ID="pnRpProveedores" />
    </article>
