<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Listado.master" AutoEventWireup="false" CodeFile="Lst_OT_CategoriasMaterial.aspx.vb" Inherits="Catalogos_Lst_OT_CategoriasMaterial" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphFormulario" Runat="Server">
    ...
    <header>
        <h2>Catálogo de Categorías Materiales</h2>
    </header>
    ...
    <article data-grupo="FiltrosDeBusqueda" class="formulario">
        ...
        <article class="areaBotonesListado">
            <a id="lnkNuevoRegistroFiltro" href="Frm_OT_CategoriasMaterial.aspx?pvn_Operacion=<%=Utilerias.OrdenesDeTrabajo.eOperacion.Agregar%>">
    ...
    <article data-grupo="Listado" class="listado">
        ...
        <article class="areaBotonesListado">
            <a id="lnkNuevoRegistro" href="Frm_OT_CategoriasMaterial.aspx?pvn_Operacion=<%=Utilerias.OrdenesDeTrabajo.eOperacion.Agregar%>">
        ...
        <asp:Repeater runat="server" ID="rpCategoria">
            <HeaderTemplate>
                <table>
                    <tr>
                        <th>
                            <asp:LinkButton runat="server" ID="lnkDescripcion" Text="Descripción" CommandName="<%#Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_CATEGORIA_MATERIALLST.DESCRIPCION%>" CommandArgument="ASC" OnCommand="lnkRpCategoria_Command"></asp:LinkButton>
                        </th>
                        <th>
                            <asp:LinkButton runat="server" ID="lnkEstado" Text="Estado" CommandName="<%#Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_CATEGORIA_MATERIALLST.DESC_ESTADO%>" CommandArgument="ASC" OnCommand="lnkRpCategoria_Command"></asp:LinkButton>
                        </th>
                        <th>&nbsp;</th>
                        <th>&nbsp;</th>
                    </tr>
            ...
            <ItemTemplate>
                <tr class="lineaDelListado">
                    <td><%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_CATEGORIA_MATERIALLST.DESCRIPCION)%></td>
                    <td><%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_CATEGORIA_MATERIALLST.DESC_ESTADO)%></td>
                    <td>
                        <a href="Frm_OT_CategoriasMaterial.aspx?pvn_Operacion=<%#Utilerias.OrdenesDeTrabajo.eOperacion.Modificar%>&pvn_IdCategoria=<%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_CATEGORIA_MATERIALLST.ID_CATEGORIA_MATERIAL)%>">
                    ...
                    <td>
                        <asp:ImageButton runat="server" ID="ibBorrar" AlternateText="Borrar Registro" data-tipo="borrarRegistro" ToolTip="Borrar registro"
                            CommandArgument='<%# String.Format("{0}", Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_CATEGORIA_MATERIALLST.ID_CATEGORIA_MATERIAL))%>'
                            Visible="<%#IIf(CType(Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_CATEGORIA_MATERIALLST.POSEE_REGISTROS_ASOCIADOS), Integer) = 0, True, False)%>"
    ...
    <article data-grupo="Listado" class="areaPaginadorListado">
        <wuc:PaginadorNumerico runat="server" ID="pnRpCategoria" />
    </article>
    ...
    <script type="text/javascript">
        ...
        function mostrarPopupConfirmaDeseaBorrarRegistro(pvo_UniqueIdControl) {
            var vlo_ConfiguracionPopup = {
                titulo: 'Catálogo de Categorías Materiales',
