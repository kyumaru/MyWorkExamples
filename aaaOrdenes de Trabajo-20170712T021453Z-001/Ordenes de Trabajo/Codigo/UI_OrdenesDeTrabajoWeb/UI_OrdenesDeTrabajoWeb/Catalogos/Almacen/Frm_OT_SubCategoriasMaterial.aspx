<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Formulario.master" AutoEventWireup="false" CodeFile="Frm_OT_SubCategoriasMaterial.aspx.vb" Inherits="Catalogos_Frm_OT_SubCategoriasMaterial" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphFormulario" runat="Server">
    ...
    <article class="tituloSeccion">
        Mantenimiento de Sub Categorías Material
    </article>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            configurarLongitudMaximaTexto('#<%=Me.txtDescripcion.ClientID%>',<%=Utilerias.OrdenesDeTrabajo.Modelo.OTM_SUBCATEGORIA_MATERIAL.DESCRIPCION_BD_TAMANO%>);
        ...
        function regresarAlListado() {
            window.location = 'Lst_OT_SubCategoriasMaterial.aspx';
        };

        function mostrarPopupRegistroExitoso() {
            var vlo_ConfiguracionPopup = {
                titulo: 'Catálogo Sub Categorías Material',
                mensaje: 'Se ha registrado la información.. <br/><strong>¿Desea registrar otra subcategoría?</strong>',
                        ...
                        [
                            {
                                idControl: "btnSi",
                                textoBoton: "Sí",
                                onClick: function () { window.location = 'Frm_OT_SubCategoriasMaterial.aspx?pvn_Operacion=<%=Utilerias.OrdenesDeTrabajo.eOperacion.Agregar%>'; }
                            },
                        {
                            idControl: "btnNo",
                            textoBoton: "No",
