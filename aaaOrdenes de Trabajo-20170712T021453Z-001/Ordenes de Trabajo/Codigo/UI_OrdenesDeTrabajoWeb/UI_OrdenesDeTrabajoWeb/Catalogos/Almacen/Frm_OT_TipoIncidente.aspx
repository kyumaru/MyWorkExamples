<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Formulario.master" AutoEventWireup="false" CodeFile="Frm_OT_TipoIncidente.aspx.vb" Inherits="Catalogos_Almacen_Frm_OT_TipoIncidente" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphFormulario" Runat="Server">
    ...
    <article class="tituloSeccion">
        Mantenimiento de Incidentes de Almacén
    </article>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            configurarLongitudMaximaTexto('#<%=Me.txtDescripcion.ClientID%>',<%=Utilerias.OrdenesDeTrabajo.Modelo.OTM_TIPO_INCIDENTE.DESCRIPCION_BD_TAMANO%>);
        ...
        function regresarAlListado() {
            window.location = 'Lst_OT_TipoIncidente.aspx';
        };

        function mostrarPopupRegistroExitoso() {
            var vlo_ConfiguracionPopup = {
                titulo: 'Catálogo de Incidentes de Almacén',
                        ...
                        [
                            {
                                idControl: "btnSi",
                                textoBoton: "Sí",
                                onClick: function () { window.location = 'Frm_OT_TipoIncidente.aspx?pvn_Operacion=<%=Utilerias.OrdenesDeTrabajo.eOperacion.Agregar%>'; }
                            },
                        {
                            idControl: "btnNo",
                            textoBoton: "No",
