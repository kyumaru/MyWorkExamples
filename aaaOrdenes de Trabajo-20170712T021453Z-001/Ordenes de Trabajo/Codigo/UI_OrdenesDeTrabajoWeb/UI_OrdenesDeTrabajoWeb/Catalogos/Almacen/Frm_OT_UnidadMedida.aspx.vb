...
Partial Class Catalogos_Frm_OT_UnidadMedida
...
#Region "Propiedades"
    ...
    ''' <creationDate>23/05/2016</creationDate>
    ''' <changeLog></changeLog>
    Private Property UnidadMedida As Wsr_OT_Catalogos.EntOtmUnidadMedida
        Get
...
#Region "Métodos"
    ...
    Private Sub InicializarFormulario()
        ...
        Select Case Me.Operacion
            ...
            Case Is = eOperacion.Modificar
                ...
                Try
                    CargarUnidadMedida(WebUtils.LeerParametro(Of Integer)("pvn_IdUnidadMedida"))
                Catch ex As Exception
                    Throw
                End Try
        End Select
    ...
    ''' </summary>
    ''' <param name="pvn_IdUnidadMedida">identificacion del registro</param>
    ''' <remarks></remarks>
    ''' <author>Carlos Gómez Ondoy</author>
    ''' <creationDate>23/05/2016</creationDate>
    ''' <changeLog></changeLog>
    Private Sub CargarUnidadMedida(pvn_IdUnidadMedida As Integer)
        ...
        Try
            Me.UnidadMedida = vlo_Ws_OT_Catalogos.OTM_UNIDAD_MEDIDA_ObtenerRegistro(
                ConfigurationManager.AppSettings(ConstantesInternas.APP_KEY_USUARIO_APLICACION_WEB),
                ConfigurationManager.AppSettings(ConstantesInternas.APP_KEY_CLAVE_APLICACION_WEB),
                String.Format("{0} = {1}", Modelo.OTM_UNIDAD_MEDIDA.ID_UNIDAD_MEDIDA, pvn_IdUnidadMedida))
        ...
        If Me.UnidadMedida.Existe Then
            With Me.UnidadMedida
                Me.txtDescripcion.Text = .Descripcion
                Me.txtAcronimo.Text = .Acronimo
...
#Region "Funciones"
    ...
    ''' <creationDate>23/05/2016</creationDate>
    ''' <changeLog></changeLog>
    Private Function ConstruirRegistro() As Wsr_OT_Catalogos.EntOtmUnidadMedida
        ...
        Else
            vlo_EntOtmUnidadMedida = Me.UnidadMedida
        End If

        With vlo_EntOtmUnidadMedida
            .Descripcion = Me.txtDescripcion.Text
            .Acronimo = Me.txtAcronimo.Text
            .Estado = Me.ddlEstado.SelectedValue
            .Usuario = Me.Usuario.UserName
        End With

        Return vlo_EntOtmUnidadMedida
    End Function
    ...
    Private Function Agregar() As Boolean
        ...
        vlo_EntOtmUnidadMedida = ConstruirRegistro()

        Try
            Return vlo_Ws_OT_Catalogos.OTM_UNIDAD_MEDIDA_InsertarRegistro(
                ConfigurationManager.AppSettings(ConstantesInternas.APP_KEY_USUARIO_APLICACION_WEB),
                ConfigurationManager.AppSettings(ConstantesInternas.APP_KEY_CLAVE_APLICACION_WEB),
    ...
    Private Function Modificar() As Boolean
        ...
        Try
            Return vlo_Ws_OT_Catalogos.OTM_UNIDAD_MEDIDA_ModificarRegistro(
                ConfigurationManager.AppSettings(ConstantesInternas.APP_KEY_USUARIO_APLICACION_WEB),
                ConfigurationManager.AppSettings(ConstantesInternas.APP_KEY_CLAVE_APLICACION_WEB),
                vlo_EntOtmUnidadMedida) > 0
        Catch ex As Exception
