<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Listado.master" AutoEventWireup="false" CodeFile="Lst_OT_TipoIncidente.aspx.vb" Inherits="Catalogos_Almacen_Lst_OT_TipoIncidente" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphFormulario" Runat="Server">
    ...
    <header>
        <h2>Catálogo de Incidentes en Almacén</h2>
    </header>
    ...
    <article data-grupo="FiltrosDeBusqueda" class="formulario">
        ...
        <article class="areaBotonesListado">
            <a id="lnkNuevoRegistroFiltro" href="Frm_OT_TipoIncidente.aspx?pvn_Operacion=<%=Utilerias.OrdenesDeTrabajo.eOperacion.Agregar%>">
    ...
    <article data-grupo="Listado" class="listado">
        ...
        <article class="areaBotonesListado">
            <a id="lnkNuevoRegistro" href="Frm_OT_TipoIncidente.aspx?pvn_Operacion=<%=Utilerias.OrdenesDeTrabajo.eOperacion.Agregar%>">
        ...
        <asp:Repeater runat="server" ID="rpIncidentes">
            <HeaderTemplate>
                <table>
                    <tr>
                        <th>
                            <asp:LinkButton runat="server" ID="lnkDescripcion" Text="Descripción" CommandName="<%#Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_TIPO_INCIDENTELST.DESCRIPCION%>" CommandArgument="ASC" OnCommand="lnkRpIncidentes_Command"></asp:LinkButton>
                        </th>
                        <th>
                            <asp:LinkButton runat="server" ID="lnkEstado" Text="Estado" CommandName="<%#Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_TIPO_INCIDENTELST.DESC_ESTADO%>" CommandArgument="ASC" OnCommand="lnkRpIncidentes_Command"></asp:LinkButton>
                        </th>
                        <th>&nbsp;</th>
                        <th>&nbsp;</th>
                    </tr>
            ...
            <ItemTemplate>
                <tr class="lineaDelListado">
                    <td><%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_TIPO_INCIDENTELST.DESCRIPCION)%></td>
                    <td><%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_TIPO_INCIDENTELST.DESC_ESTADO)%></td>
                    <td>
                        <a href="Frm_OT_TipoIncidente.aspx?pvn_Operacion=<%#Utilerias.OrdenesDeTrabajo.eOperacion.Modificar%>&pvn_IdTipoIncidente=<%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_TIPO_INCIDENTELST.ID_TIPO_INCIDENTE)%>">
                    ...
                    <td>
                        <asp:ImageButton runat="server" ID="ibBorrar" AlternateText="Borrar Registro" data-tipo="borrarRegistro" ToolTip="Borrar registro"
                            CommandArgument='<%# String.Format("{0}", Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_TIPO_INCIDENTELST.ID_TIPO_INCIDENTE))%>'
                            Visible="<%#IIf(CType(Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_TIPO_INCIDENTELST.POSEE_REGISTROS_ASOCIADOS), Integer) = 0, True, False)%>"
    ...
    <script type="text/javascript">
        ...
        function mostrarPopupConfirmaDeseaBorrarRegistro(pvo_UniqueIdControl) {
            var vlo_ConfiguracionPopup = {
                titulo: 'Catálogo de Incidentes en Almacén',
