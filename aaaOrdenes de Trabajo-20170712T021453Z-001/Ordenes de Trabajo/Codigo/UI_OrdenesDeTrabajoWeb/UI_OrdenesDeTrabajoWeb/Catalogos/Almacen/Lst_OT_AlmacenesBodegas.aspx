<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Listado.master" AutoEventWireup="false" CodeFile="Lst_OT_AlmacenesBodegas.aspx.vb" Inherits="Catalogos_Lst_OT_AlmacenesBodegas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphFormulario" Runat="Server">
    ...
    <header>
        <h2>Catálogo de Almacenes y Bodegas</h2>
    </header>
    ...
    <article data-grupo="FiltrosDeBusqueda" class="formulario">
        ...
        <article class="areaBotonesListado">
            <a id="lnkNuevoRegistroFiltro" href="Frm_OT_AlmacenesBodegas.aspx?pvn_Operacion=<%=Utilerias.OrdenesDeTrabajo.eOperacion.Agregar%>">
    ...
    <article data-grupo="Listado" class="listado">
        ...
        <article class="areaBotonesListado">
            <a id="lnkNuevoRegistro" href="Frm_OT_AlmacenesBodegas.aspx?pvn_Operacion=<%=Utilerias.OrdenesDeTrabajo.eOperacion.Agregar%>">
        ...
        <asp:Repeater runat="server" ID="rpAlmacenMaterial">
            <HeaderTemplate>
                <table>
                    <tr>
                        <th>
                            <asp:LinkButton runat="server" ID="lnkDescripcion" Text="Descripción" CommandName="<%#Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_ALMACEN_BODEGALST.DESCRIPCION%>" CommandArgument="ASC" OnCommand="lnkRpAlmacenMaterial_Command"></asp:LinkButton>
                        </th>
                         <th>
                            <asp:LinkButton runat="server" ID="lnkDescTipo" Text="Tipo" CommandName="<%#Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_ALMACEN_BODEGALST.DESC_TIPO%>" CommandArgument="ASC" OnCommand="lnkRpAlmacenMaterial_Command"></asp:LinkButton>
                        </th>  
                        <th>
                            <asp:LinkButton runat="server" ID="lnkEstado" Text="Estado" CommandName="<%#Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_ALMACEN_BODEGALST.DESC_ESTADO%>" CommandArgument="ASC" OnCommand="lnkRpAlmacenMaterial_Command"></asp:LinkButton>
                        </th>                        
                        <th>&nbsp;</th>
                        <th>&nbsp;</th>
                    </tr>
            ...
            <ItemTemplate>
                <tr class="lineaDelListado">
                    <td><%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_ALMACEN_BODEGALST.DESCRIPCION)%></td>
                    <td>
                        <%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_ALMACEN_BODEGALST.DESC_TIPO)%>
                        &nbsp;&nbsp;
                        <asp:Image runat="server" ID="imgTooltipEspecificoPorControl" data-tipo="tooltip"
                             Visible="<%#IIf(CType(Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_ALMACEN_BODEGALST.ID_SECTOR_TALLER), Integer) = 0, False, True)%>"
                            title="<%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_ALMACEN_BODEGALST.DESC_SECTOR_TALLER)%>"
                    ...
                    <td><%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_ALMACEN_BODEGALST.DESC_ESTADO)%></td>
                    <td>
                        <a href="Frm_OT_AlmacenesBodegas.aspx?pvn_Operacion=<%#Utilerias.OrdenesDeTrabajo.eOperacion.Modificar%>&pvn_IdAlmacenBodega=<%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_ALMACEN_BODEGALST.ID_ALMACEN_BODEGA)%>">
                    ...
                    <td>
                        <asp:ImageButton runat="server" ID="ibBorrar" AlternateText="Borrar Registro" data-tipo="borrarRegistro" ToolTip="Borrar registro"
                            CommandArgument='<%# String.Format("{0}", Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_ALMACEN_BODEGALST.ID_ALMACEN_BODEGA))%>'
                            Visible="<%#IIf(CType(Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_ALMACEN_BODEGALST.POSEE_REGISTROS_ASOCIADOS), Integer) = 0, True, False)%>"
    ...
    <article data-grupo="Listado" class="areaPaginadorListado">
        <wuc:PaginadorNumerico runat="server" ID="pnRpAlmacenMaterial" />
    </article>
