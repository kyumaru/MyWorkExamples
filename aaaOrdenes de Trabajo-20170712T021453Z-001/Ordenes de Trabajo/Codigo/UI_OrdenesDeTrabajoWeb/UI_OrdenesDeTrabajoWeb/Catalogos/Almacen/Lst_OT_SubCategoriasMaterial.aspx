<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Listado.master" AutoEventWireup="false" CodeFile="Lst_OT_SubCategoriasMaterial.aspx.vb" Inherits="Catalogos_Lst_OT_SubCategoriasMaterial" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphFormulario" runat="Server">
    ...
    <header>
        <h2>Catálogo de Sub Categorías Material</h2>
    </header>
    ...
    <article data-grupo="FiltrosDeBusqueda" class="formulario">
        ...
        <article class="areaBotonesListado">
            <a id="lnkNuevoRegistroFiltro" href="Frm_OT_SubCategoriasMaterial.aspx?pvn_Operacion=<%=Utilerias.OrdenesDeTrabajo.eOperacion.Agregar%>">
    ...
    <article data-grupo="Listado" class="tituloSeccion">
        Sub Categorías Material
    </article>

    <article data-grupo="Listado" class="listado">

        <article class="areaBotonesListado">
            <a id="lnkNuevoRegistro" href="Frm_OT_SubCategoriasMaterial.aspx?pvn_Operacion=<%=Utilerias.OrdenesDeTrabajo.eOperacion.Agregar%>">
        ...
        <asp:Repeater runat="server" ID="rpSubCategoria">
            <HeaderTemplate>
                <table>
                    <tr>
                        <th>
                            <asp:LinkButton runat="server" ID="lnkDescripcion" Text="Descripción" CommandName="<%#Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_SUBCATEGORIA_MATERIALLST.DESCRIPCION%>" CommandArgument="ASC" OnCommand="lnkRpSubCategoria_Command"></asp:LinkButton>
                        </th>
                        <th>
                            <asp:LinkButton runat="server" ID="lnkEstado" Text="Estado" CommandName="<%#Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_SUBCATEGORIA_MATERIALLST.DESC_ESTADO%>" CommandArgument="ASC" OnCommand="lnkRpSubCategoria_Command"></asp:LinkButton>
                        </th>
                        <th>&nbsp;</th>
                        <th>&nbsp;</th>
                    </tr>
            ...
            <ItemTemplate>
                <tr class="lineaDelListado">
                    <td><%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_SUBCATEGORIA_MATERIALLST.DESCRIPCION)%></td>
                    <td><%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_SUBCATEGORIA_MATERIALLST.DESC_ESTADO)%></td>
                    <td>
                        <a href="Frm_OT_SubCategoriasMaterial.aspx?pvn_Operacion=<%#Utilerias.OrdenesDeTrabajo.eOperacion.Modificar%>&pvn_IdSubCategoria=<%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_SUBCATEGORIA_MATERIALLST.ID_SUBCATEGORIA_MATERIAL)%>">
                    ...
                    <td>
                        <asp:ImageButton runat="server" ID="ibBorrar" AlternateText="Borrar Registro" data-tipo="borrarRegistro" ToolTip="Borrar registro"
                            CommandArgument='<%# String.Format("{0}", Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_SUBCATEGORIA_MATERIALLST.ID_SUBCATEGORIA_MATERIAL))%>'
                            Visible="<%#IIf(CType(Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_SUBCATEGORIA_MATERIALLST.POSEE_REGISTROS_ASOCIADOS), Integer) = 0, True, False)%>"
    ...
    <article data-grupo="Listado" class="areaPaginadorListado">
        <wuc:PaginadorNumerico runat="server" ID="pnRpSubCategoria" />
    </article>
    ...
    <script type="text/javascript">
        ...
        function mostrarPopupConfirmaDeseaBorrarRegistro(pvo_UniqueIdControl) {
            var vlo_ConfiguracionPopup = {
                titulo: 'Catálogo de Sub Categorías Material',
