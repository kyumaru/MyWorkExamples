<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Listado.master" AutoEventWireup="false" CodeFile="Lst_OT_RubrosTipoObra.aspx.vb" Inherits="Catalogos_Lst_OT_RubrosTipoObra" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphFormulario" runat="Server">
    ...
    <header>
        <h2>Catálogo de Tipos de Obra</h2>
    </header>
    ...
    <article data-grupo="FiltrosDeBusqueda" class="formulario">
        ...
        <article class="areaBotonesListado">
            <a id="lnkNuevoRegistroFiltro" href="Frm_OT_RubrosTipoObra.aspx?pvn_Operacion=<%=Utilerias.OrdenesDeTrabajo.eOperacion.Agregar%>">
        ...
        <table>
            <tr>
                <th>Descripción</th>
                <td>
                    <asp:TextBox runat="server" ID="txtDescTrabajo" data-tipocontrol="texto" Width="59%" MaxLength="4000"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th>Estado</th>
    ...
    <article data-grupo="Listado" class="listado">
        ...
        <article class="areaBotonesListado">
            <a id="lnkNuevoRegistro" href="Frm_OT_RubrosTipoObra.aspx?pvn_Operacion=<%=Utilerias.OrdenesDeTrabajo.eOperacion.Agregar%>">
        ...
        <asp:Repeater runat="server" ID="rpTipoObra">
            <HeaderTemplate>
                <table>
                    <tr>
                        <th>
                            <asp:LinkButton runat="server" ID="lnkDescripcion" Text="Descripción" CommandName="<%#Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_TIPO_OBRALST.DESCRIPCION%>" CommandArgument="ASC" OnCommand="lnkRpTipoObra_Command"></asp:LinkButton>
                        </th>
                        <th>
                            <asp:LinkButton runat="server" ID="lnkEstado" Text="Estado" CommandName="<%#Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_TIPO_OBRALST.DESC_ESTADO%>" CommandArgument="ASC" OnCommand="lnkRpTipoObra_Command"></asp:LinkButton>
                        </th>
                        <th>&nbsp;</th>
                        <th>&nbsp;</th>
                    </tr>
            ...
            <ItemTemplate>
                <tr class="lineaDelListado">
                    <td><%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_TIPO_OBRALST.DESCRIPCION)%></td>
                    <td><%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_TIPO_OBRALST.DESC_ESTADO)%></td>
                     <td>
                        <a href="Frm_OT_RubrosTipoObra.aspx?pvn_Operacion=<%#Utilerias.OrdenesDeTrabajo.eOperacion.Modificar%>&pvn_IdTipoObra=<%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_TIPO_OBRALST.ID_TIPO_OBRA)%>">
                    ...
                    <td>
                        <asp:ImageButton runat="server" ID="ibBorrar" AlternateText="Borrar Registro" data-tipo="borrarRegistro" ToolTip="Borrar registro"
                            CommandArgument='<%# String.Format("{0}", Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTM_TIPO_OBRALST.ID_TIPO_OBRA))%>'
    ...
    <article data-grupo="Listado" class="areaPaginadorListado">
        <wuc:PaginadorNumerico runat="server" ID="pnRpTipoObra" />
    </article>
