<%@ Page Title="Catálogo de Espacios" Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage/Mp_Formulario.master" CodeFile="Frm_OT_Espacios.aspx.vb" Inherits="Catalogos_Frm_OT_Espacios" %>
...
<asp:Content id="Content1" runat="server" ContentPlaceHolderID="cphFormulario">
    ...
    <script type="text/javascript">
        ...
        function regresarAlListado() {
            window.location = 'Lst_OT_Espacios.aspx';
        }
        ...
        function mostrarPopupRegistroExitoso() {
            var vlo_ConfiguracionPopup = {
                ...
                mensaje: 'Se ha registrado la información del espacio.<br /><strong>¿Desea registrar otro espacio?</strong>',
                    ...
                    [
                        {
                            idControl: "btnSi",
                            textoBoton: "Sí",
                            onClick: function () { window.location = 'Frm_OT_Espacios.aspx?pvn_Operacion=<%=Utilerias.OrdenesDeTrabajo.eOperacion.Agregar%>'; }
                        },
                        {
                            idControl: "btnNo",
                            textoBoton: "No",
