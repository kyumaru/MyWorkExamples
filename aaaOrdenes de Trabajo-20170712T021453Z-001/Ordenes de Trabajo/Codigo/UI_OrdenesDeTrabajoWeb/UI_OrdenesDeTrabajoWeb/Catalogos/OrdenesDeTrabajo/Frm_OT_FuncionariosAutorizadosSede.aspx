<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Formulario.master" AutoEventWireup="false" CodeFile="Frm_OT_FuncionariosAutorizadosSede.aspx.vb" Inherits="Catalogos_Frm_OT_FuncionariosAutorizadosSede" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphFormulario" Runat="Server">
    ...
    <article class="tituloSeccion">
        Mantenimiento de Funcionarios Autorizados por Sede
    </article>
    ...
    <script type="text/javascript">
        ...
        function regresarAlListado() {
            window.location = 'Lst_OT_FuncionariosAutorizadosSede.aspx';
        };
        ...
        function mostrarPopupRegistroExitoso() {
            var vlo_ConfiguracionPopup = {
                ...
                mensaje: 'Se ha registrado la información.. <br/><strong>¿Desea registrar otra autorizado?</strong>',
                        ...
                        [
                            {
                                idControl: "btnSi",
                                textoBoton: "Sí",
                                onClick: function () { window.location = 'Frm_OT_FuncionariosAutorizadosSede.aspx?pvn_Operacion=<%=Utilerias.OrdenesDeTrabajo.eOperacion.Agregar%>'; }
                            },
                        {
                            idControl: "btnNo",
                            textoBoton: "No",
        ...
        function mostrarAlertaActualizacionExitosa() {
            ...
            mostrarAlerta(
                '#arAlertasDelFormulario',
                {
                    mensaje: 'Se ha actualizado la información del Autorizado.',
                    tipo: "exito",
                    transparencia: 0.9,
                    posicion: 'center',
                    onClosed: function () { regresarAlListado(); }
        ...
        function mostrarAlertaLlaveIncorrecta() {
            ...
            mostrarAlerta(
                '#arAlertasDelFormulario',
                {
                    mensaje: 'El identificador provisto no pertenece a ningun autorizado del sistema.',
                    tipo: "peligro",
                    transparencia: 0.9,
                    posicion: 'center',
                    onClosed: function () { regresarAlListado(); }
