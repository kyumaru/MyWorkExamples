...
Partial Class OrdenesDeTrabajo_Lst_OT_VistoBuenoJefaturaSeccionMantenimiento
...
#Region "Eventos"
    ...
    Protected Sub lnkTrazabilidad_Command(sender As Object, e As CommandEventArgs)
        ...
        Try
            ...
            Me.Session.Add("pvc_PantallaRetorno", "OrdenesDeTrabajo/Lst_OT_VistoBuenoJefaturaSeccionMantenimiento.aspx")
    ...
    ''' <summary>
    ''' Redirecciona al formulario para validar el oficio de la disponibilidad presupuestaria, 
    ''' informe de valoración presupuestaria
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    ...
    ''' <changeLog></changeLog>
    Protected Sub imgValidarOficioPresupuesto_Click(sender As Object, e As ImageClickEventArgs)
        Dim vlc_Llave As String()
        ...
        Catch ex As Exception
            ...
            vlo_ControlDeErrores.RegistrarExcepcion(ex, String.Empty)
        End Try
        Response.Redirect("Frm_OT_ValidarOficio.aspx", False)
    End Sub
...
#Region "Funciones"
    ...
    Private Function ObtenerCondicionBusqueda() As String
        ...
        If String.IsNullOrWhiteSpace(vlc_Condicion) Then
            vlc_Condicion = String.Format("({0} = '{1}' OR {0} = '{2}')", Modelo.V_OTT_ORDEN_TRABAJOLST.ESTADO_ORDEN_TRABAJO, EstadoOrden.EVALUACION_PRELIMINAR_REVISION_JEFATURA, EstadoOrden.EVALUADA)
        Else
            vlc_Condicion = String.Format("{0} AND ({1} = '{2}' OR {1} = '{3}' OR {1} = '{4}')", vlc_Condicion, Modelo.V_OTT_ORDEN_TRABAJOLST.ESTADO_ORDEN_TRABAJO, EstadoOrden.EVALUACION_PRELIMINAR_REVISION_JEFATURA, EstadoOrden.EVALUADA, EstadoOrden.PRESUPUESTO_APROBADO_SOLICITANTE)
        End If
