...
Partial Class OrdenesDeTrabajo_Frm_OT_OrdenTrabajoHija
        ...
        If Page.IsValid Then
            Try
                ...
                If (Me.ddlCategoria.SelectedValue <> Me.OrdenTrabajo.IdCategoriaServicio) Or (Me.ddlActividad.SelectedValue <> Me.OrdenTrabajo.IdActividad) Then
                    If Agregar() Then
                        WebUtils.RegistrarScript(Me, "MensajePopup", "MensajePopup('Se ha registrado la información correctamente','Lst_OT_GestionOrdenTrabajoCordinadorSectorTaller.aspx');")
                    Else
