<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Formulario.master" AutoEventWireup="false" CodeFile="Frm_OT_OrdenesTrabajoDisenio.aspx.vb" Inherits="OrdenesDeTrabajo_Frm_OT_OrdenesTrabajoDisenio" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphFormulario" runat="Server">
    ...
    <article class="tituloSeccion">
        Mantenimiento de la Orden de Trabajo de Diseño
    </article>
    ...
    <article class="formulario" id="formularioTotal" runat="server">
        <table>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox Enabled="false" Width="59%" runat="server" ID="txtNumeroOrden" data-tipocontrol="texto" MaxLength="10"></asp:TextBox>
                </td>
            </tr>
    ...
    <script type="text/javascript">
        ...
        function mostrarPopupRegistroExitoso() {
            ...
            var vlo_ConfiguracionPopup = {
                titulo: 'Catálogo de Ordenes de Trabajo de Diseño',
                        ...
                        [
                            {
                                idControl: "btnSi",
                                textoBoton: "Sí",
                                onClick: function () { window.location = 'Frm_OT_OrdenesTrabajoDisenio.aspx?pvn_Operacion=<%=Utilerias.OrdenesDeTrabajo.eOperacion.Agregar%>'; }
                            },
                        {
                            idControl: "btnNo",
                            textoBoton: "No",
