...
Partial Class OrdenesDeTrabajo_Lst_OT_VistoBuenoAnalisisViabilidadTecnica
...
#Region "Eventos"
    ...
    ''' <changeLog></changeLog>
    Protected Sub ibRevisarOrden_Click(sender As Object, e As ImageClickEventArgs)
        ...
        Catch ex As Exception
            ...
            vlo_ControlDeErrores.RegistrarExcepcion(ex, String.Empty)
        End Try
        Response.Redirect(String.Format("Frm_OT_VistoBuenoAnalisisViabilidadTecnica.aspx"), False)
    End Sub
    ...
    Protected Sub lnkTrazabilidad_Command(sender As Object, e As CommandEventArgs)
        ...
        Try
            ...
            Me.Session.Add("pvc_PantallaRetorno", "OrdenesDeTrabajo/Lst_OT_VistoBuenoAnalisisViabilidadTecnica.aspx")
...
#Region "Funciones"
    ...
    Private Function ObtenerCondicionBusqueda() As String
        ...
        If String.IsNullOrWhiteSpace(vlc_Condicion) Then
            vlc_Condicion = String.Format("{0} = '{1}' OR {0} = '{2}'", Modelo.V_OTT_ORDEN_TRABAJOLST.ESTADO_ORDEN_TRABAJO, EstadoOrden.EVALUACION_PRELIMINAR_REVISION_COORD, EstadoOrden.EVALUACION_PRELIMINAR_DEVUELTA_JEFATURA)
        Else
            vlc_Condicion = String.Format("{0} AND ({1} = '{2}' OR {1} = '{3}')", vlc_Condicion, Modelo.V_OTT_ORDEN_TRABAJOLST.ESTADO_ORDEN_TRABAJO, EstadoOrden.EVALUACION_PRELIMINAR_REVISION_COORD, EstadoOrden.EVALUACION_PRELIMINAR_DEVUELTA_JEFATURA)
        End If
