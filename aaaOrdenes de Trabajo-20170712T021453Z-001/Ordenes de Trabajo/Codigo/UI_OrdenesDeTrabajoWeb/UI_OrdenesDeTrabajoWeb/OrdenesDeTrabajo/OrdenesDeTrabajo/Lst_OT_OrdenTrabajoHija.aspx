<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Listado.master" AutoEventWireup="false" CodeFile="Lst_OT_OrdenTrabajoHija.aspx.vb" Inherits="OrdenesDeTrabajo_Lst_OT_OrdenTrabajoHija" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphFormulario" runat="Server">
    ...
    <article data-grupo="Listado" class="listado">
        <article class="areaBotonesListado">
            <a id="lnkRegresar" href="Lst_OT_GestionOrdenTrabajoCordinadorSectorTaller.aspx">
                <img id="imgRegresar" data-tipo="RegresarOT" title="Regresar" alt="Regresar" src="" />
            </a>
            <a id="lnkNuevoRegistro" href="Frm_OT_OrdenTrabajoHija.aspx">
