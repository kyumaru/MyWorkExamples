<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Listado.master" AutoEventWireup="false" CodeFile="Lst_OT_AprobacionPresupuestoJefatura.aspx.vb" Inherits="OrdenesDeTrabajo_Lst_OT_AprobacionPresupuestoJefatura" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphFormulario" runat="Server">
    ...
    <header>
        <h2>Aprobación de Infome de valoración presupuestaria para la realización de la obra por parte de la Jefatura</h2>
    </header>
