<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Listado.master" AutoEventWireup="false" CodeFile="Lst_OT_VistoBuenoAnalisisViabilidadTecnica.aspx.vb" Inherits="OrdenesDeTrabajo_Lst_OT_VistoBuenoAnalisisViabilidadTecnica" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphFormulario" runat="Server">
    ...
    <header>
        <h2>Revisión de Análisis de Viabilidad Técnica</h2>
    </header>
    ...
    <article data-grupo="FiltrosDeBusqueda" class="formulario">
        <table>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox Width="59%" runat="server" ID="txtFechaSolicitud"></asp:TextBox>
    ...
    <article data-grupo="Listado" class="tituloSeccion">
        Listado para Revisión de Análisis de Viabilidad Técnica
    </article>
        ...
        <asp:Repeater runat="server" ID="rpOrdenTrabajo">
            ...
            <ItemTemplate>
               ...
               <%--         <a href="Frm_OT_VistoBuenoAnalisisViabilidadTecnica.aspx?pvn_IdUbicacion=<%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTT_ORDEN_TRABAJOLST.ID_UBICACION)%>&pvc_IdOrdenTrabajo=<%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTT_ORDEN_TRABAJOLST.ID_ORDEN_TRABAJO)%>&pvn_Anno=<%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTT_ORDEN_TRABAJOLST.ANNO)%>">
                         ...
                         <asp:ImageButton runat="server" ID="imgRevisarOrden" AlternateText="Revisar la Orden" ToolTip="Revisar la Orden"
