...
Partial Class OrdenesDeTrabajo_Frm_OT_OrdenesTrabajoDisenio
...
#Region "Propiedades"
    ...
    ''' <summary>
    ''' propiedad para el tamaño del archivo
    ''' </summary>
    ''' <value></value>
    ''' <returns></returns>
    ''' <remarks></remarks>
    ...
    ''' <summary>
    ''' propiedad que guarda el evento que es gerando
    ''' </summary>
    ''' <value></value>
    ''' <returns></returns>
    ''' <remarks></remarks>
...
#Region "Eventos"
                    ...
                    Select Case (Me.Operacion)
                        Case Is = eOperacion.Agregar
                            If Agregar() Then
                                ...
                                WebUtils.RegistrarScript(Me.Page, "MostrarPopupRegistroExitoso", "mostrarAlertaWizard();")
                            Else
    ...
    ''' <summary>
    ''' evento que se ejecuta al dar click sobre el boton de limpiar
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    ...
    ''' <summary>
    ''' cambio del focus del campo de texto para solicitante
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    ''' <remarks></remarks>
...
#Region "Métodos"
    ...
    Private Sub InicializarFormulario()
        ...
        CargarCategoriaServicio(String.Format("{0} LIKE '%{1}%' AND {2} = 1", Modelo.OTM_CATEGORIA_SERVICIO.ESTADO, Estado.ACTIVO, Modelo.OTM_CATEGORIA_SERVICIO.REQUIERE_FICHA_TECNICA))
    ...
    ''' <summary>
    ''' data set de doicumentos adjuntos a la orden de trabajo
    ''' </summary>
    ''' <remarks></remarks>
    ''' <author>Carlos Gómez Ondoy</author>
    ''' <creationDate>25/01/2016</creationDate>
    ...
    Private Sub CargarLugarTrabajo(pvc_Condicion As String)
        ...
        Try
            ...
            vlo_DsDatos = vlo_Ws_OT_Ws_OT_Catalogos.OTM_LUGAR_TRABAJO_ListarRegistrosLista(
                                ...
                                ConfigurationManager.AppSettings(ConstantesInternas.APP_KEY_CLAVE_APLICACION_WEB),
                                pvc_Condicion,
                                String.Format("{0} ASC", Modelo.V_OTM_LUGAR_TRABAJOLST.NOMBRE),
                                False,
                                0,
                                0)
...
#Region "Funciones"
    ...
    Private Function ConstruirRegistro() As Wsr_OT_OrdenesDeTrabajo.EntOttOrdenTrabajo
        ...
        With vlo_EntOttOrdenTrabajo
            .TipoOrdenTrabajo = Utilerias.OrdenesDeTrabajo.TipoOrden.ORDINARIA
            .EstadoOrdenTrabajo = EstadoOrden.PENDIENTE_DE_ENVIO
            .Parentesco = "MAD"
