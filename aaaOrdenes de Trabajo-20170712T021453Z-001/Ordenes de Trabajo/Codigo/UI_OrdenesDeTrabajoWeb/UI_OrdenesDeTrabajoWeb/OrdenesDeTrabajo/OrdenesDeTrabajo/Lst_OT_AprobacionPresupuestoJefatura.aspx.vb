...
Partial Class OrdenesDeTrabajo_Lst_OT_AprobacionPresupuestoJefatura
...
#Region "Eventos"
    ...
    Protected Sub lnkTrazabilidad_Command(sender As Object, e As CommandEventArgs)
        ...
        Try
            ...
            Me.Session.Add("pvc_PantallaRetorno", "Lst_OT_AprobacionPresupuestoJefatura.aspx")
...
#Region "Funciones"
    ...
    Private Function ObtenerCondicionBusqueda() As String
        ...
        If String.IsNullOrWhiteSpace(vlc_Condicion) Then
            vlc_Condicion = String.Format("{0} = '{1}'", Modelo.V_OTT_ORDEN_TRABAJOLST.ESTADO_ORDEN_TRABAJO, EstadoOrden.PRESUPUESTO_REVISION_JEFATURA)
        Else
            vlc_Condicion = String.Format("{0} AND {1} = '{2}'", vlc_Condicion, Modelo.V_OTT_ORDEN_TRABAJOLST.ESTADO_ORDEN_TRABAJO, EstadoOrden.PRESUPUESTO_REVISION_JEFATURA)
        End If
