<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Formulario.master" AutoEventWireup="false" CodeFile="Frm_OT_OrdenesTrabajoRecepcion.aspx.vb" Inherits="OrdenesDeTrabajo_Frm_OT_OrdenesTrabajoRecepcion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphFormulario" runat="Server">
    ...
    <article class="tituloSeccion">
        Mantenimiento de la Orden de Trabajo Incluida en Recepción
    </article>

    <article class="formulario" id="formularioTotal1" runat="server">
        <table>
            <tr>
            ...
            <tr>
                <th>Lugar Exacto</th>
                <td>
                    <asp:TextBox runat="server" ID="txtLugarExacto" data-tipocontrol="texto" TextMode="MultiLine" Rows="4" Columns="40"></asp:TextBox>
                    <img class="tooltip" src="<%= AdministradorRecursos.ObtenerRutaImagen(AdministradorRecursos.TAMANO_IMAGEN.x16, AdministradorRecursos.COLOR_IMAGEN.COLOR, "Icono_Ayuda.png")%>"
            ...
            <tr>
                ...
                <td>
                    <asp:UpdatePanel runat="server" ID="upTxtDescripcionActividad" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:TextBox Width="59%" runat="server" ID="txtDescripcionActividad" TextMode="MultiLine" Rows="4" Enabled="false"></asp:TextBox>
                        </ContentTemplate>
                        <Triggers>
    ...
    <article class="formulario sinBorde" id="formularioTotal2" runat="server">
        <table>
            <tr>
                <th>No. Orden de Trabajo</th>
                <td>
                    <asp:UpdatePanel runat="server" ID="upTxtNumeroOrden" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:TextBox Width="59%" runat="server" ID="txtNumeroOrden" data-tipocontrol="texto" MaxLength="10"></asp:TextBox>
                            <ajax:FilteredTextBoxExtender ID="ftbTxtNumeroOrden" runat="server" TargetControlID="txtNumeroOrden" FilterMode="ValidChars" FilterType="Numbers"></ajax:FilteredTextBoxExtender>
                            <asp:Button runat="server" ID="btnActualizarPDAGO" Text="Actualizar" />
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
            </tr>
    ...
    <article class="formulario sinBorde" id="formularioTotal3" runat="server">
        <table>
    ...
    <article class="areaBotones">
        <asp:Button runat="server" ID="btnRegistrar" Text="Guardar" ValidationGroup="Aceptar" OnClientClick="javascript:return validarGuardar();" />
    ...
    <script type="text/javascript">
        ...
        function validarGuardarEmergencia(){
        ...
        function mostrarPopupRegistroExitoso() {
            var tipoOrden = <%=Me.TipoOrden%>;
            var nombreOrden;

            if(tipoOrden == 0){
                nombreOrden= 'Emergencia';
            }else{
                nombreOrden= 'Ordinaria';
            }

            var vlo_ConfiguracionPopup = {
                titulo: 'Catálogo de Ordenes de Trabajo en Recepción',
                mensaje: 'Se ha registrado la información.. <br/><strong>¿Desea registrar otra orden de trabajo de tipo '+ nombreOrden +'?</strong>',
                        ...
                        [
                            {
                                idControl: "btnSi",
                                textoBoton: "Sí",
                                onClick: function () { window.location = 'Frm_OT_OrdenesTrabajoRecepcion.aspx?pvn_Operacion=<%=Utilerias.OrdenesDeTrabajo.eOperacion.Agregar%>&pvn_TipoOrden=<%=Me.TipoOrden%>'; }
                            },
                        {
                            idControl: "btnNo",
                            textoBoton: "No",
        ...
        function mostrarActualizacionExitosa(){
            mostrarAlerta(
                '#arAlertasDelFormulario',
                {
                    mensaje: 'Se ha actualizado la información del Número de Orden.',
                    tipo: "exito",
                    transparencia: 0.9,
                    posicion: 'center'
                });
        ...
        function inicializarFormulario(){
            ...
            configurarLongitudMaximaTexto('#<%=Me.txtPersonaContacto.ClientID%>',<%=Utilerias.OrdenesDeTrabajo.Modelo.OTT_ORDEN_TRABAJO.NOMBRE_PERSONA_CONTACTO_BD_TAMANO%>);
        ...
        function deshabilitar(){
            deshabilitarJerarquiaDeControles(document.getElementById('<%=formularioTotal1.ClientID%>'));
            deshabilitarJerarquiaDeControles(document.getElementById('<%=formularioTotal3.ClientID%>'));
            deshabilitarControl('#<%=btnRegistrar.ClientID%>');
            deshabilitarControl('#<%=btnRegistrarEnviar.ClientID%>');
            deshabilitarControl('#btnLimpiarFormulario');
