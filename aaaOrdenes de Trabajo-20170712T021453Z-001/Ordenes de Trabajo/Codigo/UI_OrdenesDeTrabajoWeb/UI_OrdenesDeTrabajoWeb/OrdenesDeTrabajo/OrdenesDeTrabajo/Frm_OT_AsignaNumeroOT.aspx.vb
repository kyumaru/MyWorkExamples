...
Partial Class OrdenesDeTrabajo_Frm_OT_AsignaNumeroOT
...
#Region "Eventos"
    ...
    '''    <creationChange>17/09/2015</creationChange>
    '''    <change>Inicializar el UsuarioActual</change>
    ''' </changeLog>
    ...
    ''' <summary>
    ''' evento que se ejecuta cuando se da click en el boton de aceptar del formulario
    ''' </summary>
...
#Region "Funciones"
    ...
    Public Function CargarFuncionario(pvn_IdPersonal As String) As WsrEU_Curriculo.EntEmpleados
        ...
        Try
            Return vlo_WsEU_Curriculo.Empleados_ObtenerRegistro(
                ConfigurationManager.AppSettings(ConstantesInternas.APP_KEY_USUARIO_APLICACION_WEB),
                ConfigurationManager.AppSettings(ConstantesInternas.APP_KEY_CLAVE_APLICACION_WEB),
                String.Format("NUM_EMPLEADO = '{0}'", pvn_IdPersonal))
        Catch ex As Exception
            Throw
        Finally
    ...
    Private Function Actualizacion() As Boolean
        ...
        Try
            ...
            Me.OrdenTrabajo.NumeroOrden = IIf(Me.txtNumeroOrden.Text = String.Empty, Nothing, Me.txtNumeroOrden.Text)
            Me.OrdenTrabajo.Usuario = Me.Usuario.UserName

            If Me.OrdenTrabajo.NumeroOrden = Nothing Then
                Return vlo_Ws_OT_OrdenesDeTrabajo.OTT_ORDEN_TRABAJO_ModificarRegistro(
                    ConfigurationManager.AppSettings(ConstantesInternas.APP_KEY_USUARIO_APLICACION_WEB),
                    ConfigurationManager.AppSettings(ConstantesInternas.APP_KEY_CLAVE_APLICACION_WEB),
                    Me.OrdenTrabajo) > 0
            Else
                Return vlo_Ws_OT_OrdenesDeTrabajo.OTT_ORDEN_TRABAJO_ModificarNumeroOT(
                    ConfigurationManager.AppSettings(ConstantesInternas.APP_KEY_USUARIO_APLICACION_WEB),
                    ConfigurationManager.AppSettings(ConstantesInternas.APP_KEY_CLAVE_APLICACION_WEB),
                    Me.OrdenTrabajo) > 0
            End If
