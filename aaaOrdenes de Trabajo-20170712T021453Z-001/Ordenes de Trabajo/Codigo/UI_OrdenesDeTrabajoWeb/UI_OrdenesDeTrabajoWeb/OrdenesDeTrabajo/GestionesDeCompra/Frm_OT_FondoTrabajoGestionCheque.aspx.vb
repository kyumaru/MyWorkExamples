...
Partial Class OrdenesDeTrabajo_GestionesDeCompra_Frm_OT_FondoTrabajoGestionCheque
    ...
    Private Sub GuardarRevision()
        ...
        Try
            ...
            If vlo_EntOttGestionCompra.Existe Then
                vlo_EntOttGestionCompra.NumeroCheque = Me.txtCheque.Text
                vlo_EntOttGestionCompra.Estado = Utilerias.OrdenesDeTrabajo.EstadoGestionCompra.PENDIENTE_INGRESO_ALMACEN
            End If
            ...
            With vlo_EntOtlTrazabilGestionComp
                ...
                .Estado = Utilerias.OrdenesDeTrabajo.EstadoGestionCompra.GESTION_DE_CHEQUE
