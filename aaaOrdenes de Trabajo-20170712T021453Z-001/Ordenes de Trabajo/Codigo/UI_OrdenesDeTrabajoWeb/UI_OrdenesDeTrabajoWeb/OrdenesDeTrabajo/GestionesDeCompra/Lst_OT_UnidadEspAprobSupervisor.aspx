<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Listado.master" AutoEventWireup="false" CodeFile="Lst_OT_UnidadEspAprobSupervisor.aspx.vb" Inherits="OrdenesDeTrabajo_GestionesDeCompra_Lst_OT_UnidadEspAprobSupervisor" %>
    ...
    <article data-grupo="FiltrosDeBusqueda" class="formulario">
        ...
        <table>
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID="txtNumeroGestion" data-tipocontrol="texto" Width="60%" MaxLength="10"></asp:TextBox>
            ...
            <tr>
                <th>Estado</th>
                <td>
                    <asp:DropDownList Width="60%" runat="server" ID="ddlEstado" data-tipocontrol="combo" AppendDataBoundItems="true"></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <th>Fecha desde</th>
