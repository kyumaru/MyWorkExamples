...
Partial Class OrdenesDeTrabajo_GestionesDeCompra_Frm_OT_UnidadEspAprobJefeAdmin
    ...
    Private Sub GuardarRevision()
        ...
        Try
            ...
            With vlo_EntOtlTrazabilGestionComp
                ...
                .Estado = Utilerias.OrdenesDeTrabajo.EstadoGestionCompra.APROBACION_JEFE_ADMINISTRATIVO
