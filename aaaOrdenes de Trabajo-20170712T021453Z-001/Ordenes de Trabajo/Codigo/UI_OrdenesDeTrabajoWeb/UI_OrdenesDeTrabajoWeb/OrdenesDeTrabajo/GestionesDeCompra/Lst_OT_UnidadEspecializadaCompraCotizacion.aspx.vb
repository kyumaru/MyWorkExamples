...
Partial Class OrdenesDeTrabajo_GestionesDeCompra_Lst_OT_UnidadEspecializadaCompraCotizacion
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            Try
                ...
                If Roles.IsUserInRole(Membership.GetUser.UserName, RolesSistema.OT_UNIDAD_ESPECIALIZADA_COMPRA) Then
    ...
    Protected Sub ibConsultarGestion_Click(sender As Object, e As ImageClickEventArgs)
        ...
        Response.Redirect("Frm_OT_UnidadEspecializadaCompraConsultaGestionGeco.aspx", False)
    ...
    ''' <creationDate>25/10/2016</creationDate>
    ''' <changeLog></changeLog>
    Protected Sub ibCotizacionProveedor_Click(sender As Object, e As ImageClickEventArgs)
        Dim vlc_CommandArgument As String
        Dim vlc_Llave As String()
        ...
        ' Response.Redirect("Frm_OT_UnidadEspecializadaCompraAprobacionJefatura.aspx", False)
    ...
    Protected Sub lnkTrazabilidadGestion(sender As Object, e As CommandEventArgs)
        ...
        Me.Session.Add("pvn_Anno", vlc_Llave(2))
        Me.Session.Add("pvn_NumeroGestion", vlc_Llave(3))
        Me.Session.Add("pvc_PaginaRegreso", "Lst_OT_UnidadEspecializadaCompraCotizacion.aspx")
    ...
    Private Sub CargarComboEstados()
        ...
        Try
            ...
            vlo_DsDatos = vlo_Ws_OT_OrdenesDeTrabajo.OTC_ESTADO_GESTION_COMPRA_ListarRegistrosLista(
                            ...
                            String.Format("{0} = '{1}' OR {2} = '{3}' OR {4} = '{5}' OR {6} = '{7}' OR {8} = '{9}'",
                                          Modelo.OTC_ESTADO_GESTION_COMPRA.ESTADO, EstadoGestionCompra.GESTION_UNIDAD_ESPECIALIZADA_COTIZACION,
                                          Modelo.OTC_ESTADO_GESTION_COMPRA.ESTADO, EstadoGestionCompra.GESTION_UNIDAD_ESPECIALIZADA_REGISTRO_COTIZACION,
                                          Modelo.OTC_ESTADO_GESTION_COMPRA.ESTADO, EstadoGestionCompra.APROBACION_TECNICA,
                                          Modelo.OTC_ESTADO_GESTION_COMPRA.ESTADO, EstadoGestionCompra.APROBACION_JEFATURA_REVISION_TECNICA,
                                          Modelo.OTC_ESTADO_GESTION_COMPRA.ESTADO, EstadoGestionCompra.GESTION_UNIDAD_ESPECIALIZADA_PONDERACION),
                            String.Format("{0} {1}", Modelo.OTC_ESTADO_GESTION_COMPRA.DESCRIPCION, Ordenamiento.ASCENDENTE),
                            False,
                            0,
                            0)
            ...
            If vlo_DsDatos IsNot Nothing AndAlso vlo_DsDatos.Tables(0).Rows.Count > 0 Then
                With Me.ddlFiltroEstado
                    ...
                    .DataTextField = Modelo.OTC_ESTADO_GESTION_COMPRA.DESCRIPCION
                    .DataValueField = Modelo.OTC_ESTADO_GESTION_COMPRA.ESTADO
                    .DataBind()
                End With
            End If
...
#Region "Funciones"
    ...
    Private Function ObtenerCondicionBusqueda() As String
        ...
        If Not String.IsNullOrWhiteSpace(Me.txtFiltroFechaDesde.Text) And Not String.IsNullOrWhiteSpace(Me.txtFiltroFechaHasta.Text) Then
            If String.IsNullOrWhiteSpace(vlc_Condicion) Then
                vlc_Condicion = String.Format("{0} BETWEEN TO_DATE('{1}', 'dd/mm/yyyy') AND TO_DATE('{2}', 'dd/mm/yyyy')", Modelo.V_OTT_GESTION_COMPRALST.FECHA_ASIGNA_SUPERVISOR, Me.txtFiltroFechaDesde.Text, Me.txtFiltroFechaHasta.Text)
            Else
                vlc_Condicion = String.Format("{0} AND {1} BETWEEN TO_DATE('{2}', 'dd/mm/yyyy') AND TO_DATE('{3}', 'dd/mm/yyyy')", vlc_Condicion, Modelo.V_OTT_GESTION_COMPRALST.FECHA_ASIGNA_SUPERVISOR, Me.txtFiltroFechaDesde.Text, Me.txtFiltroFechaHasta.Text)
            End If
        End If
        ...
        If String.IsNullOrWhiteSpace(vlc_Condicion) Then
            vlc_Condicion = String.Format("{0} = '{1}' OR {2} = '{3}' OR {4} = '{5}' OR {6} = '{7}' OR {8} = '{9}'",
                                          Modelo.V_OTT_GESTION_COMPRALST.ESTADO, EstadoGestionCompra.GESTION_UNIDAD_ESPECIALIZADA_COTIZACION,
                                          Modelo.V_OTT_GESTION_COMPRALST.ESTADO, EstadoGestionCompra.GESTION_UNIDAD_ESPECIALIZADA_REGISTRO_COTIZACION,
                                          Modelo.V_OTT_GESTION_COMPRALST.ESTADO, EstadoGestionCompra.APROBACION_TECNICA,
                                          Modelo.V_OTT_GESTION_COMPRALST.ESTADO, EstadoGestionCompra.APROBACION_JEFATURA_REVISION_TECNICA,
                                          Modelo.V_OTT_GESTION_COMPRALST.ESTADO, EstadoGestionCompra.GESTION_UNIDAD_ESPECIALIZADA_PONDERACION)
        Else
            vlc_Condicion = String.Format("{0} AND ({1} = '{2}' OR {3} = '{4}' OR {5} = '{6}' OR {7} = '{8}' OR {9} = '{10}')", vlc_Condicion,
                                          Modelo.V_OTT_GESTION_COMPRALST.ESTADO, EstadoGestionCompra.GESTION_UNIDAD_ESPECIALIZADA_COTIZACION,
                                          Modelo.V_OTT_GESTION_COMPRALST.ESTADO, EstadoGestionCompra.GESTION_UNIDAD_ESPECIALIZADA_REGISTRO_COTIZACION,
                                          Modelo.V_OTT_GESTION_COMPRALST.ESTADO, EstadoGestionCompra.APROBACION_TECNICA,
                                          Modelo.V_OTT_GESTION_COMPRALST.ESTADO, EstadoGestionCompra.APROBACION_JEFATURA_REVISION_TECNICA,
    ...
    Private Function CargarParametro(pvn_IdParametro As Integer) As Integer
        ...
        Try
            ...
            Return vlo_EntOtpParametroUbicacion.Valor
