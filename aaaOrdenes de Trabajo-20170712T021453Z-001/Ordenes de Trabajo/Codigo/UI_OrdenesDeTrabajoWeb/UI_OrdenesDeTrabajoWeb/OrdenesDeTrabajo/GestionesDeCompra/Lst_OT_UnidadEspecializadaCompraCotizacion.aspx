<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Listado.master" AutoEventWireup="false" CodeFile="Lst_OT_UnidadEspecializadaCompraCotizacion.aspx.vb" Inherits="OrdenesDeTrabajo_GestionesDeCompra_Lst_OT_UnidadEspecializadaCompraCotizacion" %>
    ...
    <article data-grupo="FiltrosDeBusqueda" class="formulario">
        <table>
            ...
            <tr>
                <th>Estado</th>
                <td>
                    <asp:DropDownList runat="server" ID="ddlFiltroEstado" data-tipocontrol="combo" Width="59%"></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <th>Fecha desde</th>
            ...
            <HeaderTemplate>
                <table>
                    <tr>
                        ...
                        <th>
                            <asp:LinkButton runat="server" ID="lnkFecha" Text="Fecha" CommandName="<%#Utilerias.OrdenesDeTrabajo.Modelo.V_OTT_GESTION_COMPRALST.FECHA_REGISTRO_SOLICITUD%>" CommandArgument="ASC" OnCommand="lnkRpRevision_Command"></asp:LinkButton>
                        </th>
                        <th>
                ...
                <tr class="lineaDelListado">
                    ...
                    <td>
                        <article style="display: <%#IIf(Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTT_GESTION_COMPRALST.OBSERVACIONES).ToString.StartsWith("-"), "none", "block")%>">
                            <asp:Image runat="server" ID="ImageButton1" data-tipo="tooltip"
                    ...
                    <td>
                        <asp:LinkButton runat="server" ID="lnkEstado"
                            Text="<%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTT_GESTION_COMPRALST.DESC_ESTADO)%>"
                    ...
                    <td>
                        <asp:ImageButton runat="server" class="tooltip" ToolTip="Consultar Gestión" ID="ibConsultarGestion"
                            AlternateText="Consultar Gestión" OnClick="ibConsultarGestion_Click"
                            CommandArgument='<%#String.Format("{0}%{1}%{2}%{3}", Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTT_GESTION_COMPRALST.ID_UBICACION), Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTT_GESTION_COMPRALST.ID_VIA_COMPRA_CONTRATO), Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTT_GESTION_COMPRALST.ANNO), Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTT_GESTION_COMPRALST.NUMERO_GESTION))%>'
                            src='<%#AdministradorRecursos.ObtenerRutaImagen(AdministradorRecursos.TAMANO_IMAGEN.x16, AdministradorRecursos.COLOR_IMAGEN.GRIS, "Lupa.png")%>'
                    ...
                    <td>
                        <asp:ImageButton runat="server" class="tooltip" ToolTip="Cotización a Proveedor" ID="ibCotizacionProveedor"
                            AlternateText="Cotización a Proveedor" OnClick="ibCotizacionProveedor_Click"
                            CommandArgument='<%#String.Format("{0}%{1}%{2}%{3}", Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTT_GESTION_COMPRALST.ID_UBICACION), Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTT_GESTION_COMPRALST.ID_VIA_COMPRA_CONTRATO), Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTT_GESTION_COMPRALST.ANNO), Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTT_GESTION_COMPRALST.NUMERO_GESTION))%>'
                            src='<%#AdministradorRecursos.ObtenerRutaImagen(AdministradorRecursos.TAMANO_IMAGEN.x16, AdministradorRecursos.COLOR_IMAGEN.GRIS, "Icono_Recibir_Dinero.png")%>'
