...
Partial Class OrdenesDeTrabajo_GestionesDeCompra_Lst_OT_UnidadEspAprobSupervisor
...
#Region "Eventos"
    ...
    Protected Sub ibContenidoTematico_Click(sender As Object, e As ImageClickEventArgs)
        ...
        Response.Redirect("Frm_OT_UnidadEspAprobSupervisor.aspx", False)
    ...
    Protected Sub lnkTrazabilidadGestion(sender As Object, e As CommandEventArgs)
        ...
        Me.Session.Add("pvn_Anno", vlc_Llave(2))
        Me.Session.Add("pvn_NumeroGestion", vlc_Llave(3))
        Me.Session.Add("pvc_PaginaRegreso", "Lst_OT_UnidadEspAprobSupervisor.aspx")
...
#Region "Funciones"
    ...
    Private Function ObtenerCondicionBusqueda() As String
        ...
        vlc_Condicion = String.Format("{0} = '{1}' AND {2} = {3} AND {4} = {5}", Modelo.V_OTT_GESTION_COMPRALST.ESTADO, EstadoGestionCompra.APROBACION_DEL_SUPERVISOR, Modelo.V_OTT_GESTION_COMPRALST.ID_UBICACION, Me.AutorizadoUbicacion.IdUbicacionAdministra, Modelo.V_OTT_GESTION_COMPRALST.ID_VIA_COMPRA_CONTRATO, Me.ViaCompraUnidadEspec)
