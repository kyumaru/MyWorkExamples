...
Partial Class OrdenesDeTrabajo_GestionesDeCompra_Lst_OT_UnidadEspecializadaCompraAprobacionSupervisor
...
#Region "Eventos"
    ...
    Protected Sub ibRevisar_Click(sender As Object, e As ImageClickEventArgs)
        ...
        Response.Redirect("Frm_OT_UnidadEspecializadaCompraAprobacionSupervisor.aspx", False)
    ...
    Protected Sub lnkTrazabilidadGestion(sender As Object, e As CommandEventArgs)
        ...
        Me.Session.Add("pvn_Anno", vlc_Llave(2))
        Me.Session.Add("pvn_NumeroGestion", vlc_Llave(3))
        Me.Session.Add("pvc_PaginaRegreso", "Lst_OT_UnidadEspecializadaCompraAprobacionSupervisor.aspx")
...
#Region "Funciones"
    ...
    Private Function ObtenerCondicionBusqueda() As String
        ...
        If String.IsNullOrWhiteSpace(vlc_Condicion) Then
            vlc_Condicion = String.Format("{0} = '{1}'", Modelo.V_OTT_GESTION_COMPRALST.ESTADO, EstadoGestionCompra.APROBACION_DEL_SUPERVISOR)
        Else
            vlc_Condicion = String.Format("{0} AND {1} = '{2}'", vlc_Condicion, Modelo.V_OTT_GESTION_COMPRALST.ESTADO, EstadoGestionCompra.APROBACION_DEL_SUPERVISOR)
        End If
