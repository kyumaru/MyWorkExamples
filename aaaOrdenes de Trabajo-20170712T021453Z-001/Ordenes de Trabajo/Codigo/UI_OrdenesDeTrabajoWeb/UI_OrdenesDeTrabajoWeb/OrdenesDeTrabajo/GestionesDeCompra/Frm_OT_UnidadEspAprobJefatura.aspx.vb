...
Partial Class OrdenesDeTrabajo_GestionesDeCompra_Frm_OT_UnidadEspAprobJefatura
    ...
    Private Sub GuardarRevision()
        ...
        Try
            ...
            If vlo_EntOttGestionCompra.Existe Then
                vlo_EntOttGestionCompra.Estado = IIf(Me.rdbAprobado.Checked, Utilerias.OrdenesDeTrabajo.EstadoGestionCompra.INGRESO_GESTION_GECO, Utilerias.OrdenesDeTrabajo.EstadoGestionCompra.APROBACION_JEFE_ADMINISTRATIVO)
            End If
