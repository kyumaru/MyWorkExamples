<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Formulario.master" AutoEventWireup="false" CodeFile="Frm_OT_FondoTrabajoAprobJefatura.aspx.vb" Inherits="OrdenesDeTrabajo_GestionesDeCompra_Frm_OT_FondoTrabajoAprobJefatura" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphFormulario" Runat="Server">
    ...
    <article class="formulario ">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:RadioButton ID="rdbAprobado" runat="server"  GroupName="grpAprobo" Text="Aprobar" />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:RadioButton ID="rdbDevuelto" runat="server"  GroupName="grpAprobo" Text="Devolver" />
                            <asp:CustomValidator ID="cvcgrpEstadoRevision" runat="server" ControlToValidate="txtValidaciones" ErrorMessage="Debe indicar si decide aprobar o devolver la gestión de compra" ValidationGroup="Grupo1" ClientValidationFunction="ValidarEstadoRevision">&nbsp;</asp:CustomValidator>
                        </td>
                    </tr>
    ...
    <article id="arpopupConfirmacion"></article>
    <article style="visibility:hidden">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#<%=Me.btnTramitar.ClientID%>').click(function () { 
                
                if (Page_ClientValidate('Grupo1')){
                    return mostrarPopupConfirmaDeseaBorrarRegistro();return false; }
                }
        ...
        function regresarAlListado() {
            window.location = 'Lst_OT_FondoTrabajoAprobJefatura.aspx';
        }

        function mostrarPopupConfirmaDeseaBorrarRegistro() {
            var rdbAprobarJs = document.getElementById('<%=rdbAprobado.ClientID%>');

            if (rdbAprobarJs.checked){
                var vlo_ConfiguracionPopup = {
                    titulo: 'Gestión de Compras',
                    mensaje: 'Esta acción notificara de manera automática al proveedor adjudicado sobre la compra aprobada. ¿Desea continuar?',
                    botones:
                            [
                                {
                                    idControl: "btnSi",
                ...
                $('#arpopupConfirmacion').popup(vlo_ConfiguracionPopup);

                window.location = '#arpopupConfirmacion';
