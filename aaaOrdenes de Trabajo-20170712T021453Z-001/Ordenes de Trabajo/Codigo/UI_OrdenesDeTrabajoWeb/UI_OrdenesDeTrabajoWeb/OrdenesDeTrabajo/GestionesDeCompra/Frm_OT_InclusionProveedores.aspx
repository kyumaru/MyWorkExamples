<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Formulario.master" AutoEventWireup="false" CodeFile="Frm_OT_InclusionProveedores.aspx.vb" Inherits="OrdenesDeTrabajo_GestionesDeCompra_Frm_OT_InclusionProveedores" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphFormulario" runat="Server">
    ...
    <article class="areaBotones">
        ...
        <asp:Button runat="server" ID="btnSolicitarCotizacion" Text="Solicitar Cotización" />
    </article>
    ...
    <script type="text/javascript">
        ...
        function mostrarAlertaActualizacionExitosa() {
            ...
            deshabilitarControl('#<%=btnSolicitarCotizacion.ClientID%>');
