...
Partial Class OrdenesDeTrabajo_GestionesDeCompra_Frm_OT_GestiónCompraRapida
...
#Region "Funciones"
    ...
    Private Function ObtenerCondicionBusqueda() As String
        ...
        If String.IsNullOrWhiteSpace(vlc_Condicion) Then
            vlc_Condicion = String.Format("{0} = {1}", Modelo.V_OT_DETALLE_MATERIAL.ID_VIA_COMPRA_CONTRATO, Me.ParametroViaCompraContrato.Valor)
        Else
            vlc_Condicion = String.Format("{0} AND {1} = {2}", vlc_Condicion, Modelo.V_OT_DETALLE_MATERIAL.ID_VIA_COMPRA_CONTRATO, Me.ParametroViaCompraContrato.Valor)
        End If
    ...
    ''' <changeLog></changeLog>
    Private Function GestionarCompra() As Boolean
        Dim vlo_Ws_OT_OrdenesDeTrabajo As Wsr_OT_OrdenesDeTrabajo.Ws_OT_OrdenesDeTrabajo
        ...
        Try
            ...
            Me.LlaveGestionCompra = vlo_Ws_OT_OrdenesDeTrabajo.OTT_GESTION_COMPRA_InsertarGestionCompraRapida(
                ConfigurationManager.AppSettings(ConstantesInternas.APP_KEY_USUARIO_APLICACION_WEB),
                ConfigurationManager.AppSettings(ConstantesInternas.APP_KEY_CLAVE_APLICACION_WEB),
                Me.DsMateriales, Me.Usuario.UserName, Me.AutorizadoUbicacion.IdUbicacionAdministra)
