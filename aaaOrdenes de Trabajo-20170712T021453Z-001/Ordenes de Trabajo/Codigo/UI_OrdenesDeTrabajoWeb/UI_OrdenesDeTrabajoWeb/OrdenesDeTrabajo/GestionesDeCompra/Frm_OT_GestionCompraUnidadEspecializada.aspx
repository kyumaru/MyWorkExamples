<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Listado.master" AutoEventWireup="false" CodeFile="Frm_OT_GestionCompraUnidadEspecializada.aspx.vb" Inherits="OrdenesDeTrabajo_GestionesDeCompra_Frm_OT_GestionCompraUnidadEspecializada" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphFormulario" Runat="Server">
    ...
    <article class="formulario">
        <table>
            <tr>
                <th>Observaciones</th>
                <td>
                    <asp:TextBox Width="70%" runat="server" ID="txtObservaciones" TextMode="MultiLine" Rows="5"></asp:TextBox>
                </td>
            </tr>
        </table>
    </article>
                ...
                <asp:Repeater runat="server" ID="rpDetalles">
                    ...
                    <ItemTemplate>
                        <tr class="lineaDelListado">
                            ...
                            <td><%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OT_DETALLE_MATERIAL.PARTIDA_PRESUPUESTARIA)%></td>
    ...
    <script type="text/javascript">
        ...
        function irAConsulta() {
            window.location = 'Frm_OT_ConsultaGestiónCompraUnidadEspecializada.aspx';
        };
                        ...
                        [
                            {
                                idControl: "btnSi",
                                textoBoton: "Si",
                                onClick: function () { window.location = 'Lst_OT_GestiónCompraListado.aspx'; }
                            },
            {
                idControl: "btnNo",
                textoBoton: "No",
