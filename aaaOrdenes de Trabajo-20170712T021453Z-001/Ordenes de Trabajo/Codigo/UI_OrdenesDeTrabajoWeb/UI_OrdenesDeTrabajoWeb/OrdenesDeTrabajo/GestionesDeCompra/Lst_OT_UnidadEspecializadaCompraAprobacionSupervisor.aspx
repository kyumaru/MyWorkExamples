<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Listado.master" AutoEventWireup="false" CodeFile="Lst_OT_UnidadEspecializadaCompraAprobacionSupervisor.aspx.vb" Inherits="OrdenesDeTrabajo_GestionesDeCompra_Lst_OT_UnidadEspecializadaCompraAprobacionSupervisor" %>
            ...
            <ItemTemplate>
                <tr class="lineaDelListado">
                    ...
                    <td>
                        ...
                        <td>
                            <asp:ImageButton runat="server" class="tooltip" ToolTip="Revisar" ID="ibRevisar"
                                AlternateText="Revisar" OnClick="ibRevisar_Click"
