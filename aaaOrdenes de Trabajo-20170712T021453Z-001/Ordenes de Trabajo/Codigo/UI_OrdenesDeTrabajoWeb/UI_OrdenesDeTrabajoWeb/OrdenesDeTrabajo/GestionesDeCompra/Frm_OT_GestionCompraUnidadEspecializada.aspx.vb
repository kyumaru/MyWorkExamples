...
Partial Class OrdenesDeTrabajo_GestionesDeCompra_Frm_OT_GestionCompraUnidadEspecializada
...
#Region "Propiedades"
    ...
    ''' <changeLog></changeLog>
    Private Property ParametroUnidadEspecializada As Wsr_OT_Catalogos.EntOtpParametroUbicacion
        Get
            Return CType(ViewState("ParametroUnidadEspecializada"), Wsr_OT_Catalogos.EntOtpParametroUbicacion)
        End Get
        Set(value As Wsr_OT_Catalogos.EntOtpParametroUbicacion)
            ViewState("ParametroUnidadEspecializada") = value
        End Set
    End Property
        ...
        If Not Page.IsPostBack Then
            Try
                ...
                If AutorizadoUbicacion.Existe Then
                    Me.ParametroUnidadEspecializada = CargarParametro(Parametros.VALOR_SECUENCIA_UNIDAD_ESPECIALIZADA_COMPRAS)
...
#Region "Funciones"
    ...
    Private Function ObtenerCondicionBusqueda() As String
        ...
        If String.IsNullOrWhiteSpace(vlc_Condicion) Then
            vlc_Condicion = String.Format("{0} = {1}", Modelo.V_OT_DETALLE_MATERIAL.ID_VIA_COMPRA_CONTRATO, Me.ParametroUnidadEspecializada.Valor)
        Else
            vlc_Condicion = String.Format("{0} AND {1} = {2}", vlc_Condicion, Modelo.V_OT_DETALLE_MATERIAL.ID_VIA_COMPRA_CONTRATO, Me.ParametroUnidadEspecializada.Valor)
        End If
    ...
    Private Function GestionarCompraModificar() As Boolean
        ...
        Try
            ...
            Return vlo_Ws_OT_OrdenesDeTrabajo.OTT_GESTION_COMPRA_ModificarGestionCompraUnidadEspecializada(
                ConfigurationManager.AppSettings(ConstantesInternas.APP_KEY_USUARIO_APLICACION_WEB),
                ConfigurationManager.AppSettings(ConstantesInternas.APP_KEY_CLAVE_APLICACION_WEB),
    ...
    Private Function GestionarCompraAgregar() As Boolean
        ...
        Try
            ...
            Me.LlaveGestionCompra = vlo_Ws_OT_OrdenesDeTrabajo.OTT_GESTION_COMPRA_InsertarGestionUnidadEspecializada(
                ConfigurationManager.AppSettings(ConstantesInternas.APP_KEY_USUARIO_APLICACION_WEB),
                ConfigurationManager.AppSettings(ConstantesInternas.APP_KEY_CLAVE_APLICACION_WEB),
