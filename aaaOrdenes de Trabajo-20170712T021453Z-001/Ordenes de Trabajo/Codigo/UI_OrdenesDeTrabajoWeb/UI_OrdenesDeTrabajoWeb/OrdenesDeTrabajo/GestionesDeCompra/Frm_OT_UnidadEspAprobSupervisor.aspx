<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Formulario.master" AutoEventWireup="false" CodeFile="Frm_OT_UnidadEspAprobSupervisor.aspx.vb" Inherits="OrdenesDeTrabajo_GestionesDeCompra_Frm_OT_UnidadEspAprobSupervisor" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphFormulario" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function regresarAlListado() {
            window.location = 'Lst_OT_UnidadEspAprobSupervisor.aspx';
        }
