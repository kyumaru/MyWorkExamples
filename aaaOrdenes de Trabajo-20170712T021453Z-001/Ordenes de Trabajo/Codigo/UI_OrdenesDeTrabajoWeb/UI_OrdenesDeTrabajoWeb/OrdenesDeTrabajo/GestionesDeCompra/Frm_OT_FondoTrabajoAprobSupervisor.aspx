<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Formulario.master" AutoEventWireup="false" CodeFile="Frm_OT_FondoTrabajoAprobSupervisor.aspx.vb" Inherits="OrdenesDeTrabajo_GestionesDeCompra_Frm_OT_FondoTrabajoAprobSupervisor" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphFormulario" runat="Server">
        ...
        <asp:UpdatePanel runat="server" ID="upDdlCurso" UpdateMode="Conditional">
            <ContentTemplate>
                <table>
                    ...
                    <tr runat="server" id="trAdjudicado">
                        <th style="width: 14%;">Adjudicado a:</th>
                        <td>
                            <asp:DropDownList runat="server" ID="ddlAdjudicado" data-tipocontrol="combo" AppendDataBoundItems="true" Width="65%"></asp:DropDownList>
                            <asp:CustomValidator ID="cvDdlAdjudicado" runat="server" ControlToValidate="txtValidaciones" ErrorMessage="Debe indicar a quien adjudica la gestión de compra" ValidationGroup="Grupo1" ClientValidationFunction="ValidadorDeCampoRequeridoPersonalizado2">&nbsp;</asp:CustomValidator>
                        </td>
                    </tr>
    ...
    <script type="text/javascript">
        ...
        function ValidadorDeCampoRequeridoPersonalizado2(source, clientside_arguments) {
            if (document.getElementById('<%=rdbAprobado.ClientID%>').checked && document.getElementById('<%=ddlAdjudicado.ClientID%>').value.trim() == "") {
                return clientside_arguments.IsValid = false;
            }
            else {
                return clientside_arguments.IsValid = true;
        ...
        function regresarAlListado() {
            window.location = 'Lst_OT_FondoTrabajoAprobSupervisor.aspx';
        }
