<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Listado.master" AutoEventWireup="false" CodeFile="Frm_OT_GestionCompraFondoTrabajo.aspx.vb" Inherits="OrdenesDeTrabajo_GestionesDeCompra_Frm_OT_GestionCompraFondoTrabajo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphFormulario" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function irAConsulta() {
            window.location = 'Frm_OT_ConsultaGestiónCompraFondoTrabajo.aspx';
        };
