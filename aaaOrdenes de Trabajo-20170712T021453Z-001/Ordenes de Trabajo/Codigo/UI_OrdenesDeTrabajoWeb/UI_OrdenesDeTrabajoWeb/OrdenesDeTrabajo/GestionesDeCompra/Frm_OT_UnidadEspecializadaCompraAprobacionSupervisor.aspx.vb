...
Partial Class OrdenesDeTrabajo_GestionesDeCompra_Frm_OT_UnidadEspecializadaCompraAprobacionSupervisor
    ...
    Private Function Aceptar() As Boolean
        ...
        Try
            If Me.rbtAprobada.Checked Then
                Me.GestionCompra.Estado = EstadoGestionCompra.APROBACION_JEFE_ADMINISTRATIVO
            Else
                Me.GestionCompra.Estado = EstadoGestionCompra.DEVUELTA_GESTOR_INVENTARIO
            End If
