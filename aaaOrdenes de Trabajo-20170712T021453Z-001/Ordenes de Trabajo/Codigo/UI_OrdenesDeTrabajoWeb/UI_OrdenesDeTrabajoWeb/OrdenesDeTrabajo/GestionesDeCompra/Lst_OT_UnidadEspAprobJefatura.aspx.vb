...
Partial Class OrdenesDeTrabajo_GestionesDeCompra_Lst_OT_UnidadEspAprobJefatura
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            Try
                ...
                If Roles.IsUserInRole(Membership.GetUser.UserName, RolesSistema.OT_JEFE_SECCION) Or Roles.IsUserInRole(Membership.GetUser.UserName, RolesSistema.OT_DELEGADO_JEFE_SECCION) Then
    ...
    Protected Sub ibContenidoTematico_Click(sender As Object, e As ImageClickEventArgs)
        ...
        Response.Redirect("Frm_OT_UnidadEspAprobJefatura.aspx", False)
    ...
    Protected Sub lnkTrazabilidadGestion(sender As Object, e As CommandEventArgs)
        ...
        Me.Session.Add("pvn_Anno", vlc_Llave(2))
        Me.Session.Add("pvn_NumeroGestion", vlc_Llave(3))
        Me.Session.Add("pvc_PaginaRegreso", "Lst_OT_UnidadEspAprobJefatura.aspx")
...
#Region "Métodos"
    ...
    Private Sub CargarComboEstado()
        ...
        Try
            ...
            vlo_DsDatos = vlo_Ws_OT_OrdenesDeTrabajo.OTC_ESTADO_GESTION_COMPRA_ListarRegistros(
               ConfigurationManager.AppSettings(ConstantesInternas.APP_KEY_USUARIO_APLICACION_WEB),
               ConfigurationManager.AppSettings(ConstantesInternas.APP_KEY_CLAVE_APLICACION_WEB),
               String.Empty,
...
#Region "Funciones"
    ...
    Private Function ObtenerCondicionBusqueda() As String
        ...
        vlc_Condicion = String.Format("{0} = '{1}' AND {2} = {3} AND {4} = {5}", Modelo.V_OTT_GESTION_COMPRALST.ESTADO, EstadoGestionCompra.APROBACION_DE_JEFATURA, Modelo.V_OTT_GESTION_COMPRALST.ID_UBICACION, Me.AutorizadoUbicacion.IdUbicacionAdministra, Modelo.V_OTT_GESTION_COMPRALST.ID_VIA_COMPRA_CONTRATO, Me.ViaCompraUnidadEspec)
        ...
        If Not String.IsNullOrWhiteSpace(Me.ddlEstado.SelectedValue) Then
            If String.IsNullOrWhiteSpace(vlc_Condicion) Then
                vlc_Condicion = String.Format("{0} = '{1}'", Modelo.V_OTT_GESTION_COMPRALST.ESTADO, Me.ddlEstado.SelectedValue)
            Else
                vlc_Condicion = String.Format("{0} AND {1} = '{2}'", vlc_Condicion, Modelo.V_OTT_GESTION_COMPRALST.ESTADO, Me.ddlEstado.SelectedValue)
            End If
        End If
