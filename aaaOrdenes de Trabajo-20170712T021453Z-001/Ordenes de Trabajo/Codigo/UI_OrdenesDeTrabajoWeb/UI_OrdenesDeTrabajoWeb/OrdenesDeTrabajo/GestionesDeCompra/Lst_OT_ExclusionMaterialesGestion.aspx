<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Listado.master" AutoEventWireup="false" CodeFile="Lst_OT_ExclusionMaterialesGestion.aspx.vb" Inherits="OrdenesDeTrabajo_GestionesDeCompra_Lst_OT_ExclusionMaterialesGestion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphFormulario" Runat="Server">
    <header>
        <h2>Exclusión de materiales asociados a Gestiones de Compra</h2>
    </header>
