...
Partial Class OrdenesDeTrabajo_GestionesDeCompra_Lst_OT_FondoTrabajoAprobPresupuesto
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            Try
                ...
                If Roles.IsUserInRole(Membership.GetUser.UserName, RolesSistema.OT_SUPERVISOR_SECCION) Then
    ...
    Protected Sub ibContenidoTematico_Click(sender As Object, e As ImageClickEventArgs)
        ...
        Response.Redirect("Frm_OT_FondoTrabajoAprobPresupuesto.aspx", False)

    End Sub

    Protected Sub ibRegistrarCheque_Click(sender As Object, e As ImageClickEventArgs)
        Dim vlc_CommandArgument As String
        Dim vlc_Llave As String()
        ...
        Response.Redirect("Frm_OT_FondoTrabajoGestionCheque.aspx", False)
    ...
    Protected Sub lnkTrazabilidadGestion(sender As Object, e As CommandEventArgs)
        ...
        Me.Session.Add("pvn_Anno", vlc_Llave(2))
        Me.Session.Add("pvn_NumeroGestion", vlc_Llave(3))
        Me.Session.Add("pvc_PaginaRegreso", "Lst_OT_FondoTrabajoAprobPresupuesto.aspx")
...
#Region "Funciones"
    ...
    Private Function ObtenerCondicionBusqueda() As String
        ...
        vlc_Condicion = String.Format("{0} = {1} AND {2} IN ('{3}','{4}')  AND {5} = {6}", Modelo.V_OTT_GESTION_COMPRALST.ID_UBICACION, Me.AutorizadoUbicacion.IdUbicacionAdministra, Modelo.V_OTT_GESTION_COMPRALST.ESTADO, EstadoGestionCompra.APROBACION_DE_PRESUPUESTO, EstadoGestionCompra.GESTION_DE_CHEQUE, Modelo.V_OTT_GESTION_COMPRALST.ID_VIA_COMPRA_CONTRATO, Me.ViaCompraUnidadEspec)
