<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Formulario.master" AutoEventWireup="false" CodeFile="Frm_OT_UnidadEspecializadaCompraAprobacionJefatura.aspx.vb" Inherits="OrdenesDeTrabajo_GestionesDeCompra_Frm_OT_UnidadEspecializadaCompraAprobacionJefatura" %>
    ...
    <script type="text/javascript">
        ...
        function mostrarAlertaGuardadoExitoso() {
            ...
            '#arAlertasDelFormulario',
            {
                ...
                transparencia: 0.9,
                posicion: 'center',
                onClosed: function () { window.location = 'Lst_OT_UnidadEspecializadaCompraAprobacionJefatura.aspx'; }
            });
        };

        function irAListado() {
            window.location = 'Lst_OT_UnidadEspecializadaCompraAprobacionJefatura.aspx';
        };
