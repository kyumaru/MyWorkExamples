...
Partial Class OrdenesDeTrabajo_GestionesDeCompra_Frm_FondoTrabajoAprobPresupuesto
    ...
    Private Sub GuardarRevision()
        ...
        Try
            ...
            If vlo_EntOttGestionCompra.Existe Then
                vlo_EntOttGestionCompra.Estado = IIf(Me.rdbAprobado.Checked, Utilerias.OrdenesDeTrabajo.EstadoGestionCompra.APROBACION_DE_JEFATURA, Utilerias.OrdenesDeTrabajo.EstadoGestionCompra.APROBACION_DEL_SUPERVISOR)
            End If
