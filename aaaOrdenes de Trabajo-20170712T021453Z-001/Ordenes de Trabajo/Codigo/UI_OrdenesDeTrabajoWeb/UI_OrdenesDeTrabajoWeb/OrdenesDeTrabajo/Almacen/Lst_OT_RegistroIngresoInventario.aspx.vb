...
Partial Class OrdenesDeTrabajo_Almacen_Lst_OT_RegistroIngresoInventario
...
#Region "Eventos"
    ...
    Protected Sub lnkTrazabilidadGestion(sender As Object, e As CommandEventArgs)
        ...
        Me.Session.Add("pvc_PaginaRegreso", "Lst_OT_IngresoMaterialAlmacen.aspx")
    ...
    Protected Sub ibConsultarGestion_Click(sender As Object, e As ImageClickEventArgs)
        ...
        Response.Redirect("Lst_OT_ValidarMontos.aspx", False)
...
#Region "Funciones"
    ...
    Private Function ObtenerCondicionBusqueda() As String
        ...
        vlc_Condicion = String.Format("{0} = '{1}' AND {2} = 1", Modelo.V_OTT_GESTION_COMPRALST.ESTADO, EstadoGestionCompra.PENDIENTE_INGRESO_ALMACEN, Modelo.V_OTT_GESTION_COMPRALST.POSEE_INGRESO_VALIDA_MONTOS)
