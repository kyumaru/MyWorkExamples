...
Partial Class OrdenesDeTrabajo_Almacen_Lst_OP_AjusteInventarioAprobSupervisor
...
#Region "Eventos"
    ...
    Protected Sub ibContenidoTematico_Click(sender As Object, e As ImageClickEventArgs)
        ...
        Response.Redirect("Frm_OT_AjusteInventarioAprobSupervisor.aspx", False)
    ...
    Protected Sub lnkTrazabilidadGestion(sender As Object, e As CommandEventArgs)
        ...
        Me.Session.Add("pvn_Anno", vlc_Llave(1))
        Me.Session.Add("pvn_ConsecutivoAjuste", vlc_Llave(2))
        Me.Session.Add("pvc_PaginaRegreso", "Lst_OT_AjusteInventarioAprobSupervisor.aspx")
...
#Region "Métodos"
    ...
    '        vlc_Orden = ObtenerExpresionDeOrdenamiento(Modelo.OTC_ESTADO_AJUSTE.DESCRIPCION)
    '    End If
...
#Region "Funciones"
    ...
    Private Function ObtenerCondicionBusqueda() As String
        ...
        vlc_Condicion = String.Format("{0} = '{1}' AND {2} = {3}", Modelo.V_OTT_AJUSTE_INVENTARIOLST.ESTADO_AJUSTE, EstadoAjuste.APROBACION_SUPERVISOR, Modelo.V_OTT_AJUSTE_INVENTARIOLST.ID_UBICACION, Me.AutorizadoUbicacion.IdUbicacionAdministra)
