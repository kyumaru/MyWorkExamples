<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage/Mp_Listado.master" CodeFile="Lst_OT_AprobacionAjusteMateriales.aspx.vb" Inherits="OrdenesDeTrabajo_Almacen_Lst_OT_AprobacionAjusteMateriales" %>
...
<asp:Content runat="server" ID="Content1" ContentPlaceHolderID="cphFormulario">
    ...
    <header>
        <h2>Listado de OT's Pendientes de Revisión de Ajuste a Requisición de Materiales</h2>
    </header>
    ...
    <article class="listado sinBorde" data-grupo="Listado">
        ...
        <asp:Repeater runat="server" ID="rpOrdenTrabajo">
            ...
            <ItemTemplate>
                <tr>
                    <td>
                        <asp:LinkButton runat="server" ID="LinkButton1" Text="<%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTT_ORDEN_TRABAJOLST.ID_ORDEN_TRABAJO)%>"
                    ...
                    <td>
                        <asp:ImageButton runat="server" ID="btnRevisionRequisicion" AlternateText="Revisión de Requisición" ToolTip="Revisión de Requisición"
                            ...
                            OnClick="btnRevisionRequisicion_Click" />
                    </td>
