<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Formulario.master" AutoEventWireup="false" CodeFile="Frm_OT_AprobacionTrasladoMaterialesABodega.aspx.vb" Inherits="OrdenesDeTrabajo_Almacen_Frm_OT_AprobacionTrasladoMaterialesABodega" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphFormulario" runat="Server">
        ...
        <ContentTemplate>
            <article class="formulario">
                <table>
                    <tr>
                        <th>
                            <asp:Label runat="server" ID="lblEtiquetaEncargado" Text="Encargado"></asp:Label></th>
                        <td>
        ...
        <table>
            <tr>
                ...
                <td>
                    ...
                    <asp:CustomValidator ID="cvsttxtFecha" ControlToValidate="txtFecha" ValidateEmptyText="true" runat="server" ErrorMessage="Debe indicar la fecha" ValidationGroup="Aceptar" ClientValidationFunction="ValidadorDeCampoRequeridoPersonalizadoFecha">&nbsp;*</asp:CustomValidator>
                </td>
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox runat="server" ID="txtObservaciones" TextMode="MultiLine" Columns="70" Rows="9" Style="overflow: scroll"></asp:TextBox>
                </td>
            </tr>
        </table>
    </article>
    ...
    <article class="formulario sinBorde">
        <table>
            <tr>
                <th></th>
                <td>
                    <asp:RadioButtonList ID="rblDesicion" runat="server" RepeatDirection="Horizontal" RepeatLayout="Table">
                        <asp:ListItem Text="Aprobar" Value="1"></asp:ListItem>
                        <asp:ListItem Text="Devolver" Value="0"></asp:ListItem>
                    </asp:RadioButtonList>
                </td>
            </tr>
            ...
            <tr>
                <th>Observaciones </th>
                <td>
                    <asp:TextBox runat="server" ID="txtObservacionesDesicion" TextMode="MultiLine" Rows="4" Columns="70"></asp:TextBox>
                    <asp:CustomValidator ID="cvstxtObservacionesDesicion" ControlToValidate="txtObservacionesDesicion" ValidateEmptyText="true" runat="server" ErrorMessage="Debe indicar una observación si desea devolver la solicitud" ValidationGroup="Aceptar" ClientValidationFunction="ValidadorDeCampoRequeridoPersonalizado">&nbsp;</asp:CustomValidator>
                </td>
            </tr>
        </table>
    </article>
    <br />
    <article class="areaBotones">
        <asp:Button runat="server" ID="btnAceptar" ValidationGroup="Aceptar" Text="Aceptar" Style="height: 26px" />
        <input id="btnCancelar" type="button" value="Regresar" class="tooltip" title="Regresar al listado" onclick="javascript: regresarAlListado();" />
    </article>
    ...
    <script type="text/javascript">
        ...
        function ValidadorDeCampoRequeridoPersonalizadoFecha(source, clientside_arguments) {
            if ((document.getElementById('<%=txtFecha.ClientID%>').value != "") && document.getElementById('<%=txtFecha.ClientID%>').value.trim() == "") {
                document.getElementById('<%=txtFecha.ClientID%>').style.backgroundColor = "#F5838A"
        ...
        function ValidadorDeCampoRequeridoPersonalizado(source, clientside_arguments) {
            ...
            if ($('#<%=rblDesicion.ClientID%> input[type=radio]:checked').val() == 0 && document.getElementById('<%=txtObservacionesDesicion.ClientID%>').value.trim() == "") {
                  document.getElementById('<%=txtObservacionesDesicion.ClientID%>').style.backgroundColor = "#F5838A"
                    return clientside_arguments.IsValid = false;
                }
                else {
                    document.getElementById('<%=txtObservacionesDesicion.ClientID%>').style.backgroundColor = "white"
                    return clientside_arguments.IsValid = true;
                }
        }
            ...
            var vlo_ConfiguracionPopup = {
                ...
                botones:
                    ...
                    function regresarAlListado() {
                        window.location = 'Lst_OT_AprobacionTrasladoMaterialesABodega.aspx';
                    }
