<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Formulario.master" AutoEventWireup="false" CodeFile="Frm_OT_AjusteInventarioAprobJefatura.aspx.vb" Inherits="OrdenesDeTrabajo_Almacen_Frm_OT_AjusteInventarioAprobJefatura" %>

<%@ Register TagPrefix="wuc" Namespace="Utilerias.WebForms.Controles" Assembly="Utilerias.WebForms.Controles" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphFormulario" Runat="Server">
    <header>
        <h2>Aprobación de ajustes de inventario por parte de la jefatura</h2>
    ...
    <script type="text/javascript">
        ...
        function regresarAlListado() {
            window.location = 'Lst_OT_AjusteInventarioAprobJefatura.aspx';
        }
