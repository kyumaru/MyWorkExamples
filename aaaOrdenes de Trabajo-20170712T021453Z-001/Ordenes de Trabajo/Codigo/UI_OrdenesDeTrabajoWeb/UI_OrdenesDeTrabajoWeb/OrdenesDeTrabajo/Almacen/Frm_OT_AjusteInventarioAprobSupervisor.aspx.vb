...
Partial Class OrdenesDeTrabajo_Almacen_Frm_OT_AjusteInventarioAprobSupervisor
    ...
    Private Sub GuardarRevision()
        ...
        Try
            ...
            If vlo_EntOttAjusteInventario.Existe Then
                vlo_EntOttAjusteInventario.EstadoAjuste = IIf(Me.rdbAprobado.Checked, Utilerias.OrdenesDeTrabajo.EstadoAjuste.APROBACION_JEFATURA, Utilerias.OrdenesDeTrabajo.EstadoAjuste.DEVUELTO_SUPERVISOR)
            End If

            With vlo_EntOtlTrazabilidadAjuste
                .EstadoAjuste = IIf(Me.rdbAprobado.Checked, Utilerias.OrdenesDeTrabajo.EstadoAjuste.APROBACION_JEFATURA, Utilerias.OrdenesDeTrabajo.EstadoAjuste.DEVUELTO_SUPERVISOR)
                .Observaciones = Me.txtObservaciones.Text
                .Usuario = vlo_Usuario.UserName
            End With


            vln_Resultado = vlo_Wsr_OT_OrdenesDeTrabajo.OTT_AJUSTE_INVENTARIO_AprobacionSupervisor(System.Configuration.ConfigurationManager.AppSettings(ConstantesInternas.APP_KEY_USUARIO_APLICACION_WEB).ToString, System.Configuration.ConfigurationManager.AppSettings(ConstantesInternas.APP_KEY_CLAVE_APLICACION_WEB).ToString, vlo_EntOttAjusteInventario, vlo_EntOtlTrazabilidadAjuste)
