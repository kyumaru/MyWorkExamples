<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Lst_OT_RevisionRequisicionMateriales.aspx.vb" MasterPageFile="~/MasterPage/Mp_Listado.master" Inherits="OrdenesDeTrabajo_Almacen_Lst_OT_RevisionRequisicionMateriales" %>
...
<asp:Content runat="server" ID="Content1" ContentPlaceHolderID="cphFormulario">
    ...
    <header>
        <h2>Listado de OT's Pendientes de Revisión de Requisicion de Materiales</h2>
    </header>
    ...
    <article class="listado sinBorde" data-grupo="Listado">
        ...
        <asp:Repeater runat="server" ID="rpOrdenTrabajo">
            <HeaderTemplate>
                <table>
                    <tr>
                        ...
                        <th>
                            <asp:LinkButton runat="server" ID="lnkFechaAsignacion" Text="Fecha Asignación" CommandName="<%#Utilerias.OrdenesDeTrabajo.Modelo.V_OTT_ORDEN_TRABAJOLST.FECHA_ASIGNACION%>" OnCommand="lnkRpOrdenTrabajo_Command"></asp:LinkButton>
                        </th>
                        <th>
            ...
            <ItemTemplate>
                <tr>
                    <td>
                        <asp:LinkButton runat="server" ID="lnkOt" Text="<%#Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTT_ORDEN_TRABAJOLST.ID_ORDEN_TRABAJO)%>"
                    ...
                    <td><%#CType(Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTT_ORDEN_TRABAJOLST.FECHA_ASIGNACION), DateTime).ToString(Utilerias.OrdenesDeTrabajo.Constantes.FORMATO_FECHA_UI)%></td>
                    ...
                    <td>
                        <asp:ImageButton runat="server" ID="btnRevisionReq" AlternateText="Revisión de presupuesto para Requisición" ToolTip="Revisión de presupuesto para Requisición"
                            ...
                            OnClick="btnRevisionReq_Click" />
                    </td>
                    <td>
                        <article style="display: <%#IIf((CType(Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTT_ORDEN_TRABAJOLST.POSEE_SOLICITUD_PRESUPUESTO), String) = "1"), "block", "none")%>">

                            <asp:ImageButton runat="server" ID="ibDescargar" AlternateText="Descargar Archivo de solicitud de presupuesto" ToolTip="Descargar Archivo de solicitud de presupuesto"
                                CommandArgument='<%# String.Format("{0}¬{1}", Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTT_ORDEN_TRABAJOLST.ID_UBICACION), Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTT_ORDEN_TRABAJOLST.ID_ORDEN_TRABAJO))%>'
