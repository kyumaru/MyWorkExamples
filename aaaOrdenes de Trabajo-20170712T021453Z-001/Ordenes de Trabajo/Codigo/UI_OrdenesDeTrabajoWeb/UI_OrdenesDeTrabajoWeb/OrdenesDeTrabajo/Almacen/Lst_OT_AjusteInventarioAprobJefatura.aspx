<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Listado.master" AutoEventWireup="false" CodeFile="Lst_OT_AjusteInventarioAprobJefatura.aspx.vb" Inherits="OrdenesDeTrabajo_Almacen_Lst_OT_AjusteInventarioAprobJefatura" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphFormulario" Runat="Server">
    ...
    <article data-grupo="Listado" class="tituloSeccion">
        Aprobación de ajustes de inventario por parte de la jefatura
    </article>
