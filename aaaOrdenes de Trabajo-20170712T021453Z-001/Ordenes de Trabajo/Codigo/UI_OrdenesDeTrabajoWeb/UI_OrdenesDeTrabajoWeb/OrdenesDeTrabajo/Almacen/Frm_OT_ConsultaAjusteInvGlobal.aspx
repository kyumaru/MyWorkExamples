<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Formulario.master" AutoEventWireup="false" CodeFile="Frm_OT_ConsultaAjusteInvGlobal.aspx.vb" Inherits="OrdenesDeTrabajo_Almacen_Frm_OT_ConsultaAjusteInvGlobal" %>
        ...
        <asp:Repeater runat="server" ID="rpMateriales">
            ...
            <ItemTemplate>
                <tr class="lineaDelListado">
                    ...
                    <td>
                        <asp:Label runat="server" Visible="false" ID="lblAccion" Text='<%#Eval("TIPO")%>'></asp:Label>
                        <asp:DropDownList runat="server" ID="ddlTipo" AppendDataBoundItems="true" AutoPostBack="true" data-tipocontrol="combo" OnSelectedIndexChanged="ddlTipo_SelectedValueChanged" data-inf='<%#String.Format("{0}", Eval(Utilerias.OrdenesDeTrabajo.Modelo.V_OTF_INVENTARIOLST.ID_MATERIAL))%>'>
                    ...
                    <td>
                        <asp:Label runat="server" ID="lblAlmacen" Text='<%#Eval("POST_AJUSTE")%>'></asp:Label>
                    </td>
                    <td>
