<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/Mp_Formulario.master" AutoEventWireup="false" CodeFile="Frm_OT_ConsultaIngresoMatAlmacen.aspx.vb" Inherits="OrdenesDeTrabajo_Almacen_Frm_OT_ConsultaIngresoMatAlmacen" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphFormulario" Runat="Server">
    ...
    <article class="areaBotones">
        ...
        <asp:Button runat="server" ID="btnTramitar" Text="Tramitar" ValidationGroup="Procesar" />
    ...
    <script type="text/javascript">
        ...
        function mostrarAlertaRegistroExitoso() {
            ...
            mostrarAlerta(
                '#arAlertasDelFormulario',
                {
                    mensaje: 'Se ha tramitado el ingreso de material.',
                    tipo: "exito",
                    transparencia: 0.9,
                    posicion: 'top',
                    onClosed: function () { regresarAlListado(); }
