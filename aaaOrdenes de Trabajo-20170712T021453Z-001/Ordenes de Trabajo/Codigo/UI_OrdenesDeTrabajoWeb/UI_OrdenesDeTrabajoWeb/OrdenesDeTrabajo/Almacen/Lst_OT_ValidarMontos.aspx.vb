...
Partial Class OrdenesDeTrabajo_Almacen_Lst_OT_ValidarMontos
...
#Region "Eventos"
        ...
        If Not Page.IsPostBack Then
            Try
                ...
                If AutorizadoUbicacion.Existe Then
                    ...
                    vlc_Condicion = String.Format("{0} = {1} AND {2} = {3} AND {4} = {5} AND {6} = {7} AND {8} = '{9}'", Utilerias.OrdenesDeTrabajo.Modelo.V_OTT_GESTION_INGRESO_MATERLST.ID_UBICACION, Me.IdUbicacion, Utilerias.OrdenesDeTrabajo.Modelo.V_OTT_GESTION_INGRESO_MATERLST.ANNO, Me.Anno, Utilerias.OrdenesDeTrabajo.Modelo.V_OTT_GESTION_INGRESO_MATERLST.NUMERO_GESTION, Me.NumeroGestion, Utilerias.OrdenesDeTrabajo.Modelo.V_OTT_GESTION_INGRESO_MATERLST.ID_VIA_COMPRA_CONTRATO, Me.IdViaCompra, Utilerias.OrdenesDeTrabajo.Modelo.V_OTT_GESTION_INGRESO_MATERLST.ESTADO_GESTION_INGRESO, EstadoGestionIngr.VALIDACION_MONTOS)
    ...
    Protected Sub ibConsultarGestion_Click(sender As Object, e As ImageClickEventArgs)
        ...
        Me.Session.Add("pvn_NumeroGestion", vlc_Llave(3))
        Me.Session.Add("pvn_Consecutivo", vlc_Llave(4))
        Me.Session.Add("pvc_GestionDespliegue", vlc_Llave(5))
        Me.Session.Add("pvc_NombreProveedor", vlc_Llave(6))
        Me.Session.Add("pvc_Fecha", vlc_Llave(7))
        Me.Session.Add("pvc_DescViaCompra", vlc_Llave(8))
        Me.Session.Add("pvc_Observaciones", vlc_Llave(9))
        Me.Session.Add("pvc_Responsable", vlc_Llave(10))

        Response.Redirect("Frm_OT_RegistroValidacionMontos.aspx", False)
