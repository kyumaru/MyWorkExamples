...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenidoFormulario" runat="Server">
    ...
    <article id="ControlDeIngresoAlSistema" class="ventanaEmergente">
        <article>
            ...
            <article>
                <asp:Label runat="server" ID="lblManuales" Text="Manuales:"></asp:Label></br>
                <asp:HyperLink id="lnkIngresoFunc" NavigateUrl="https://www.youtube.com/watch?v=Rmw1jAwluWM" Target="_blank" Text="Ingreso de Funcionarios" runat="server"/></br>
                <asp:HyperLink id="HyperLink1" NavigateUrl="https://www.youtube.com/watch?v=QfU7zemPan0" Target="_blank" Text="Gestiones por parte del Director de la Unidad" runat="server"/> 
            </article>
        </article>
    </article>
