...
Namespace Utilerias.OrdenesDeTrabajo.Modelo
	Public Class V_OTL_TRAZABIL_GESTION_COMPLST
#Region "Constantes"
		Public Const Name As String = "V_OTL_TRAZABIL_GESTION_COMPLST"

		Public Const ANNO As String = "ANNO"

		Public Const ESTADO As String = "ESTADO"

		Public Const ID_TRAZABIL_GESTION_COMP As String = "ID_TRAZABIL_GESTION_COMP"
